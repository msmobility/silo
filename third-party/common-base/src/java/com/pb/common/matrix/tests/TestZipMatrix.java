...
/**
 * Tests the ZipMatrixWriter class.
 *
 * @author    Tim Heier
 * @version   1.0, 1/15/2003
 */
public class TestZipMatrix {
    static Logger logger = Logger.getLogger("com.pb.common.matrix.tests");

    public static final String matrix1FileName = "testmatrix1.zip";
    public static final String matrix2FileName = "testmatrix2.zip";

    public static void main(String[] args) {
        logger.info("Test Description: ");
        logger.info("\tSquare matrix with same external zones in both rows and columns");
        logger.info("\tFirst we will write the matrix as zip file, then read it back in");
        //Create and then write a matrix
        Matrix m1 = TestZipMatrix.createMatrix1();
        TestZipMatrix.writeMatrix( m1, matrix1FileName);

        //Read new matrix back in
        Matrix m11 = TestZipMatrix.readMatrix(matrix1FileName);

        logger.info("Test Description: ");
        logger.info("\tNon-square matrix with different external zones in rows and columns");
        logger.info("\tFirst we will write the matrix as zip file, then read it back in");
        Matrix m2 = TestZipMatrix.createMatrix2();
        TestZipMatrix.writeMatrix( m2, matrix2FileName);

        //Read new matrix back in
        Matrix m22 = TestZipMatrix.readMatrix(matrix2FileName);
    }
