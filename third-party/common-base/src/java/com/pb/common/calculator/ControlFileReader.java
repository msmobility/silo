...
public class ControlFileReader implements Serializable {
    ...
    private static final long serialVersionUID = -8990255332096607034L;
    ...
    public ControlFileReader(File file, HashMap<String, String> env,
            int modelSheet,
            int dataSheet) {
        ...
        ArrayList<DataEntry> tableList = readTableDataEntries();
        ArrayList<DataEntry> matrixList = readMatrixDataEntries();
    ...
    protected void readModelEntries() {
        ...
        ArrayList<ModelEntry> entryList = new ArrayList<ModelEntry>();
        ArrayList<float[]> coeffList = new ArrayList<float[]>();
    ...
    protected ArrayList<DataEntry> readTableDataEntries() {
    ...
    protected ArrayList<DataEntry> readMatrixDataEntries() {

        //Holds entries found in the section
        ArrayList<DataEntry> matrixList = new ArrayList<DataEntry>();
     ...
     *            Starting column
     * @param fail
     *            If true, throw RuntimeException if search term is not found.
     * @return row number containing search term, or -1 if not found
     */
