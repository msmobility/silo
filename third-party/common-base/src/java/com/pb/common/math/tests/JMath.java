...
/*
 * -------------------------------------------------------------------------
 *      $Id: JMath.java,v 1.1 2004/01/14 14:14:16 jim Exp $
 * -------------------------------------------------------------------------
 ...
 */
        ...
        public static void main (String[] args) {
			...
			for (int i=0; i < 3; i++) {
				...
				delta = elapsedTime - previousTime;
				System.out.println ("JMath[" + i + "] log: " + sum + ", elapsed: " + elapsedTime + ", delta: " + delta);
			}
			...
			for (int i=0; i < 3; i++) {
				...
				delta = elapsedTime - previousTime;
				System.out.println ("java.lang.Math[" + i + "] log: " + sum + ", elapsed: " + elapsedTime + ", delta: " + delta);
			}
			...
			for (int i=0; i < 3; i++) {
				...
				delta = elapsedTime - previousTime;
				System.out.println ("JMath[" + i + "] exp: " + sum + ", elapsed: " + elapsedTime + ", delta: " + delta);
			}
			...
			for (int i=0; i < 3; i++) {
				...
				delta = elapsedTime - previousTime;
				System.out.println ("java.lang.Math[" + i + "] exp: " + sum + ", elapsed: " + elapsedTime + ", delta: " + delta);
			}
