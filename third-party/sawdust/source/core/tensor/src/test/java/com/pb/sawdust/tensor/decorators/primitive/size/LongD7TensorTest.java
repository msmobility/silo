 ...
 */
public abstract class LongD7TensorTest extends LongTensorTest {
    LongD7Tensor pdTensor;

    abstract protected LongD7Tensor getTensor(TypeSafeArray<Long> data);
    
    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (LongD7Tensor) tensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Long> t : tensor)
            assertTrue(t instanceof LongD6Tensor);
    }
}
