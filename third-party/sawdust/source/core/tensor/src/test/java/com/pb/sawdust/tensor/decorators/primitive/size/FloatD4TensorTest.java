 ...
 */
public abstract class FloatD4TensorTest extends FloatTensorTest {
    FloatD4Tensor pdTensor;

    abstract protected FloatD4Tensor getTensor(TypeSafeArray<Float> data);
    
    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (FloatD4Tensor) tensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Float> t : tensor)
            assertTrue(t instanceof FloatD3Tensor);
    }
}
