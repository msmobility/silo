 ...
 */
public abstract class IdCharTensorTest<I>  extends IdTensorTest<Character,I> {
    protected IdCharTensor<I> pTensor;
    ...
    public void testIteratorType() {
        for (Tensor<Character> t : tensor)
            assertTrue(t instanceof IdCharTensor);
    }
