 ...
 */
public abstract class LongD2TensorTest extends LongTensorTest {
    LongD2Tensor pdTensor;

    abstract protected LongD2Tensor getTensor(TypeSafeArray<Long> data);
    
    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (LongD2Tensor) tensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Long> t : tensor)
            assertTrue(t instanceof LongD1Tensor);
    }
}
