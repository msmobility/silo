 ...
 */
public abstract class IdFloatD9TensorTest<I> extends IdFloatTensorTest<I> {
    IdFloatD9Tensor<I> pdTensor;

    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (IdFloatD9Tensor<I>) pTensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Float> t : tensor)
            assertTrue(t instanceof IdFloatD8Tensor);
    }   
