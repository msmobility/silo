 ...
 */
public abstract class IdCharD1TensorTest<I> extends IdCharTensorTest<I> {
    IdCharD1Tensor<I> pdTensor;

    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (IdCharD1Tensor<I>) pTensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Character> t : tensor)
            assertTrue(t instanceof IdCharD0Tensor);
    }   
