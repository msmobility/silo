 ...
 */
public abstract class IdLongD4TensorTest<I> extends IdLongTensorTest<I> {
    IdLongD4Tensor<I> pdTensor;

    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (IdLongD4Tensor<I>) pTensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Long> t : tensor)
            assertTrue(t instanceof IdLongD3Tensor);
    }   
