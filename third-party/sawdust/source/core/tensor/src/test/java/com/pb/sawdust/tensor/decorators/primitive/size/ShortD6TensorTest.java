 ...
 */
public abstract class ShortD6TensorTest extends ShortTensorTest {
    ShortD6Tensor pdTensor;

    abstract protected ShortD6Tensor getTensor(TypeSafeArray<Short> data);
    
    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (ShortD6Tensor) tensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Short> t : tensor)
            assertTrue(t instanceof ShortD5Tensor);
    }
}
