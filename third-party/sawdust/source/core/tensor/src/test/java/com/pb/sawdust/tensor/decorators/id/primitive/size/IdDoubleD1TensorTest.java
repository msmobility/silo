 ...
 */
public abstract class IdDoubleD1TensorTest<I> extends IdDoubleTensorTest<I> {
    IdDoubleD1Tensor<I> pdTensor;

    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (IdDoubleD1Tensor<I>) pTensor;
    }
    ...
    public void testGetCellByIdD() {
        ...
        assertAlmostEquals(pData.get(index), pdTensor.getCellById(ids[0]));
    }
    ...
    public void testSetCellByIdD() {
        ...
        assertAlmostEquals(value,pdTensor.getCell(index[0]));
    }
    ...
    public void testGetValueByIdD() {
        ...
        for (int i : range(index.length))
            index[i] = random.nextInt(dimensions[i]);
        I[] ids = getIdsFromIndices(index);
        assertAlmostEquals(data.getValue(index), pdTensor.getValueById(ids[0]));
    }
    ...
    public void testSetValueByIdD() {
        ...
        assertAlmostEquals(value,idTensor.getValue(index[0]));
    }
    ...
    public void TestSizeSpecific() {
        assertAlmostEquals(1,pdTensor.size());
    }
