 ...
 */
public abstract class LongD4TensorTest extends LongTensorTest {
    LongD4Tensor pdTensor;

    abstract protected LongD4Tensor getTensor(TypeSafeArray<Long> data);
    
    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (LongD4Tensor) tensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Long> t : tensor)
            assertTrue(t instanceof LongD3Tensor);
    }
}
