 ...
 */
public abstract class IdFloatD5TensorTest<I> extends IdFloatTensorTest<I> {
    IdFloatD5Tensor<I> pdTensor;

    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (IdFloatD5Tensor<I>) pTensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Float> t : tensor)
            assertTrue(t instanceof IdFloatD4Tensor);
    }   
