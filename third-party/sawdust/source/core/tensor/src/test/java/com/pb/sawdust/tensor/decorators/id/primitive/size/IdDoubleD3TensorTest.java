 ...
 */
public abstract class IdDoubleD3TensorTest<I> extends IdDoubleTensorTest<I> {
    IdDoubleD3Tensor<I> pdTensor;

    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (IdDoubleD3Tensor<I>) pTensor;
    }
    ...
    public void testGetCellByIdD() {
        ...
        assertAlmostEquals(pData.get(index), pdTensor.getCellById(ids[0],ids[1],ids[2]));
    }
    ...
    public void testSetCellByIdD() {
        ...
        assertAlmostEquals(value,pdTensor.getCell(index[0],index[1],index[2]));
    }
    ...
    public void testIteratorType() {
        for (Tensor<Double> t : tensor)
            assertTrue(t instanceof IdDoubleD2Tensor);
    }   
    ...
    public void testGetValueByIdD() {
        ...
        for (int i : range(index.length))
            index[i] = random.nextInt(dimensions[i]);
        I[] ids = getIdsFromIndices(index);
        assertAlmostEquals(data.getValue(index), pdTensor.getValueById(ids[0],ids[1],ids[2]));
    }
    ...
    public void testSetValueByIdD() {
        ...
        assertAlmostEquals(value,idTensor.getValue(index[0],index[1],index[2]));
    }
    ...
    public void TestSizeSpecific() {
        assertAlmostEquals(3,pdTensor.size());
    }
