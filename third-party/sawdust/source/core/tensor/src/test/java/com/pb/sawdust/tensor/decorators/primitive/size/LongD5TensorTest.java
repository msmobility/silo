 ...
 */
public abstract class LongD5TensorTest extends LongTensorTest {
    LongD5Tensor pdTensor;

    abstract protected LongD5Tensor getTensor(TypeSafeArray<Long> data);
    
    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (LongD5Tensor) tensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Long> t : tensor)
            assertTrue(t instanceof LongD4Tensor);
    }
}
