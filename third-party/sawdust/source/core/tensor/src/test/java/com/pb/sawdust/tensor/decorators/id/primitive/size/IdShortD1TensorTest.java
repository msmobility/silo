 ...
 */
public abstract class IdShortD1TensorTest<I> extends IdShortTensorTest<I> {
    IdShortD1Tensor<I> pdTensor;

    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (IdShortD1Tensor<I>) pTensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Short> t : tensor)
            assertTrue(t instanceof IdShortD0Tensor);
    }   
