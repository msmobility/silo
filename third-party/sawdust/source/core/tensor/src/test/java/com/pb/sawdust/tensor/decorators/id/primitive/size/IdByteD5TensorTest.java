 ...
 */
public abstract class IdByteD5TensorTest<I> extends IdByteTensorTest<I> {
    IdByteD5Tensor<I> pdTensor;

    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (IdByteD5Tensor<I>) pTensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Byte> t : tensor)
            assertTrue(t instanceof IdByteD4Tensor);
    }   
