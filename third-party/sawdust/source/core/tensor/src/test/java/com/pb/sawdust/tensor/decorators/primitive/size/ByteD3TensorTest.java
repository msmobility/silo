 ...
 */
public abstract class ByteD3TensorTest extends ByteTensorTest {
    ByteD3Tensor pdTensor;

    abstract protected ByteD3Tensor getTensor(TypeSafeArray<Byte> data);
    
    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (ByteD3Tensor) tensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Byte> t : tensor)
            assertTrue(t instanceof ByteD2Tensor);
    }
}
