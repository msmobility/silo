 ...
 */
public abstract class IdDoubleD2TensorTest<I> extends IdDoubleTensorTest<I> {
    IdDoubleD2Tensor<I> pdTensor;

    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (IdDoubleD2Tensor<I>) pTensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Double> t : tensor)
            assertTrue(t instanceof IdDoubleD1Tensor);
    }   
