 ...
 */
public abstract class IntD6TensorTest extends IntTensorTest {
    IntD6Tensor pdTensor;

    abstract protected IntD6Tensor getTensor(TypeSafeArray<Integer> data);
    
    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (IntD6Tensor) tensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Integer> t : tensor)
            assertTrue(t instanceof IntD5Tensor);
    }
}
