 ...
 */
public abstract class DoubleD1TensorTest extends DoubleTensorTest {
    DoubleD1Tensor pdTensor;

    abstract protected DoubleD1Tensor getTensor(TypeSafeArray<Double> data);
    
    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (DoubleD1Tensor) tensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Double> t : tensor)
            assertTrue(t instanceof DoubleD0Tensor);
    }
}
