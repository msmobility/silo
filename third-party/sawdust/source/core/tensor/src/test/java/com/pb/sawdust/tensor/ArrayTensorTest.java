...
/**
 * The {@code ArrayTensorTest} ...
 *
 * @author crf <br/>
 *         Started Dec 24, 2010 7:16:41 AM
 */
public class ArrayTensorTest extends TensorFactoryTest {
    ...
    protected Collection<Class<? extends TestBase>> getAdditionalTestClasses() {
        ...
        adds.add(ConcurrentArrayTensorTest.class);
        return adds;
    }
    ...
    public static class ConcurrentArrayTensorTest extends ConcurrentTensorFactoryTest {
