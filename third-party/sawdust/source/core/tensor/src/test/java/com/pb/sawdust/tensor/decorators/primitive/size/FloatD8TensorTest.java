 ...
 */
public abstract class FloatD8TensorTest extends FloatTensorTest {
    FloatD8Tensor pdTensor;

    abstract protected FloatD8Tensor getTensor(TypeSafeArray<Float> data);
    
    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (FloatD8Tensor) tensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Float> t : tensor)
            assertTrue(t instanceof FloatD7Tensor);
    }
}
