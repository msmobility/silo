 ...
 */
public abstract class IdShortD2TensorTest<I> extends IdShortTensorTest<I> {
    IdShortD2Tensor<I> pdTensor;

    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (IdShortD2Tensor<I>) pTensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Short> t : tensor)
            assertTrue(t instanceof IdShortD1Tensor);
    }   
