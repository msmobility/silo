 ...
 */
public abstract class FloatD1TensorTest extends FloatTensorTest {
    FloatD1Tensor pdTensor;

    abstract protected FloatD1Tensor getTensor(TypeSafeArray<Float> data);
    
    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (FloatD1Tensor) tensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Float> t : tensor)
            assertTrue(t instanceof FloatD0Tensor);
    }
}
