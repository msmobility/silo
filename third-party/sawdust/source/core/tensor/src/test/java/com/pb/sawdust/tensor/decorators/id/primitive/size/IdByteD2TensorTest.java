 ...
 */
public abstract class IdByteD2TensorTest<I> extends IdByteTensorTest<I> {
    IdByteD2Tensor<I> pdTensor;

    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (IdByteD2Tensor<I>) pTensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Byte> t : tensor)
            assertTrue(t instanceof IdByteD1Tensor);
    }   
