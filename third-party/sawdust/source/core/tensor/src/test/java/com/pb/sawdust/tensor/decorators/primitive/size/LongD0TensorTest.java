 ...
 */
public abstract class LongD0TensorTest extends LongTensorTest {
    LongD0Tensor pdTensor;

    abstract protected LongD0Tensor getTensor(TypeSafeArray<Long> data);

    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (LongD0Tensor) tensor;
