 ...
 */
public abstract class IdShortD4TensorTest<I> extends IdShortTensorTest<I> {
    IdShortD4Tensor<I> pdTensor;

    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (IdShortD4Tensor<I>) pTensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Short> t : tensor)
            assertTrue(t instanceof IdShortD3Tensor);
    }   
