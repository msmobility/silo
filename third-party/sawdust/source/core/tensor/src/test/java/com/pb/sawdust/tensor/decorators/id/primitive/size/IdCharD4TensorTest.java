 ...
 */
public abstract class IdCharD4TensorTest<I> extends IdCharTensorTest<I> {
    IdCharD4Tensor<I> pdTensor;

    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (IdCharD4Tensor<I>) pTensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Character> t : tensor)
            assertTrue(t instanceof IdCharD3Tensor);
    }   
