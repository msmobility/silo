 ...
 */
public abstract class IdLongD5TensorTest<I> extends IdLongTensorTest<I> {
    IdLongD5Tensor<I> pdTensor;

    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (IdLongD5Tensor<I>) pTensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Long> t : tensor)
            assertTrue(t instanceof IdLongD4Tensor);
    }   
