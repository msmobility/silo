 ...
 */
public abstract class DoubleD6TensorTest extends DoubleTensorTest {
    DoubleD6Tensor pdTensor;

    abstract protected DoubleD6Tensor getTensor(TypeSafeArray<Double> data);
    
    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (DoubleD6Tensor) tensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Double> t : tensor)
            assertTrue(t instanceof DoubleD5Tensor);
    }
}
