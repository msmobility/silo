 ...
 */
public abstract class IdBooleanD2TensorTest<I> extends IdBooleanTensorTest<I> {
    IdBooleanD2Tensor<I> pdTensor;

    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (IdBooleanD2Tensor<I>) pTensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Boolean> t : tensor)
            assertTrue(t instanceof IdBooleanD1Tensor);
    }   
