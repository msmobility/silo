 ...
 */
public abstract class IdDoubleD8TensorTest<I> extends IdDoubleTensorTest<I> {
    IdDoubleD8Tensor<I> pdTensor;

    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (IdDoubleD8Tensor<I>) pTensor;
    }
    ...
    public void testGetCellByIdD() {
        ...
        assertAlmostEquals(pData.get(index), pdTensor.getCellById(ids[0],ids[1],ids[2],ids[3],ids[4],ids[5],ids[6],ids[7]));
    }
    ...
    public void testSetCellByIdD() {
        ...
        assertAlmostEquals(value,pdTensor.getCell(index[0],index[1],index[2],index[3],index[4],index[5],index[6],index[7]));
    }
    ...
    public void testIteratorType() {
        for (Tensor<Double> t : tensor)
            assertTrue(t instanceof IdDoubleD7Tensor);
    }   
    ...
    public void testGetValueByIdD() {
        ...
        for (int i : range(index.length))
            index[i] = random.nextInt(dimensions[i]);
        I[] ids = getIdsFromIndices(index);
        assertAlmostEquals(data.getValue(index), pdTensor.getValueById(ids[0],ids[1],ids[2],ids[3],ids[4],ids[5],ids[6],ids[7]));
    }
    ...
    public void testSetValueByIdD() {
        ...
        assertAlmostEquals(value,idTensor.getValue(index[0],index[1],index[2],index[3],index[4],index[5],index[6],index[7]));
    }
    ...
    public void TestSizeSpecific() {
        assertAlmostEquals(8,pdTensor.size());
    }
