 ...
 */
public abstract class IdDoubleD9TensorTest<I> extends IdDoubleTensorTest<I> {
    IdDoubleD9Tensor<I> pdTensor;

    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (IdDoubleD9Tensor<I>) pTensor;
    }
    ...
    public void testGetCellByIdD() {
        ...
        assertAlmostEquals(pData.get(index), pdTensor.getCellById(ids[0],ids[1],ids[2],ids[3],ids[4],ids[5],ids[6],ids[7],ids[8]));
    }
    ...
    public void testSetCellByIdD() {
        ...
        assertAlmostEquals(value,pdTensor.getCell(index[0],index[1],index[2],index[3],index[4],index[5],index[6],index[7],index[8]));
    }
    ...
    public void testIteratorType() {
        for (Tensor<Double> t : tensor)
            assertTrue(t instanceof IdDoubleD8Tensor);
    }   
    ...
    public void testGetValueByIdD() {
        ...
        for (int i : range(index.length))
            index[i] = random.nextInt(dimensions[i]);
        I[] ids = getIdsFromIndices(index);
        assertAlmostEquals(data.getValue(index), pdTensor.getValueById(ids[0],ids[1],ids[2],ids[3],ids[4],ids[5],ids[6],ids[7],ids[8]));
    }
    ...
    public void testSetValueByIdD() {
        ...
        assertAlmostEquals(value,idTensor.getValue(index[0],index[1],index[2],index[3],index[4],index[5],index[6],index[7],index[8]));
    }
    ...
    public void TestSizeSpecific() {
        assertAlmostEquals(9,pdTensor.size());
    }
