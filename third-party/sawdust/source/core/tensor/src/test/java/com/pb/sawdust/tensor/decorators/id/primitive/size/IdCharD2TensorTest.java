 ...
 */
public abstract class IdCharD2TensorTest<I> extends IdCharTensorTest<I> {
    IdCharD2Tensor<I> pdTensor;

    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (IdCharD2Tensor<I>) pTensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Character> t : tensor)
            assertTrue(t instanceof IdCharD1Tensor);
    }   
