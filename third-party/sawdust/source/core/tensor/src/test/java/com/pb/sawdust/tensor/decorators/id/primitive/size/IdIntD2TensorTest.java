 ...
 */
public abstract class IdIntD2TensorTest<I> extends IdIntTensorTest<I> {
    IdIntD2Tensor<I> pdTensor;

    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (IdIntD2Tensor<I>) pTensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Integer> t : tensor)
            assertTrue(t instanceof IdIntD1Tensor);
    }   
