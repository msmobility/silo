 ...
 */
public abstract class IdIntD5TensorTest<I> extends IdIntTensorTest<I> {
    IdIntD5Tensor<I> pdTensor;

    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (IdIntD5Tensor<I>) pTensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Integer> t : tensor)
            assertTrue(t instanceof IdIntD4Tensor);
    }   
