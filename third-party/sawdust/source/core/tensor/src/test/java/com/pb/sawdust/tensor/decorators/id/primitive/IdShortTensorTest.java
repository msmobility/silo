 ...
 */
public abstract class IdShortTensorTest<I>  extends IdTensorTest<Short,I> {
    protected IdShortTensor<I> pTensor;
    ...
    public void beforeTest() {
        super.beforeTest();
        pTensor = (IdShortTensor<I>) tensor;
    ...
    public void testIteratorType() {
        for (Tensor<Short> t : tensor)
            assertTrue(t instanceof IdShortTensor);
    }
