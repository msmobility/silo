 ...
 */
public abstract class IntD8TensorTest extends IntTensorTest {
    IntD8Tensor pdTensor;

    abstract protected IntD8Tensor getTensor(TypeSafeArray<Integer> data);
    
    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (IntD8Tensor) tensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Integer> t : tensor)
            assertTrue(t instanceof IntD7Tensor);
    }
}
