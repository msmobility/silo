 ...
 */
public abstract class ByteD7TensorTest extends ByteTensorTest {
    ByteD7Tensor pdTensor;

    abstract protected ByteD7Tensor getTensor(TypeSafeArray<Byte> data);
    
    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (ByteD7Tensor) tensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Byte> t : tensor)
            assertTrue(t instanceof ByteD6Tensor);
    }
}
