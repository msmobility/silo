 ...
 */
public abstract class ByteD8TensorTest extends ByteTensorTest {
    ByteD8Tensor pdTensor;

    abstract protected ByteD8Tensor getTensor(TypeSafeArray<Byte> data);
    
    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (ByteD8Tensor) tensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Byte> t : tensor)
            assertTrue(t instanceof ByteD7Tensor);
    }
}
