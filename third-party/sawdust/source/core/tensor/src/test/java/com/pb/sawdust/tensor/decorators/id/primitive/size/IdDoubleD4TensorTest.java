 ...
 */
public abstract class IdDoubleD4TensorTest<I> extends IdDoubleTensorTest<I> {
    IdDoubleD4Tensor<I> pdTensor;

    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (IdDoubleD4Tensor<I>) pTensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Double> t : tensor)
            assertTrue(t instanceof IdDoubleD3Tensor);
    }   
