 ...
 */
public abstract class IdBooleanD3TensorTest<I> extends IdBooleanTensorTest<I> {
    IdBooleanD3Tensor<I> pdTensor;

    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (IdBooleanD3Tensor<I>) pTensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Boolean> t : tensor)
            assertTrue(t instanceof IdBooleanD2Tensor);
    }   
