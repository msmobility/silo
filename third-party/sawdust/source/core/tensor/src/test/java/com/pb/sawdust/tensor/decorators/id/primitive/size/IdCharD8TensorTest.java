 ...
 */
public abstract class IdCharD8TensorTest<I> extends IdCharTensorTest<I> {
    IdCharD8Tensor<I> pdTensor;

    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (IdCharD8Tensor<I>) pTensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Character> t : tensor)
            assertTrue(t instanceof IdCharD7Tensor);
    }   
