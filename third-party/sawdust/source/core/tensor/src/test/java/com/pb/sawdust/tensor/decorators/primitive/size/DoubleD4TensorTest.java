 ...
 */
public abstract class DoubleD4TensorTest extends DoubleTensorTest {
    DoubleD4Tensor pdTensor;

    abstract protected DoubleD4Tensor getTensor(TypeSafeArray<Double> data);
    
    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (DoubleD4Tensor) tensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Double> t : tensor)
            assertTrue(t instanceof DoubleD3Tensor);
    }
}
