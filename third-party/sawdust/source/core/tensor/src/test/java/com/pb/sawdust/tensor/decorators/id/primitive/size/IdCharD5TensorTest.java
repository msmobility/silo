 ...
 */
public abstract class IdCharD5TensorTest<I> extends IdCharTensorTest<I> {
    IdCharD5Tensor<I> pdTensor;

    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (IdCharD5Tensor<I>) pTensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Character> t : tensor)
            assertTrue(t instanceof IdCharD4Tensor);
    }   
