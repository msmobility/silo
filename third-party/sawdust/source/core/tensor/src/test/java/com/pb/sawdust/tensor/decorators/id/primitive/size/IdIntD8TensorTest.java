 ...
 */
public abstract class IdIntD8TensorTest<I> extends IdIntTensorTest<I> {
    IdIntD8Tensor<I> pdTensor;

    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (IdIntD8Tensor<I>) pTensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Integer> t : tensor)
            assertTrue(t instanceof IdIntD7Tensor);
    }   
