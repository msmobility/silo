 ...
 */
public abstract class DoubleD7TensorTest extends DoubleTensorTest {
    DoubleD7Tensor pdTensor;

    abstract protected DoubleD7Tensor getTensor(TypeSafeArray<Double> data);
    
    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (DoubleD7Tensor) tensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Double> t : tensor)
            assertTrue(t instanceof DoubleD6Tensor);
    }
}
