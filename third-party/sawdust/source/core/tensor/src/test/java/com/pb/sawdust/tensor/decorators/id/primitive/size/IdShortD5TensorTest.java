 ...
 */
public abstract class IdShortD5TensorTest<I> extends IdShortTensorTest<I> {
    IdShortD5Tensor<I> pdTensor;

    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (IdShortD5Tensor<I>) pTensor;
    }
    ...
    public void testGetCellByIdD() {
        ...
        assertEquals(pData.get(index), pdTensor.getCellById(ids[0],ids[1],ids[2],ids[3],ids[4]));
    }
    ...
    public void testGetCellByIdBadIdD() {
        ...
        pdTensor.getCellById(ids[0],ids[1],ids[2],ids[3],ids[4]);
    }
    ...
    public void testSetCellByIdD() {
        ...
        I[] ids = getIdsFromIndices(index);
        pdTensor.setCellById(value,ids[0],ids[1],ids[2],ids[3],ids[4]);
        assertEquals(value,pdTensor.getCell(index[0],index[1],index[2],index[3],index[4]));
    }
    ...
    public void testSetCellByIdBadIdD() {
        ...
        I[] ids = getIdsFromIndices(index);
        ids[random.nextInt(index.length)] = (I) new Object();
        pdTensor.setCellById(getRandomElement(),ids[0],ids[1],ids[2],ids[3],ids[4]);
    }

    @Test
    public void testIteratorType() {
        for (Tensor<Short> t : tensor)
            assertTrue(t instanceof IdShortD4Tensor);
    }   
    ...
    public void testGetValueByIdD() {
        ...
        for (int i : range(index.length))
            index[i] = random.nextInt(dimensions[i]);
        I[] ids = getIdsFromIndices(index);
        assertEquals(data.getValue(index), pdTensor.getValueById(ids[0],ids[1],ids[2],ids[3],ids[4]));
    }
    ...
    public void testGetValueByIdBadIdD() {
        ...
        I[] ids = getIdsFromIndices(index);
        ids[random.nextInt(index.length)] = (I) new Object();
        pdTensor.getValueById(ids[0],ids[1],ids[2],ids[3],ids[4]);
    }
    ...
    public void testSetValueByIdD() {
        ...
        Short value = getRandomElement();
        I[] ids = getIdsFromIndices(index);
        pdTensor.setValueById(value,ids[0],ids[1],ids[2],ids[3],ids[4]);
        assertEquals(value,idTensor.getValue(index[0],index[1],index[2],index[3],index[4]));
    }
    ...
    public void testSetValueByIdBadIdD() {
        ...
        I[] ids = getIdsFromIndices(index);
        ids[random.nextInt(index.length)] = (I) new Object();
        pdTensor.setValueById(getRandomElement(),ids[0],ids[1],ids[2],ids[3],ids[4]);
    }
    ...
    public void testGetValueD() {
        ...
        for (int i : range(index.length))
            index[i] = random.nextInt(dimensions[i]);
        assertEquals(data.getValue(index),pdTensor.getValue(index[0],index[1],index[2],index[3],index[4]));
    }
