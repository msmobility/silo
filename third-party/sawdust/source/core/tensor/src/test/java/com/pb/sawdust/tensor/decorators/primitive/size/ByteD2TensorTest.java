 ...
 */
public abstract class ByteD2TensorTest extends ByteTensorTest {
    ByteD2Tensor pdTensor;

    abstract protected ByteD2Tensor getTensor(TypeSafeArray<Byte> data);
    
    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (ByteD2Tensor) tensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Byte> t : tensor)
            assertTrue(t instanceof ByteD1Tensor);
    }
}
