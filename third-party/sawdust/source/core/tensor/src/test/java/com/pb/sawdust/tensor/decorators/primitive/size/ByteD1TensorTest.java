 ...
 */
public abstract class ByteD1TensorTest extends ByteTensorTest {
    ByteD1Tensor pdTensor;

    abstract protected ByteD1Tensor getTensor(TypeSafeArray<Byte> data);
    
    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (ByteD1Tensor) tensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Byte> t : tensor)
            assertTrue(t instanceof ByteD0Tensor);
    }
}
