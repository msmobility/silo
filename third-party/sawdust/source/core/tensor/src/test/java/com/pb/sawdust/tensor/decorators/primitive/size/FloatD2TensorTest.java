 ...
 */
public abstract class FloatD2TensorTest extends FloatTensorTest {
    FloatD2Tensor pdTensor;

    abstract protected FloatD2Tensor getTensor(TypeSafeArray<Float> data);
    
    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (FloatD2Tensor) tensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Float> t : tensor)
            assertTrue(t instanceof FloatD1Tensor);
    }
}
