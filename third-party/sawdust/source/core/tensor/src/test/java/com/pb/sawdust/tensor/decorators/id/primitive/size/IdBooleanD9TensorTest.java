 ...
 */
public abstract class IdBooleanD9TensorTest<I> extends IdBooleanTensorTest<I> {
    IdBooleanD9Tensor<I> pdTensor;

    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (IdBooleanD9Tensor<I>) pTensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Boolean> t : tensor)
            assertTrue(t instanceof IdBooleanD8Tensor);
    }   
