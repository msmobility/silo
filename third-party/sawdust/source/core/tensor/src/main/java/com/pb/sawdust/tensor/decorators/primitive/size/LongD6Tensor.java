...
/**
 * The {@code LongD6Tensor} interface combines the {@code LongTensor} and {@code D6Tensor} interfaces. The notes and caveats
 ...
 */
public interface LongD6Tensor extends LongTensor, D6Tensor<Long> {
    /**
     ...
     */
    long getCell(int d0index, int d1index, int d2index, int d3index, int d4index, int d5index);
     ...
     *                                   equal to the size of its corresponding dimension.
     */
    void setCell(long value, int d0index, int d1index, int d2index, int d3index, int d4index, int d5index);
    
    /**
     * {@inheritDoc}
     * 
     * The tensors this iterator loops over are guaranteed to be {@code LongD5Tensor} tensors.
     * 
     */
