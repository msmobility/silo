...
/**
 * The {@code IdDoubleD7Tensor} class combines the {@code Double7Tensor} and {@code IdTensor} interfaces. It adds a
 * number of methods extending {@code DoubleD7Tensor} methods so that dimensional indices can be referenced by ids.
 *
 * @param <I>
 ...
 */
public interface IdDoubleD7Tensor<I> extends DoubleD7Tensor,IdDoubleTensor<I>,IdD7Tensor<Double,I> {
    /**
     ...
     */
    double getCellById(I d0id, I d1id, I d2id, I d3id, I d4id, I d5id, I d6id);
     ...
     * @throws IllegalArgumentException if any id is not valid in its respective dimension.
     */
    void setCellById(double value, I d0id, I d1id, I d2id, I d3id, I d4id, I d5id, I d6id);

    /**
     * {@inheritDoc}
     *
     * The tensors this iterator loops over are guaranteed to be {@code IddoubleD6Tensor<I>} tensors.
     * 
     */
