...
/**
 * The {@code IntD8Tensor} interface combines the {@code IntTensor} and {@code D8Tensor} interfaces. The notes and caveats
 ...
 */
public interface IntD8Tensor extends IntTensor, D8Tensor<Integer> {
    /**
     ...
     */
    int getCell(int d0index, int d1index, int d2index, int d3index, int d4index, int d5index, int d6index, int d7index);
     ...
     *                                   equal to the size of its corresponding dimension.
     */
    void setCell(int value, int d0index, int d1index, int d2index, int d3index, int d4index, int d5index, int d6index, int d7index);
    
    /**
     * {@inheritDoc}
     * 
     * The tensors this iterator loops over are guaranteed to be {@code IntD7Tensor} tensors.
     * 
     */
