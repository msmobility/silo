...
/**
 * The {@code IdD9Tensor} class combines the {@code D9Tensor} and {@code IdTensor} interfaces. It adds a number of
 * methods extending {@code D9Tensor} methods so that dimensional indices can be referenced by ids.
 *
 * @param <T>
 ...
 */
public interface IdD9Tensor<T,I> extends D9Tensor<T>,IdTensor<T,I> {
     ...
     */
    T getValueById(I d0id, I d1id, I d2id, I d3id, I d4id, I d5id, I d6id, I d7id, I d8id);
     ...
     * @throws IllegalArgumentException if any id is not valid in its respective dimension.
     */
    void setValueById(T value, I d0id, I d1id, I d2id, I d3id, I d4id, I d5id, I d6id, I d7id, I d8id);

    /**
     * {@inheritDoc}
     *
     * The tensors this iterator loops over are guaranteed to be {@code IdD8Tensor<T,I>} tensors.
     * 
     */
