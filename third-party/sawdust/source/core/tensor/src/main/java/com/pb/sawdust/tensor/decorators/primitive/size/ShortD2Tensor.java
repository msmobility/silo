...
/**
 * The {@code ShortD2Tensor} interface combines the {@code ShortTensor} and {@code Matrix} interfaces. The notes and caveats
 ...
 */
public interface ShortD2Tensor extends ShortTensor, Matrix<Short> {
    /**
     ...
     */
    short getCell(int d0index, int d1index);
     ...
     *                                   equal to the size of its corresponding dimension.
     */
    void setCell(short value, int d0index, int d1index);
    
    /**
     * {@inheritDoc}
     * 
     * The tensors this iterator loops over are guaranteed to be {@code ShortD1Tensor} tensors.
     * 
     */
