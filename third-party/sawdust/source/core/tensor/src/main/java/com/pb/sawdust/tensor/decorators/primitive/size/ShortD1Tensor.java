...
/**
 * The {@code ShortD1Tensor} interface combines the {@code ShortTensor} and {@code Vector} interfaces. The notes and caveats
 ...
 */
public interface ShortD1Tensor extends ShortTensor, Vector<Short> {
    /**
     ...
     *                                   equal to the size of its corresponding dimension.
     */
    void setCell(short value, int index);
    
    /**
     * {@inheritDoc}
     * 
     * The tensors this iterator loops over are guaranteed to be {@code ShortD0Tensor} tensors.
     * 
     */
