...
/**
 * The {@code ConcurrentBooleanD8TensorShell} class provides a wrapper for implementations of the {@code BooleanD8Tensor} interface
 ...
 */
public class ConcurrentBooleanD8TensorShell extends ConcurrentD8TensorShell<Boolean> implements BooleanD8Tensor {
     ...
     */
    public ConcurrentBooleanD8TensorShell(BooleanD8Tensor tensor, ConcurrentD8TensorLocks locks) {
        super(tensor,locks);
        this.tensor = tensor;
    }
