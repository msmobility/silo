...
/**
 * The {@code IdCharD4Tensor} class combines the {@code Char4Tensor} and {@code IdTensor} interfaces. It adds a
 * number of methods extending {@code CharD4Tensor} methods so that dimensional indices can be referenced by ids.
 *
 * @param <I>
 ...
 */
public interface IdCharD4Tensor<I> extends CharD4Tensor,IdCharTensor<I>,IdD4Tensor<Character,I> {
    /**
     ...
     */
    char getCellById(I d0id, I d1id, I d2id, I d3id);
     ...
     * @throws IllegalArgumentException if any id is not valid in its respective dimension.
     */
    void setCellById(char value, I d0id, I d1id, I d2id, I d3id);

    /**
     * {@inheritDoc}
     *
     * The tensors this iterator loops over are guaranteed to be {@code IdcharD3Tensor<I>} tensors.
     * 
     */
