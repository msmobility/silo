...
/**
 * The {@code IdByteD7Tensor} class combines the {@code Byte7Tensor} and {@code IdTensor} interfaces. It adds a
 * number of methods extending {@code ByteD7Tensor} methods so that dimensional indices can be referenced by ids.
 *
 * @param <I>
 ...
 */
public interface IdByteD7Tensor<I> extends ByteD7Tensor,IdByteTensor<I>,IdD7Tensor<Byte,I> {
    /**
     ...
     */
    byte getCellById(I d0id, I d1id, I d2id, I d3id, I d4id, I d5id, I d6id);
     ...
     * @throws IllegalArgumentException if any id is not valid in its respective dimension.
     */
    void setCellById(byte value, I d0id, I d1id, I d2id, I d3id, I d4id, I d5id, I d6id);

    /**
     * {@inheritDoc}
     *
     * The tensors this iterator loops over are guaranteed to be {@code IdbyteD6Tensor<I>} tensors.
     * 
     */
