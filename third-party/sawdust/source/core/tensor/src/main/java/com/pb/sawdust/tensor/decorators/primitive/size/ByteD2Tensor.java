...
/**
 * The {@code ByteD2Tensor} interface combines the {@code ByteTensor} and {@code Matrix} interfaces. The notes and caveats
 ...
 */
public interface ByteD2Tensor extends ByteTensor, Matrix<Byte> {
    /**
     ...
     */
    byte getCell(int d0index, int d1index);
     ...
     *                                   equal to the size of its corresponding dimension.
     */
    void setCell(byte value, int d0index, int d1index);
    
    /**
     * {@inheritDoc}
     * 
     * The tensors this iterator loops over are guaranteed to be {@code ByteD1Tensor} tensors.
     * 
     */
