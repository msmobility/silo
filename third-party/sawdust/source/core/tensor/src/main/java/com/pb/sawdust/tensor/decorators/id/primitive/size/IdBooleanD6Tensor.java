...
/**
 * The {@code IdBooleanD6Tensor} class combines the {@code Boolean6Tensor} and {@code IdTensor} interfaces. It adds a
 * number of methods extending {@code BooleanD6Tensor} methods so that dimensional indices can be referenced by ids.
 *
 * @param <I>
 ...
 */
public interface IdBooleanD6Tensor<I> extends BooleanD6Tensor,IdBooleanTensor<I>,IdD6Tensor<Boolean,I> {
    /**
     ...
     */
    boolean getCellById(I d0id, I d1id, I d2id, I d3id, I d4id, I d5id);
     ...
     * @throws IllegalArgumentException if any id is not valid in its respective dimension.
     */
    void setCellById(boolean value, I d0id, I d1id, I d2id, I d3id, I d4id, I d5id);

    /**
     * {@inheritDoc}
     *
     * The tensors this iterator loops over are guaranteed to be {@code IdbooleanD5Tensor<I>} tensors.
     * 
     */
