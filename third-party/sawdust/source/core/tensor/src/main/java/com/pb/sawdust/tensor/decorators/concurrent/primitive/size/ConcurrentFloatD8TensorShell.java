...
/**
 * The {@code ConcurrentFloatD8TensorShell} class provides a wrapper for implementations of the {@code FloatD8Tensor} interface
 ...
 */
public class ConcurrentFloatD8TensorShell extends ConcurrentD8TensorShell<Float> implements FloatD8Tensor {
     ...
     */
    public ConcurrentFloatD8TensorShell(FloatD8Tensor tensor, ConcurrentD8TensorLocks locks) {
        super(tensor,locks);
        this.tensor = tensor;
    }
