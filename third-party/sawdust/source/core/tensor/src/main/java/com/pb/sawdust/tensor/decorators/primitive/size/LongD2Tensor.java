...
/**
 * The {@code LongD2Tensor} interface combines the {@code LongTensor} and {@code Matrix} interfaces. The notes and caveats
 ...
 */
public interface LongD2Tensor extends LongTensor, Matrix<Long> {
    /**
     ...
     */
    long getCell(int d0index, int d1index);
     ...
     *                                   equal to the size of its corresponding dimension.
     */
    void setCell(long value, int d0index, int d1index);
    
    /**
     * {@inheritDoc}
     * 
     * The tensors this iterator loops over are guaranteed to be {@code LongD1Tensor} tensors.
     * 
     */
