...
import com.pb.sawdust.tensor.decorators.primitive.size.ShortD4TensorShell;
...
/**
 * The {@code IdShortD4TensorShell} class is a wrapper which sets a {@code ShortD4TensorShell} as an {@code IdTensor<I>} (or,
 * more specifically, an {@code IdShortD4Tensor}).
 *
 * @author crf <br/>
 *         Started: Jan 16, 2009 9:47:43 AM
 *         Revised: Dec 14, 2009 12:35:27 PM
 */
public class IdShortD4TensorShell<I> extends ShortD4TensorShell implements IdShortD4Tensor<I> {
    private final ShortD4Tensor tensor;
    private final Index<I> index;

    IdShortD4TensorShell(ShortD4Tensor tensor, Index<I> index) {
        super(tensor);
        this.tensor = tensor;
        this.index = index;
    }
    ...
    public IdShortD4TensorShell(ShortD4Tensor tensor) {
    ...
    public IdShortD4TensorShell(ShortD4Tensor tensor, I[] ... ids) {
     ...
     *                                  in {@code ids} contains repeated elements.
     */
    public IdShortD4TensorShell(ShortD4Tensor tensor, List<List<I>> ids) {
        this(tensor,new BaseIndex<I>(tensor,ids));
    }
    ...
    public Iterator<Tensor<Short>> iterator() {
        return new Iterator<Tensor<Short>>() {
            private final Iterator<Tensor<Short>> iterator = IdShortD4TensorShell.super.iterator();
            ...
            public Tensor<Short> next() {
                return new IdShortD3TensorShell<I>((ShortD3Tensor) iterator.next());
            }
