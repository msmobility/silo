...
/**
 * The {@code DoubleD4Tensor} interface combines the {@code DoubleTensor} and {@code D4Tensor} interfaces. The notes and caveats
 ...
 */
public interface DoubleD4Tensor extends DoubleTensor, D4Tensor<Double> {
    /**
     ...
     */
    double getCell(int d0index, int d1index, int d2index, int d3index);
     ...
     *                                   equal to the size of its corresponding dimension.
     */
    void setCell(double value, int d0index, int d1index, int d2index, int d3index);
    
    /**
     * {@inheritDoc}
     * 
     * The tensors this iterator loops over are guaranteed to be {@code DoubleD3Tensor} tensors.
     * 
     */
