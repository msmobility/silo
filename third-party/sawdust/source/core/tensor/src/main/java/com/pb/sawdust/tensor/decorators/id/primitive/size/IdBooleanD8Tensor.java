...
/**
 * The {@code IdBooleanD8Tensor} class combines the {@code Boolean8Tensor} and {@code IdTensor} interfaces. It adds a
 * number of methods extending {@code BooleanD8Tensor} methods so that dimensional indices can be referenced by ids.
 *
 * @param <I>
 ...
 */
public interface IdBooleanD8Tensor<I> extends BooleanD8Tensor,IdBooleanTensor<I>,IdD8Tensor<Boolean,I> {
    /**
     ...
     */
    boolean getCellById(I d0id, I d1id, I d2id, I d3id, I d4id, I d5id, I d6id, I d7id);
     ...
     * @throws IllegalArgumentException if any id is not valid in its respective dimension.
     */
    void setCellById(boolean value, I d0id, I d1id, I d2id, I d3id, I d4id, I d5id, I d6id, I d7id);

    /**
     * {@inheritDoc}
     *
     * The tensors this iterator loops over are guaranteed to be {@code IdbooleanD7Tensor<I>} tensors.
     * 
     */
