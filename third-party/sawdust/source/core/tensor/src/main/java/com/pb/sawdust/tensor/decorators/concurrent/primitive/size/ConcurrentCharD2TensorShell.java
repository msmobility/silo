...
/**
 * The {@code ConcurrentCharD2TensorShell} class provides a wrapper for implementations of the {@code CharMatrix} interface
 ...
 */
public class ConcurrentCharD2TensorShell extends ConcurrentD2TensorShell<Character> implements CharMatrix {
     ...
     */
    public ConcurrentCharD2TensorShell(CharD2Tensor tensor, ConcurrentD2TensorLocks locks) {
        super(tensor,locks);
        this.tensor = tensor;
    }
