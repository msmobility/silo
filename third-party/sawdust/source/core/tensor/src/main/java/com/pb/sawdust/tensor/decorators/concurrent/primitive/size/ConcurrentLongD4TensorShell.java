...
/**
 * The {@code ConcurrentLongD4TensorShell} class provides a wrapper for implementations of the {@code LongD4Tensor} interface
 ...
 */
public class ConcurrentLongD4TensorShell extends ConcurrentD4TensorShell<Long> implements LongD4Tensor {
     ...
     */
    public ConcurrentLongD4TensorShell(LongD4Tensor tensor, ConcurrentD4TensorLocks locks) {
        super(tensor,locks);
        this.tensor = tensor;
    }
