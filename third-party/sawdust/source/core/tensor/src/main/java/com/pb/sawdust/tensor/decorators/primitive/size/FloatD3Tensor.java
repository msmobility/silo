...
/**
 * The {@code FloatD3Tensor} interface combines the {@code FloatTensor} and {@code D3Tensor} interfaces. The notes and caveats
 ...
 */
public interface FloatD3Tensor extends FloatTensor, D3Tensor<Float> {
    /**
     ...
     */
    float getCell(int d0index, int d1index, int d2index);
     ...
     *                                   equal to the size of its corresponding dimension.
     */
    void setCell(float value, int d0index, int d1index, int d2index);
    
    /**
     * {@inheritDoc}
     * 
     * The tensors this iterator loops over are guaranteed to be {@code FloatD2Tensor} tensors.
     * 
     */
