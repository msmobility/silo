...
/**
 * The {@code CharD3Tensor} interface combines the {@code CharTensor} and {@code D3Tensor} interfaces. The notes and caveats
 ...
 */
public interface CharD3Tensor extends CharTensor, D3Tensor<Character> {
    /**
     ...
     */
    char getCell(int d0index, int d1index, int d2index);
     ...
     *                                   equal to the size of its corresponding dimension.
     */
    void setCell(char value, int d0index, int d1index, int d2index);
    
    /**
     * {@inheritDoc}
     * 
     * The tensors this iterator loops over are guaranteed to be {@code CharD2Tensor} tensors.
     * 
     */
