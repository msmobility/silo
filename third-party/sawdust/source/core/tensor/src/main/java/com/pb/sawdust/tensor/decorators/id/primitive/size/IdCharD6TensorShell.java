...
import com.pb.sawdust.tensor.decorators.primitive.size.CharD6TensorShell;
...
/**
 * The {@code IdCharD6TensorShell} class is a wrapper which sets a {@code CharD6TensorShell} as an {@code IdTensor<I>} (or,
 * more specifically, an {@code IdCharD6Tensor}).
 *
 * @author crf <br/>
 *         Started: Jan 16, 2009 9:47:43 AM
 *         Revised: Dec 14, 2009 12:35:30 PM
 */
public class IdCharD6TensorShell<I> extends CharD6TensorShell implements IdCharD6Tensor<I> {
    private final CharD6Tensor tensor;
    private final Index<I> index;

    IdCharD6TensorShell(CharD6Tensor tensor, Index<I> index) {
        super(tensor);
        this.tensor = tensor;
        this.index = index;
    }
    ...
    public IdCharD6TensorShell(CharD6Tensor tensor) {
    ...
    public IdCharD6TensorShell(CharD6Tensor tensor, I[] ... ids) {
     ...
     *                                  in {@code ids} contains repeated elements.
     */
    public IdCharD6TensorShell(CharD6Tensor tensor, List<List<I>> ids) {
        this(tensor,new BaseIndex<I>(tensor,ids));
    }
    ...
    public Iterator<Tensor<Character>> iterator() {
        return new Iterator<Tensor<Character>>() {
            private final Iterator<Tensor<Character>> iterator = IdCharD6TensorShell.super.iterator();
            ...
            public Tensor<Character> next() {
                return new IdCharD5TensorShell<I>((CharD5Tensor) iterator.next());
            }
