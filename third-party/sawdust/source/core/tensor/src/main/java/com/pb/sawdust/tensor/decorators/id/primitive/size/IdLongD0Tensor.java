...
/**
 * The {@code IdLongD0Tensor} class combines the {@code Long0Tensor} and {@code IdTensor} interfaces. Because it is
 ...
 *
 * @see com.pb.sawdust.tensor.alias.scalar.id.IdLongScalar
 *
 * @author crf <br/>
 *         Started: Jan 14, 2009 11:00:16 PM
 *         Revised: Jun 16, 2009 3:17:18 PM
 */
public interface IdLongD0Tensor<I> extends LongD0Tensor,IdLongTensor<I>,IdD0Tensor<Long,I> {
     ...
     */
    void setCellById(long value);

    @Override
    <J> IdLongTensor<J> getReferenceTensor(Index<J> index);
