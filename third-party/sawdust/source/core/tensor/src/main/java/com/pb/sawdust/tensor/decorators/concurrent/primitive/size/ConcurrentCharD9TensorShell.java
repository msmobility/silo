...
/**
 * The {@code ConcurrentCharD9TensorShell} class provides a wrapper for implementations of the {@code CharD9Tensor} interface
 ...
 */
public class ConcurrentCharD9TensorShell extends ConcurrentD9TensorShell<Character> implements CharD9Tensor {
     ...
     */
    public ConcurrentCharD9TensorShell(CharD9Tensor tensor, ConcurrentD9TensorLocks locks) {
        super(tensor,locks);
        this.tensor = tensor;
    }
