...
/**
 * The {@code DoubleD8Tensor} interface combines the {@code DoubleTensor} and {@code D8Tensor} interfaces. The notes and caveats
 ...
 */
public interface DoubleD8Tensor extends DoubleTensor, D8Tensor<Double> {
    /**
     ...
     */
    double getCell(int d0index, int d1index, int d2index, int d3index, int d4index, int d5index, int d6index, int d7index);
     ...
     *                                   equal to the size of its corresponding dimension.
     */
    void setCell(double value, int d0index, int d1index, int d2index, int d3index, int d4index, int d5index, int d6index, int d7index);
    
    /**
     * {@inheritDoc}
     * 
     * The tensors this iterator loops over are guaranteed to be {@code DoubleD7Tensor} tensors.
     * 
     */
