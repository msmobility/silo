...
/**
 * The {@code IdCharD6Tensor} class combines the {@code Char6Tensor} and {@code IdTensor} interfaces. It adds a
 * number of methods extending {@code CharD6Tensor} methods so that dimensional indices can be referenced by ids.
 *
 * @param <I>
 ...
 */
public interface IdCharD6Tensor<I> extends CharD6Tensor,IdCharTensor<I>,IdD6Tensor<Character,I> {
    /**
     ...
     */
    char getCellById(I d0id, I d1id, I d2id, I d3id, I d4id, I d5id);
     ...
     * @throws IllegalArgumentException if any id is not valid in its respective dimension.
     */
    void setCellById(char value, I d0id, I d1id, I d2id, I d3id, I d4id, I d5id);

    /**
     * {@inheritDoc}
     *
     * The tensors this iterator loops over are guaranteed to be {@code IdcharD5Tensor<I>} tensors.
     * 
     */
