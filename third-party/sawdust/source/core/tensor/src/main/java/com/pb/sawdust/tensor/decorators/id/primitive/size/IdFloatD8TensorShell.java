...
import com.pb.sawdust.tensor.decorators.primitive.size.FloatD8TensorShell;
...
/**
 * The {@code IdFloatD8TensorShell} class is a wrapper which sets a {@code FloatD8TensorShell} as an {@code IdTensor<I>} (or,
 * more specifically, an {@code IdFloatD8Tensor}).
 *
 * @author crf <br/>
 *         Started: Jan 16, 2009 9:47:43 AM
 *         Revised: Dec 14, 2009 12:35:33 PM
 */
public class IdFloatD8TensorShell<I> extends FloatD8TensorShell implements IdFloatD8Tensor<I> {
    private final FloatD8Tensor tensor;
    private final Index<I> index;

    IdFloatD8TensorShell(FloatD8Tensor tensor, Index<I> index) {
        super(tensor);
        this.tensor = tensor;
        this.index = index;
    }
    ...
    public IdFloatD8TensorShell(FloatD8Tensor tensor) {
    ...
    public IdFloatD8TensorShell(FloatD8Tensor tensor, I[] ... ids) {
     ...
     *                                  in {@code ids} contains repeated elements.
     */
    public IdFloatD8TensorShell(FloatD8Tensor tensor, List<List<I>> ids) {
        this(tensor,new BaseIndex<I>(tensor,ids));
    }
    ...
    public Iterator<Tensor<Float>> iterator() {
        return new Iterator<Tensor<Float>>() {
            private final Iterator<Tensor<Float>> iterator = IdFloatD8TensorShell.super.iterator();
            ...
            public Tensor<Float> next() {
                return new IdFloatD7TensorShell<I>((FloatD7Tensor) iterator.next());
            }
