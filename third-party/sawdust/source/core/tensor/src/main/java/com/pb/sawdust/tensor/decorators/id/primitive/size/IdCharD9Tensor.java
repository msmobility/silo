...
/**
 * The {@code IdCharD9Tensor} class combines the {@code Char9Tensor} and {@code IdTensor} interfaces. It adds a
 * number of methods extending {@code CharD9Tensor} methods so that dimensional indices can be referenced by ids.
 *
 * @param <I>
 ...
 */
public interface IdCharD9Tensor<I> extends CharD9Tensor,IdCharTensor<I>,IdD9Tensor<Character,I> {
    /**
     ...
     */
    char getCellById(I d0id, I d1id, I d2id, I d3id, I d4id, I d5id, I d6id, I d7id, I d8id);
     ...
     * @throws IllegalArgumentException if any id is not valid in its respective dimension.
     */
    void setCellById(char value, I d0id, I d1id, I d2id, I d3id, I d4id, I d5id, I d6id, I d7id, I d8id);

    /**
     * {@inheritDoc}
     *
     * The tensors this iterator loops over are guaranteed to be {@code IdcharD8Tensor<I>} tensors.
     * 
     */
