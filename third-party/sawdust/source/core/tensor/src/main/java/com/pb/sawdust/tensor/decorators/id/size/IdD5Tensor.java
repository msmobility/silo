...
/**
 * The {@code IdD5Tensor} class combines the {@code D5Tensor} and {@code IdTensor} interfaces. It adds a number of
 * methods extending {@code D5Tensor} methods so that dimensional indices can be referenced by ids.
 *
 * @param <T>
 ...
 */
public interface IdD5Tensor<T,I> extends D5Tensor<T>,IdTensor<T,I> {
     ...
     */
    T getValueById(I d0id, I d1id, I d2id, I d3id, I d4id);
     ...
     * @throws IllegalArgumentException if any id is not valid in its respective dimension.
     */
    void setValueById(T value, I d0id, I d1id, I d2id, I d3id, I d4id);

    /**
     * {@inheritDoc}
     *
     * The tensors this iterator loops over are guaranteed to be {@code IdD4Tensor<T,I>} tensors.
     * 
     */
