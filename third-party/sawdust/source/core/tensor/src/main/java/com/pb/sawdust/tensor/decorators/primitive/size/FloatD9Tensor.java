...
/**
 * The {@code FloatD9Tensor} interface combines the {@code FloatTensor} and {@code D9Tensor} interfaces. The notes and caveats
 ...
 */
public interface FloatD9Tensor extends FloatTensor, D9Tensor<Float> {
    /**
     ...
     */
    float getCell(int d0index, int d1index, int d2index, int d3index, int d4index, int d5index, int d6index, int d7index, int d8index);
     ...
     *                                   equal to the size of its corresponding dimension.
     */
    void setCell(float value, int d0index, int d1index, int d2index, int d3index, int d4index, int d5index, int d6index, int d7index, int d8index);
    
    /**
     * {@inheritDoc}
     * 
     * The tensors this iterator loops over are guaranteed to be {@code FloatD8Tensor} tensors.
     * 
     */
