...
/**
 * The {@code BooleanD6Tensor} interface combines the {@code BooleanTensor} and {@code D6Tensor} interfaces. The notes and caveats
 ...
 */
public interface BooleanD6Tensor extends BooleanTensor, D6Tensor<Boolean> {
    /**
     ...
     */
    boolean getCell(int d0index, int d1index, int d2index, int d3index, int d4index, int d5index);
     ...
     *                                   equal to the size of its corresponding dimension.
     */
    void setCell(boolean value, int d0index, int d1index, int d2index, int d3index, int d4index, int d5index);
    
    /**
     * {@inheritDoc}
     * 
     * The tensors this iterator loops over are guaranteed to be {@code BooleanD5Tensor} tensors.
     * 
     */
