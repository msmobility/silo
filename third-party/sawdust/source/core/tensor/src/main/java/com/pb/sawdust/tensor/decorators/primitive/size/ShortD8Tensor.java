...
/**
 * The {@code ShortD8Tensor} interface combines the {@code ShortTensor} and {@code D8Tensor} interfaces. The notes and caveats
 ...
 */
public interface ShortD8Tensor extends ShortTensor, D8Tensor<Short> {
    /**
     ...
     */
    short getCell(int d0index, int d1index, int d2index, int d3index, int d4index, int d5index, int d6index, int d7index);
     ...
     *                                   equal to the size of its corresponding dimension.
     */
    void setCell(short value, int d0index, int d1index, int d2index, int d3index, int d4index, int d5index, int d6index, int d7index);
    
    /**
     * {@inheritDoc}
     * 
     * The tensors this iterator loops over are guaranteed to be {@code ShortD7Tensor} tensors.
     * 
     */
