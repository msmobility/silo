...
/**
 * The {@code IdShortD4Tensor} class combines the {@code Short4Tensor} and {@code IdTensor} interfaces. It adds a
 * number of methods extending {@code ShortD4Tensor} methods so that dimensional indices can be referenced by ids.
 *
 * @param <I>
 ...
 */
public interface IdShortD4Tensor<I> extends ShortD4Tensor,IdShortTensor<I>,IdD4Tensor<Short,I> {
    /**
     ...
     */
    short getCellById(I d0id, I d1id, I d2id, I d3id);
     ...
     * @throws IllegalArgumentException if any id is not valid in its respective dimension.
     */
    void setCellById(short value, I d0id, I d1id, I d2id, I d3id);

    /**
     * {@inheritDoc}
     *
     * The tensors this iterator loops over are guaranteed to be {@code IdshortD3Tensor<I>} tensors.
     * 
     */
