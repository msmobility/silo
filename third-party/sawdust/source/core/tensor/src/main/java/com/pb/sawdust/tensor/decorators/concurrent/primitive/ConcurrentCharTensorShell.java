...
/**
 * The {@code ConcurrentCharTensorShell} class provides a wrapper for implementations of the {@code CharTensor} interface
 ...
 */
public class ConcurrentCharTensorShell extends ConcurrentTensorShell<Character> implements CharTensor {
     ...
     */
    public ConcurrentCharTensorShell(CharTensor tensor, ConcurrentTensorLocks locks) {
        super(tensor,locks);
        this.tensor = tensor;
    }
