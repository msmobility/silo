...
/**
 * The {@code ConcurrentFloatD9TensorShell} class provides a wrapper for implementations of the {@code FloatD9Tensor} interface
 ...
 */
public class ConcurrentFloatD9TensorShell extends ConcurrentD9TensorShell<Float> implements FloatD9Tensor {
     ...
     */
    public ConcurrentFloatD9TensorShell(FloatD9Tensor tensor, ConcurrentD9TensorLocks locks) {
        super(tensor,locks);
        this.tensor = tensor;
    }
