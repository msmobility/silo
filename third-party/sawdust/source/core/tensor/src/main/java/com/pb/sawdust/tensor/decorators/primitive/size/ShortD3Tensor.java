...
/**
 * The {@code ShortD3Tensor} interface combines the {@code ShortTensor} and {@code D3Tensor} interfaces. The notes and caveats
 ...
 */
public interface ShortD3Tensor extends ShortTensor, D3Tensor<Short> {
    /**
     ...
     */
    short getCell(int d0index, int d1index, int d2index);
     ...
     *                                   equal to the size of its corresponding dimension.
     */
    void setCell(short value, int d0index, int d1index, int d2index);
    
    /**
     * {@inheritDoc}
     * 
     * The tensors this iterator loops over are guaranteed to be {@code ShortD2Tensor} tensors.
     * 
     */
