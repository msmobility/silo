...
/**
 * The {@code CharD4Tensor} interface combines the {@code CharTensor} and {@code D4Tensor} interfaces. The notes and caveats
 ...
 */
public interface CharD4Tensor extends CharTensor, D4Tensor<Character> {
    /**
     ...
     */
    char getCell(int d0index, int d1index, int d2index, int d3index);
     ...
     *                                   equal to the size of its corresponding dimension.
     */
    void setCell(char value, int d0index, int d1index, int d2index, int d3index);
    
    /**
     * {@inheritDoc}
     * 
     * The tensors this iterator loops over are guaranteed to be {@code CharD3Tensor} tensors.
     * 
     */
