...
/**
 * The {@code BooleanD4Tensor} interface combines the {@code BooleanTensor} and {@code D4Tensor} interfaces. The notes and caveats
 ...
 */
public interface BooleanD4Tensor extends BooleanTensor, D4Tensor<Boolean> {
    /**
     ...
     */
    boolean getCell(int d0index, int d1index, int d2index, int d3index);
     ...
     *                                   equal to the size of its corresponding dimension.
     */
    void setCell(boolean value, int d0index, int d1index, int d2index, int d3index);
    
    /**
     * {@inheritDoc}
     * 
     * The tensors this iterator loops over are guaranteed to be {@code BooleanD3Tensor} tensors.
     * 
     */
