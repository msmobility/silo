...
/**
 * The {@code D4Tensor} interface specifies a tensor with {@code 4} dimensions.
 *
 * @param <T>
 ...
 */
public interface D4Tensor<T> extends Tensor<T> {

    /**
     * Gets the number of dimensions in this tensor.
     *
     * @return {@code 4}, the number of dimensions in this tensor.
     */
    int size();
     ...
     */
    T getValue(int d0index, int d1index, int d2index, int d3index);
     ...
     *                                   equal to the size of its corresponding dimension.
     */
    void setValue(T value, int d0index, int d1index, int d2index, int d3index);
    
    /**
     * {@inheritDoc}
     * 
     * The tensors this iterator loops over are guaranteed to be {@code D3Tensor<T>} tensors.
     * 
     */
