...
/**
 * The {@code ShortD6Tensor} interface combines the {@code ShortTensor} and {@code D6Tensor} interfaces. The notes and caveats
 ...
 */
public interface ShortD6Tensor extends ShortTensor, D6Tensor<Short> {
    /**
     ...
     */
    short getCell(int d0index, int d1index, int d2index, int d3index, int d4index, int d5index);
     ...
     *                                   equal to the size of its corresponding dimension.
     */
    void setCell(short value, int d0index, int d1index, int d2index, int d3index, int d4index, int d5index);
    
    /**
     * {@inheritDoc}
     * 
     * The tensors this iterator loops over are guaranteed to be {@code ShortD5Tensor} tensors.
     * 
     */
