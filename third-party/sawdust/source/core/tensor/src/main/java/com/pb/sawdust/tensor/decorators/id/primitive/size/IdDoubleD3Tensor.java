...
/**
 * The {@code IdDoubleD3Tensor} class combines the {@code Double3Tensor} and {@code IdTensor} interfaces. It adds a
 * number of methods extending {@code DoubleD3Tensor} methods so that dimensional indices can be referenced by ids.
 *
 * @param <I>
 ...
 */
public interface IdDoubleD3Tensor<I> extends DoubleD3Tensor,IdDoubleTensor<I>,IdD3Tensor<Double,I> {
    /**
     ...
     */
    double getCellById(I d0id, I d1id, I d2id);
     ...
     * @throws IllegalArgumentException if any id is not valid in its respective dimension.
     */
    void setCellById(double value, I d0id, I d1id, I d2id);

    /**
     * {@inheritDoc}
     *
     * The tensors this iterator loops over are guaranteed to be {@code IddoubleD2Tensor<I>} tensors.
     * 
     */
