...
import com.pb.sawdust.tensor.decorators.primitive.size.FloatD9TensorShell;
import com.pb.sawdust.tensor.decorators.primitive.size.FloatD9Tensor;
import com.pb.sawdust.tensor.decorators.primitive.size.FloatD8Tensor;
...
/**
 * The {@code IdFloatD9TensorShell} class is a wrapper which sets a {@code FloatD9TensorShell} as an {@code IdTensor<I>} (or,
 * more specifically, an {@code IdFloatD9Tensor}).
 *
 * @author crf <br/>
 *         Started: Jan 16, 2009 9:47:43 AM
 *         Revised: Dec 14, 2009 12:35:34 PM
 */
public class IdFloatD9TensorShell<I> extends FloatD9TensorShell implements IdFloatD9Tensor<I> {
    private final FloatD9Tensor tensor;
    private final Index<I> index;

    IdFloatD9TensorShell(FloatD9Tensor tensor, Index<I> index) {
        super(tensor);
        this.tensor = tensor;
        this.index = index;
    }
    ...
    public IdFloatD9TensorShell(FloatD9Tensor tensor) {
    ...
    public IdFloatD9TensorShell(FloatD9Tensor tensor, I[] ... ids) {
     ...
     *                                  in {@code ids} contains repeated elements.
     */
    public IdFloatD9TensorShell(FloatD9Tensor tensor, List<List<I>> ids) {
        this(tensor,new BaseIndex<I>(tensor,ids));
    }
    ...
    public Iterator<Tensor<Float>> iterator() {
        return new Iterator<Tensor<Float>>() {
            private final Iterator<Tensor<Float>> iterator = IdFloatD9TensorShell.super.iterator();
            ...
            public Tensor<Float> next() {
                return new IdFloatD8TensorShell<I>((FloatD8Tensor) iterator.next());
            }
