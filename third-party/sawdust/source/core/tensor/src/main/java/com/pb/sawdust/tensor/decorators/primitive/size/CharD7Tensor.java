...
/**
 * The {@code CharD7Tensor} interface combines the {@code CharTensor} and {@code D7Tensor} interfaces. The notes and caveats
 ...
 */
public interface CharD7Tensor extends CharTensor, D7Tensor<Character> {
    /**
     ...
     */
    char getCell(int d0index, int d1index, int d2index, int d3index, int d4index, int d5index, int d6index);
     ...
     *                                   equal to the size of its corresponding dimension.
     */
    void setCell(char value, int d0index, int d1index, int d2index, int d3index, int d4index, int d5index, int d6index);
    
    /**
     * {@inheritDoc}
     * 
     * The tensors this iterator loops over are guaranteed to be {@code CharD6Tensor} tensors.
     * 
     */
