...
/**
 * The {@code LongD7Tensor} interface combines the {@code LongTensor} and {@code D7Tensor} interfaces. The notes and caveats
 ...
 */
public interface LongD7Tensor extends LongTensor, D7Tensor<Long> {
    /**
     ...
     */
    long getCell(int d0index, int d1index, int d2index, int d3index, int d4index, int d5index, int d6index);
     ...
     *                                   equal to the size of its corresponding dimension.
     */
    void setCell(long value, int d0index, int d1index, int d2index, int d3index, int d4index, int d5index, int d6index);
    
    /**
     * {@inheritDoc}
     * 
     * The tensors this iterator loops over are guaranteed to be {@code LongD6Tensor} tensors.
     * 
     */
