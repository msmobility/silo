...
/**
 * The {@code IdBooleanD9Tensor} class combines the {@code Boolean9Tensor} and {@code IdTensor} interfaces. It adds a
 * number of methods extending {@code BooleanD9Tensor} methods so that dimensional indices can be referenced by ids.
 *
 * @param <I>
 ...
 */
public interface IdBooleanD9Tensor<I> extends BooleanD9Tensor,IdBooleanTensor<I>,IdD9Tensor<Boolean,I> {
    /**
     ...
     */
    boolean getCellById(I d0id, I d1id, I d2id, I d3id, I d4id, I d5id, I d6id, I d7id, I d8id);
     ...
     * @throws IllegalArgumentException if any id is not valid in its respective dimension.
     */
    void setCellById(boolean value, I d0id, I d1id, I d2id, I d3id, I d4id, I d5id, I d6id, I d7id, I d8id);

    /**
     * {@inheritDoc}
     *
     * The tensors this iterator loops over are guaranteed to be {@code IdbooleanD8Tensor<I>} tensors.
     * 
     */
