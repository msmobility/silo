...
/**
 * The {@code IdLongD7Tensor} class combines the {@code Long7Tensor} and {@code IdTensor} interfaces. It adds a
 * number of methods extending {@code LongD7Tensor} methods so that dimensional indices can be referenced by ids.
 *
 * @param <I>
 ...
 */
public interface IdLongD7Tensor<I> extends LongD7Tensor,IdLongTensor<I>,IdD7Tensor<Long,I> {
    /**
     ...
     */
    long getCellById(I d0id, I d1id, I d2id, I d3id, I d4id, I d5id, I d6id);
     ...
     * @throws IllegalArgumentException if any id is not valid in its respective dimension.
     */
    void setCellById(long value, I d0id, I d1id, I d2id, I d3id, I d4id, I d5id, I d6id);

    /**
     * {@inheritDoc}
     *
     * The tensors this iterator loops over are guaranteed to be {@code IdlongD6Tensor<I>} tensors.
     * 
     */
