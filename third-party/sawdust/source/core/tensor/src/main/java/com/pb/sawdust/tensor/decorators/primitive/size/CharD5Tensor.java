...
/**
 * The {@code CharD5Tensor} interface combines the {@code CharTensor} and {@code D5Tensor} interfaces. The notes and caveats
 ...
 */
public interface CharD5Tensor extends CharTensor, D5Tensor<Character> {
    /**
     ...
     */
    char getCell(int d0index, int d1index, int d2index, int d3index, int d4index);
     ...
     *                                   equal to the size of its corresponding dimension.
     */
    void setCell(char value, int d0index, int d1index, int d2index, int d3index, int d4index);
    
    /**
     * {@inheritDoc}
     * 
     * The tensors this iterator loops over are guaranteed to be {@code CharD4Tensor} tensors.
     * 
     */
