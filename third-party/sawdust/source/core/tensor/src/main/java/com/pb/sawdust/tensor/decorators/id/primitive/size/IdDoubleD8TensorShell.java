...
import com.pb.sawdust.tensor.decorators.primitive.size.DoubleD8TensorShell;
...
/**
 * The {@code IdDoubleD8TensorShell} class is a wrapper which sets a {@code DoubleD8TensorShell} as an {@code IdTensor<I>} (or,
 * more specifically, an {@code IdDoubleD8Tensor}).
 *
 * @author crf <br/>
 *         Started: Jan 16, 2009 9:47:43 AM
 *         Revised: Dec 14, 2009 12:35:33 PM
 */
public class IdDoubleD8TensorShell<I> extends DoubleD8TensorShell implements IdDoubleD8Tensor<I> {
    private final DoubleD8Tensor tensor;
    private final Index<I> index;

    IdDoubleD8TensorShell(DoubleD8Tensor tensor, Index<I> index) {
        super(tensor);
        this.tensor = tensor;
        this.index = index;
    }
    ...
    public IdDoubleD8TensorShell(DoubleD8Tensor tensor) {
    ...
    public IdDoubleD8TensorShell(DoubleD8Tensor tensor, I[] ... ids) {
     ...
     *                                  in {@code ids} contains repeated elements.
     */
    public IdDoubleD8TensorShell(DoubleD8Tensor tensor, List<List<I>> ids) {
        this(tensor,new BaseIndex<I>(tensor,ids));
    }
    ...
    public Iterator<Tensor<Double>> iterator() {
        return new Iterator<Tensor<Double>>() {
            private final Iterator<Tensor<Double>> iterator = IdDoubleD8TensorShell.super.iterator();
            ...
            public Tensor<Double> next() {
                return new IdDoubleD7TensorShell<I>((DoubleD7Tensor) iterator.next());
            }
