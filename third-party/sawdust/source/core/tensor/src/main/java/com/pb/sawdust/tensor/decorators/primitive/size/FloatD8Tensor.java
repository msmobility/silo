...
/**
 * The {@code FloatD8Tensor} interface combines the {@code FloatTensor} and {@code D8Tensor} interfaces. The notes and caveats
 ...
 */
public interface FloatD8Tensor extends FloatTensor, D8Tensor<Float> {
    /**
     ...
     */
    float getCell(int d0index, int d1index, int d2index, int d3index, int d4index, int d5index, int d6index, int d7index);
     ...
     *                                   equal to the size of its corresponding dimension.
     */
    void setCell(float value, int d0index, int d1index, int d2index, int d3index, int d4index, int d5index, int d6index, int d7index);
    
    /**
     * {@inheritDoc}
     * 
     * The tensors this iterator loops over are guaranteed to be {@code FloatD7Tensor} tensors.
     * 
     */
