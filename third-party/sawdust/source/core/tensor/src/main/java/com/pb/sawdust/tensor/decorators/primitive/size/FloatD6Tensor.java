...
/**
 * The {@code FloatD6Tensor} interface combines the {@code FloatTensor} and {@code D6Tensor} interfaces. The notes and caveats
 ...
 */
public interface FloatD6Tensor extends FloatTensor, D6Tensor<Float> {
    /**
     ...
     */
    float getCell(int d0index, int d1index, int d2index, int d3index, int d4index, int d5index);
     ...
     *                                   equal to the size of its corresponding dimension.
     */
    void setCell(float value, int d0index, int d1index, int d2index, int d3index, int d4index, int d5index);
    
    /**
     * {@inheritDoc}
     * 
     * The tensors this iterator loops over are guaranteed to be {@code FloatD5Tensor} tensors.
     * 
     */
