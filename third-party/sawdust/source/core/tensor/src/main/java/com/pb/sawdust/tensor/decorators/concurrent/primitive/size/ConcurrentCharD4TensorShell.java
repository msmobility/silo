...
/**
 * The {@code ConcurrentCharD4TensorShell} class provides a wrapper for implementations of the {@code CharD4Tensor} interface
 ...
 */
public class ConcurrentCharD4TensorShell extends ConcurrentD4TensorShell<Character> implements CharD4Tensor {
     ...
     */
    public ConcurrentCharD4TensorShell(CharD4Tensor tensor, ConcurrentD4TensorLocks locks) {
        super(tensor,locks);
        this.tensor = tensor;
    }
