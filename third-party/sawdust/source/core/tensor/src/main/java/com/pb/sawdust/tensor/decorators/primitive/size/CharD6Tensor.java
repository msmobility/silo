...
/**
 * The {@code CharD6Tensor} interface combines the {@code CharTensor} and {@code D6Tensor} interfaces. The notes and caveats
 ...
 */
public interface CharD6Tensor extends CharTensor, D6Tensor<Character> {
    /**
     ...
     */
    char getCell(int d0index, int d1index, int d2index, int d3index, int d4index, int d5index);
     ...
     *                                   equal to the size of its corresponding dimension.
     */
    void setCell(char value, int d0index, int d1index, int d2index, int d3index, int d4index, int d5index);
    
    /**
     * {@inheritDoc}
     * 
     * The tensors this iterator loops over are guaranteed to be {@code CharD5Tensor} tensors.
     * 
     */
