...
/**
 * The {@code IdBooleanD7Tensor} class combines the {@code Boolean7Tensor} and {@code IdTensor} interfaces. It adds a
 * number of methods extending {@code BooleanD7Tensor} methods so that dimensional indices can be referenced by ids.
 *
 * @param <I>
 ...
 */
public interface IdBooleanD7Tensor<I> extends BooleanD7Tensor,IdBooleanTensor<I>,IdD7Tensor<Boolean,I> {
    /**
     ...
     */
    boolean getCellById(I d0id, I d1id, I d2id, I d3id, I d4id, I d5id, I d6id);
     ...
     * @throws IllegalArgumentException if any id is not valid in its respective dimension.
     */
    void setCellById(boolean value, I d0id, I d1id, I d2id, I d3id, I d4id, I d5id, I d6id);

    /**
     * {@inheritDoc}
     *
     * The tensors this iterator loops over are guaranteed to be {@code IdbooleanD6Tensor<I>} tensors.
     * 
     */
