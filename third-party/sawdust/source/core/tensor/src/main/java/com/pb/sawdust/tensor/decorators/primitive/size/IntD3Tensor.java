...
/**
 * The {@code IntD3Tensor} interface combines the {@code IntTensor} and {@code D3Tensor} interfaces. The notes and caveats
 ...
 */
public interface IntD3Tensor extends IntTensor, D3Tensor<Integer> {
    /**
     ...
     */
    int getCell(int d0index, int d1index, int d2index);
     ...
     *                                   equal to the size of its corresponding dimension.
     */
    void setCell(int value, int d0index, int d1index, int d2index);
    
    /**
     * {@inheritDoc}
     * 
     * The tensors this iterator loops over are guaranteed to be {@code IntD2Tensor} tensors.
     * 
     */
