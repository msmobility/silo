...
/**
 * The {@code ConcurrentLongD9TensorShell} class provides a wrapper for implementations of the {@code LongD9Tensor} interface
 ...
 */
public class ConcurrentLongD9TensorShell extends ConcurrentD9TensorShell<Long> implements LongD9Tensor {
     ...
     */
    public ConcurrentLongD9TensorShell(LongD9Tensor tensor, ConcurrentD9TensorLocks locks) {
        super(tensor,locks);
        this.tensor = tensor;
    }
