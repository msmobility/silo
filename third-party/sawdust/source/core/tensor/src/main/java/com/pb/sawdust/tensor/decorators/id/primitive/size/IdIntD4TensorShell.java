...
import com.pb.sawdust.tensor.decorators.primitive.size.IntD4TensorShell;
...
/**
 * The {@code IdIntD4TensorShell} class is a wrapper which sets a {@code IntD4TensorShell} as an {@code IdTensor<I>} (or,
 * more specifically, an {@code IdIntD4Tensor}).
 *
 * @author crf <br/>
 *         Started: Jan 16, 2009 9:47:43 AM
 *         Revised: Dec 14, 2009 12:35:27 PM
 */
public class IdIntD4TensorShell<I> extends IntD4TensorShell implements IdIntD4Tensor<I> {
    private final IntD4Tensor tensor;
    private final Index<I> index;

    IdIntD4TensorShell(IntD4Tensor tensor, Index<I> index) {
        super(tensor);
        this.tensor = tensor;
        this.index = index;
    }
    ...
    public IdIntD4TensorShell(IntD4Tensor tensor) {
    ...
    public IdIntD4TensorShell(IntD4Tensor tensor, I[] ... ids) {
     ...
     *                                  in {@code ids} contains repeated elements.
     */
    public IdIntD4TensorShell(IntD4Tensor tensor, List<List<I>> ids) {
        this(tensor,new BaseIndex<I>(tensor,ids));
    }
    ...
    public Iterator<Tensor<Integer>> iterator() {
        return new Iterator<Tensor<Integer>>() {
            private final Iterator<Tensor<Integer>> iterator = IdIntD4TensorShell.super.iterator();
            ...
            public Tensor<Integer> next() {
                return new IdIntD3TensorShell<I>((IntD3Tensor) iterator.next());
            }
