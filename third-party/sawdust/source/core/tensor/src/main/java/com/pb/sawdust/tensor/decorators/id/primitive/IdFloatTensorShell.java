...
/**
 * The {@code IdFloatTensorShell} class is a wrapper which sets a {@code FloatTensor} as an {@code IdTensor<I>} (or,
 * more specifically, an {@code IdFloatTensor}).
 * 
 * @author crf <br/>
 *         Started: Jan 15, 2009 11:25:11 PM
 *         Revised: Dec 14, 2009 12:35:34 PM
 */
public class IdFloatTensorShell<I> extends AbstractFloatTensor implements IdFloatTensor<I> {
    private final FloatTensor tensor;
    private final Index<I> index;

    private IdFloatTensorShell(FloatTensor tensor, Index<I> index) {
    ...
    public IdFloatTensorShell(FloatTensor tensor) {
    ...
    public IdFloatTensorShell(FloatTensor tensor, I[] ... ids) {
     ...
     *                                  in {@code ids} contains repeated elements.
     */
    public IdFloatTensorShell(FloatTensor tensor, List<List<I>> ids) {
        this(tensor,new BaseIndex<I>(tensor,ids));
    }
    ...
    public Iterator<Tensor<Float>> iterator() {
        return new Iterator<Tensor<Float>>() {
            private final Iterator<Tensor<Float>> it = IdFloatTensorShell.super.iterator();
