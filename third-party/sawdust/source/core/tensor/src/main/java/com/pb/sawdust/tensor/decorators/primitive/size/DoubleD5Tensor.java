...
/**
 * The {@code DoubleD5Tensor} interface combines the {@code DoubleTensor} and {@code D5Tensor} interfaces. The notes and caveats
 ...
 */
public interface DoubleD5Tensor extends DoubleTensor, D5Tensor<Double> {
    /**
     ...
     */
    double getCell(int d0index, int d1index, int d2index, int d3index, int d4index);
     ...
     *                                   equal to the size of its corresponding dimension.
     */
    void setCell(double value, int d0index, int d1index, int d2index, int d3index, int d4index);
    
    /**
     * {@inheritDoc}
     * 
     * The tensors this iterator loops over are guaranteed to be {@code DoubleD4Tensor} tensors.
     * 
     */
