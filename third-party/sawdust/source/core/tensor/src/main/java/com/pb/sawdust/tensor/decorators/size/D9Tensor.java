...
/**
 * The {@code D9Tensor} interface specifies a tensor with {@code 9} dimensions.
 *
 * @param <T>
 ...
 */
public interface D9Tensor<T> extends Tensor<T> {

    /**
     * Gets the number of dimensions in this tensor.
     *
     * @return {@code 9}, the number of dimensions in this tensor.
     */
    int size();
     ...
     */
    T getValue(int d0index, int d1index, int d2index, int d3index, int d4index, int d5index, int d6index, int d7index, int d8index);
     ...
     *                                   equal to the size of its corresponding dimension.
     */
    void setValue(T value, int d0index, int d1index, int d2index, int d3index, int d4index, int d5index, int d6index, int d7index, int d8index);
    
    /**
     * {@inheritDoc}
     * 
     * The tensors this iterator loops over are guaranteed to be {@code D8Tensor<T>} tensors.
     * 
     */
