...
/**
 * The {@code CharD8Tensor} interface combines the {@code CharTensor} and {@code D8Tensor} interfaces. The notes and caveats
 ...
 */
public interface CharD8Tensor extends CharTensor, D8Tensor<Character> {
    /**
     ...
     */
    char getCell(int d0index, int d1index, int d2index, int d3index, int d4index, int d5index, int d6index, int d7index);
     ...
     *                                   equal to the size of its corresponding dimension.
     */
    void setCell(char value, int d0index, int d1index, int d2index, int d3index, int d4index, int d5index, int d6index, int d7index);
    
    /**
     * {@inheritDoc}
     * 
     * The tensors this iterator loops over are guaranteed to be {@code CharD7Tensor} tensors.
     * 
     */
