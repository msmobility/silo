...
/**
 * The {@code IdCharD5Tensor} class combines the {@code Char5Tensor} and {@code IdTensor} interfaces. It adds a
 * number of methods extending {@code CharD5Tensor} methods so that dimensional indices can be referenced by ids.
 *
 * @param <I>
 ...
 */
public interface IdCharD5Tensor<I> extends CharD5Tensor,IdCharTensor<I>,IdD5Tensor<Character,I> {
    /**
     ...
     */
    char getCellById(I d0id, I d1id, I d2id, I d3id, I d4id);
     ...
     * @throws IllegalArgumentException if any id is not valid in its respective dimension.
     */
    void setCellById(char value, I d0id, I d1id, I d2id, I d3id, I d4id);

    /**
     * {@inheritDoc}
     *
     * The tensors this iterator loops over are guaranteed to be {@code IdcharD4Tensor<I>} tensors.
     * 
     */
