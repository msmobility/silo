...
/**
 * The {@code IdDoubleMatrix} class combines the {@code Double2Tensor} and {@code IdTensor} interfaces. It adds a
 * number of methods extending {@code DoubleMatrix} methods so that dimensional indices can be referenced by ids.
 *
 * @param <I>
 ...
 */
public interface IdDoubleD2Tensor<I> extends DoubleMatrix,IdDoubleTensor<I>,IdMatrix<Double,I> {
    /**
     ...
     */
    double getCellById(I d0id, I d1id);
     ...
     * @throws IllegalArgumentException if any id is not valid in its respective dimension.
     */
    void setCellById(double value, I d0id, I d1id);

    /**
     * {@inheritDoc}
     *
     * The tensors this iterator loops over are guaranteed to be {@code IddoubleD1Tensor<I>} tensors.
     * 
     */
