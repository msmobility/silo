...
import com.pb.sawdust.tensor.decorators.primitive.size.BooleanD6TensorShell;
...
/**
 * The {@code IdBooleanD6TensorShell} class is a wrapper which sets a {@code BooleanD6TensorShell} as an {@code IdTensor<I>} (or,
 * more specifically, an {@code IdBooleanD6Tensor}).
 *
 * @author crf <br/>
 *         Started: Jan 16, 2009 9:47:43 AM
 *         Revised: Dec 14, 2009 12:35:30 PM
 */
public class IdBooleanD6TensorShell<I> extends BooleanD6TensorShell implements IdBooleanD6Tensor<I> {
    private final BooleanD6Tensor tensor;
    private final Index<I> index;

    IdBooleanD6TensorShell(BooleanD6Tensor tensor, Index<I> index) {
        super(tensor);
        this.tensor = tensor;
        this.index = index;
    }
    ...
    public IdBooleanD6TensorShell(BooleanD6Tensor tensor) {
    ...
    public IdBooleanD6TensorShell(BooleanD6Tensor tensor, I[] ... ids) {
     ...
     *                                  in {@code ids} contains repeated elements.
     */
    public IdBooleanD6TensorShell(BooleanD6Tensor tensor, List<List<I>> ids) {
        this(tensor,new BaseIndex<I>(tensor,ids));
    }
    ...
    public Iterator<Tensor<Boolean>> iterator() {
        return new Iterator<Tensor<Boolean>>() {
            private final Iterator<Tensor<Boolean>> iterator = IdBooleanD6TensorShell.super.iterator();
            ...
            public Tensor<Boolean> next() {
                return new IdBooleanD5TensorShell<I>((BooleanD5Tensor) iterator.next());
            }
