 ...
 */
public abstract class IntD2TensorTest extends IntTensorTest {
    IntD2Tensor pdTensor;

    abstract protected IntD2Tensor getTensor(TypeSafeArray<Integer> data);
    
    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (IntD2Tensor) tensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Integer> t : tensor)
            assertTrue(t instanceof IntD1Tensor);
    }
}
