...
/**
 * The {@code CharD1Tensor} interface combines the {@code CharTensor} and {@code Vector} interfaces. The notes and caveats
 ...
 */
public interface CharD1Tensor extends CharTensor, Vector<Character> {
    /**
     ...
     *                                   equal to the size of its corresponding dimension.
     */
    void setCell(char value, int index);
    
    /**
     * {@inheritDoc}
     * 
     * The tensors this iterator loops over are guaranteed to be {@code CharD0Tensor} tensors.
     * 
     */
