 ...
 */
public abstract class DoubleD9TensorTest extends DoubleTensorTest {
    DoubleD9Tensor pdTensor;

    abstract protected DoubleD9Tensor getTensor(TypeSafeArray<Double> data);
    
    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (DoubleD9Tensor) tensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Double> t : tensor)
            assertTrue(t instanceof DoubleD8Tensor);
    }
}
