 ...
 */
public abstract class CharD7TensorTest extends CharTensorTest {
    CharD7Tensor pdTensor;

    abstract protected CharD7Tensor getTensor(TypeSafeArray<Character> data);
    
    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (CharD7Tensor) tensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Character> t : tensor)
            assertTrue(t instanceof CharD6Tensor);
    }
}
