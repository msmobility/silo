 ...
 */
public abstract class ShortD7TensorTest extends ShortTensorTest {
    ShortD7Tensor pdTensor;

    abstract protected ShortD7Tensor getTensor(TypeSafeArray<Short> data);
    
    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (ShortD7Tensor) tensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Short> t : tensor)
            assertTrue(t instanceof ShortD6Tensor);
    }
}
