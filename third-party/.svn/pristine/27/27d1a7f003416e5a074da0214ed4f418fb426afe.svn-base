...
/**
 * The {@code FloatD5Tensor} interface combines the {@code FloatTensor} and {@code D5Tensor} interfaces. The notes and caveats
 ...
 */
public interface FloatD5Tensor extends FloatTensor, D5Tensor<Float> {
    /**
     ...
     */
    float getCell(int d0index, int d1index, int d2index, int d3index, int d4index);
     ...
     *                                   equal to the size of its corresponding dimension.
     */
    void setCell(float value, int d0index, int d1index, int d2index, int d3index, int d4index);
    
    /**
     * {@inheritDoc}
     * 
     * The tensors this iterator loops over are guaranteed to be {@code FloatD4Tensor} tensors.
     * 
     */
