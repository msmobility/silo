...
/**
 * The {@code ConcurrentShortD7TensorShell} class provides a wrapper for implementations of the {@code ShortD7Tensor} interface
 ...
 */
public class ConcurrentShortD7TensorShell extends ConcurrentD7TensorShell<Short> implements ShortD7Tensor {
     ...
     */
    public ConcurrentShortD7TensorShell(ShortD7Tensor tensor, ConcurrentD7TensorLocks locks) {
        super(tensor,locks);
        this.tensor = tensor;
    }
