...
/**
 * The {@code FloatD7Tensor} interface combines the {@code FloatTensor} and {@code D7Tensor} interfaces. The notes and caveats
 ...
 */
public interface FloatD7Tensor extends FloatTensor, D7Tensor<Float> {
    /**
     ...
     */
    float getCell(int d0index, int d1index, int d2index, int d3index, int d4index, int d5index, int d6index);
     ...
     *                                   equal to the size of its corresponding dimension.
     */
    void setCell(float value, int d0index, int d1index, int d2index, int d3index, int d4index, int d5index, int d6index);
    
    /**
     * {@inheritDoc}
     * 
     * The tensors this iterator loops over are guaranteed to be {@code FloatD6Tensor} tensors.
     * 
     */
