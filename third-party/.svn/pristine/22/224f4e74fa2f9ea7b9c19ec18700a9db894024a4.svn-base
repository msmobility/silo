...
/**
 * The {@code BooleanD7Tensor} interface combines the {@code BooleanTensor} and {@code D7Tensor} interfaces. The notes and caveats
 ...
 */
public interface BooleanD7Tensor extends BooleanTensor, D7Tensor<Boolean> {
    /**
     ...
     */
    boolean getCell(int d0index, int d1index, int d2index, int d3index, int d4index, int d5index, int d6index);
     ...
     *                                   equal to the size of its corresponding dimension.
     */
    void setCell(boolean value, int d0index, int d1index, int d2index, int d3index, int d4index, int d5index, int d6index);
    
    /**
     * {@inheritDoc}
     * 
     * The tensors this iterator loops over are guaranteed to be {@code BooleanD6Tensor} tensors.
     * 
     */
