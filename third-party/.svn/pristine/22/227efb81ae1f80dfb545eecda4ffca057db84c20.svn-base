 ...
 */
public abstract class IdFloatD3TensorTest<I> extends IdFloatTensorTest<I> {
    IdFloatD3Tensor<I> pdTensor;

    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (IdFloatD3Tensor<I>) pTensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Float> t : tensor)
            assertTrue(t instanceof IdFloatD2Tensor);
    }   
