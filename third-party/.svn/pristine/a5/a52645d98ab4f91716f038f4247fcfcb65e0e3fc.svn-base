 ...
 */
public abstract class IntD4TensorTest extends IntTensorTest {
    IntD4Tensor pdTensor;

    abstract protected IntD4Tensor getTensor(TypeSafeArray<Integer> data);
    
    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (IntD4Tensor) tensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Integer> t : tensor)
            assertTrue(t instanceof IntD3Tensor);
    }
}
