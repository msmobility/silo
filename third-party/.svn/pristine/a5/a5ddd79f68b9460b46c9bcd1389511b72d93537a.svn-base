 ...
 */
public abstract class DoubleD3TensorTest extends DoubleTensorTest {
    DoubleD3Tensor pdTensor;

    abstract protected DoubleD3Tensor getTensor(TypeSafeArray<Double> data);
    
    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (DoubleD3Tensor) tensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Double> t : tensor)
            assertTrue(t instanceof DoubleD2Tensor);
    }
}
