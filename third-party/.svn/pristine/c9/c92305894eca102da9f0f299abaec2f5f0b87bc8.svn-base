...
/**
 * The {@code ConcurrentIntD6TensorShell} class provides a wrapper for implementations of the {@code IntD6Tensor} interface
 ...
 */
public class ConcurrentIntD6TensorShell extends ConcurrentD6TensorShell<Integer> implements IntD6Tensor {
     ...
     */
    public ConcurrentIntD6TensorShell(IntD6Tensor tensor, ConcurrentD6TensorLocks locks) {
        super(tensor,locks);
        this.tensor = tensor;
    }
