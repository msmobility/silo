...
import com.pb.sawdust.tensor.decorators.primitive.size.IntD8TensorShell;
...
/**
 * The {@code IdIntD8TensorShell} class is a wrapper which sets a {@code IntD8TensorShell} as an {@code IdTensor<I>} (or,
 * more specifically, an {@code IdIntD8Tensor}).
 *
 * @author crf <br/>
 *         Started: Jan 16, 2009 9:47:43 AM
 *         Revised: Dec 14, 2009 12:35:32 PM
 */
public class IdIntD8TensorShell<I> extends IntD8TensorShell implements IdIntD8Tensor<I> {
    private final IntD8Tensor tensor;
    private final Index<I> index;

    IdIntD8TensorShell(IntD8Tensor tensor, Index<I> index) {
        super(tensor);
        this.tensor = tensor;
        this.index = index;
    }
    ...
    public IdIntD8TensorShell(IntD8Tensor tensor) {
    ...
    public IdIntD8TensorShell(IntD8Tensor tensor, I[] ... ids) {
     ...
     *                                  in {@code ids} contains repeated elements.
     */
    public IdIntD8TensorShell(IntD8Tensor tensor, List<List<I>> ids) {
        this(tensor,new BaseIndex<I>(tensor,ids));
    }
    ...
    public Iterator<Tensor<Integer>> iterator() {
        return new Iterator<Tensor<Integer>>() {
            private final Iterator<Tensor<Integer>> iterator = IdIntD8TensorShell.super.iterator();
            ...
            public Tensor<Integer> next() {
                return new IdIntD7TensorShell<I>((IntD7Tensor) iterator.next());
            }
