...
/**
 * The {@code DoubleD6Tensor} interface combines the {@code DoubleTensor} and {@code D6Tensor} interfaces. The notes and caveats
 ...
 */
public interface DoubleD6Tensor extends DoubleTensor, D6Tensor<Double> {
    /**
     ...
     */
    double getCell(int d0index, int d1index, int d2index, int d3index, int d4index, int d5index);
     ...
     *                                   equal to the size of its corresponding dimension.
     */
    void setCell(double value, int d0index, int d1index, int d2index, int d3index, int d4index, int d5index);
    
    /**
     * {@inheritDoc}
     * 
     * The tensors this iterator loops over are guaranteed to be {@code DoubleD5Tensor} tensors.
     * 
     */
