...
/**
 * The {@code IdByteD9Tensor} class combines the {@code Byte9Tensor} and {@code IdTensor} interfaces. It adds a
 * number of methods extending {@code ByteD9Tensor} methods so that dimensional indices can be referenced by ids.
 *
 * @param <I>
 ...
 */
public interface IdByteD9Tensor<I> extends ByteD9Tensor,IdByteTensor<I>,IdD9Tensor<Byte,I> {
    /**
     ...
     */
    byte getCellById(I d0id, I d1id, I d2id, I d3id, I d4id, I d5id, I d6id, I d7id, I d8id);
     ...
     * @throws IllegalArgumentException if any id is not valid in its respective dimension.
     */
    void setCellById(byte value, I d0id, I d1id, I d2id, I d3id, I d4id, I d5id, I d6id, I d7id, I d8id);

    /**
     * {@inheritDoc}
     *
     * The tensors this iterator loops over are guaranteed to be {@code IdbyteD8Tensor<I>} tensors.
     * 
     */
