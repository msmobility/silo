 ...
 */
public abstract class IdIntD4TensorTest<I> extends IdIntTensorTest<I> {
    IdIntD4Tensor<I> pdTensor;

    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (IdIntD4Tensor<I>) pTensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Integer> t : tensor)
            assertTrue(t instanceof IdIntD3Tensor);
    }   
