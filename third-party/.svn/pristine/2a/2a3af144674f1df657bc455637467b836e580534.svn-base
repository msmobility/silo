...
/**
 * The {@code IdBooleanD4Tensor} class combines the {@code Boolean4Tensor} and {@code IdTensor} interfaces. It adds a
 * number of methods extending {@code BooleanD4Tensor} methods so that dimensional indices can be referenced by ids.
 *
 * @param <I>
 ...
 */
public interface IdBooleanD4Tensor<I> extends BooleanD4Tensor,IdBooleanTensor<I>,IdD4Tensor<Boolean,I> {
    /**
     ...
     */
    boolean getCellById(I d0id, I d1id, I d2id, I d3id);
     ...
     * @throws IllegalArgumentException if any id is not valid in its respective dimension.
     */
    void setCellById(boolean value, I d0id, I d1id, I d2id, I d3id);

    /**
     * {@inheritDoc}
     *
     * The tensors this iterator loops over are guaranteed to be {@code IdbooleanD3Tensor<I>} tensors.
     * 
     */
