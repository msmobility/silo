...
/**
 * The {@code LongD4Tensor} interface combines the {@code LongTensor} and {@code D4Tensor} interfaces. The notes and caveats
 ...
 */
public interface LongD4Tensor extends LongTensor, D4Tensor<Long> {
    /**
     ...
     */
    long getCell(int d0index, int d1index, int d2index, int d3index);
     ...
     *                                   equal to the size of its corresponding dimension.
     */
    void setCell(long value, int d0index, int d1index, int d2index, int d3index);
    
    /**
     * {@inheritDoc}
     * 
     * The tensors this iterator loops over are guaranteed to be {@code LongD3Tensor} tensors.
     * 
     */
