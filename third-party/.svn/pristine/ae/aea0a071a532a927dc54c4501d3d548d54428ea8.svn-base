...
/**
 * The {@code LongD3Tensor} interface combines the {@code LongTensor} and {@code D3Tensor} interfaces. The notes and caveats
 ...
 */
public interface LongD3Tensor extends LongTensor, D3Tensor<Long> {
    /**
     ...
     */
    long getCell(int d0index, int d1index, int d2index);
     ...
     *                                   equal to the size of its corresponding dimension.
     */
    void setCell(long value, int d0index, int d1index, int d2index);
    
    /**
     * {@inheritDoc}
     * 
     * The tensors this iterator loops over are guaranteed to be {@code LongD2Tensor} tensors.
     * 
     */
