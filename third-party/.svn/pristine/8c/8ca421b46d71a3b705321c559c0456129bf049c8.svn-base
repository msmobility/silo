...
/**
 * The {@code IdFloatD8Tensor} class combines the {@code Float8Tensor} and {@code IdTensor} interfaces. It adds a
 * number of methods extending {@code FloatD8Tensor} methods so that dimensional indices can be referenced by ids.
 *
 * @param <I>
 ...
 */
public interface IdFloatD8Tensor<I> extends FloatD8Tensor,IdFloatTensor<I>,IdD8Tensor<Float,I> {
    /**
     ...
     */
    float getCellById(I d0id, I d1id, I d2id, I d3id, I d4id, I d5id, I d6id, I d7id);
     ...
     * @throws IllegalArgumentException if any id is not valid in its respective dimension.
     */
    void setCellById(float value, I d0id, I d1id, I d2id, I d3id, I d4id, I d5id, I d6id, I d7id);

    /**
     * {@inheritDoc}
     *
     * The tensors this iterator loops over are guaranteed to be {@code IdfloatD7Tensor<I>} tensors.
     * 
     */
