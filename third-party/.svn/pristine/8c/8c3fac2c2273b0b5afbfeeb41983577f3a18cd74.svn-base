 ...
 */
public abstract class FloatD9TensorTest extends FloatTensorTest {
    FloatD9Tensor pdTensor;

    abstract protected FloatD9Tensor getTensor(TypeSafeArray<Float> data);
    
    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (FloatD9Tensor) tensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Float> t : tensor)
            assertTrue(t instanceof FloatD8Tensor);
    }
}
