 ...
 */
public abstract class IntD7TensorTest extends IntTensorTest {
    IntD7Tensor pdTensor;

    abstract protected IntD7Tensor getTensor(TypeSafeArray<Integer> data);
    
    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (IntD7Tensor) tensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Integer> t : tensor)
            assertTrue(t instanceof IntD6Tensor);
    }
}
