 ...
 */
public abstract class LongD9TensorTest extends LongTensorTest {
    LongD9Tensor pdTensor;

    abstract protected LongD9Tensor getTensor(TypeSafeArray<Long> data);
    
    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (LongD9Tensor) tensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Long> t : tensor)
            assertTrue(t instanceof LongD8Tensor);
    }
}
