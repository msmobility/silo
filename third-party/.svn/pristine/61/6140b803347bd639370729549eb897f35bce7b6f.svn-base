...
/**
 * The {@code IntD6Tensor} interface combines the {@code IntTensor} and {@code D6Tensor} interfaces. The notes and caveats
 ...
 */
public interface IntD6Tensor extends IntTensor, D6Tensor<Integer> {
    /**
     ...
     */
    int getCell(int d0index, int d1index, int d2index, int d3index, int d4index, int d5index);
     ...
     *                                   equal to the size of its corresponding dimension.
     */
    void setCell(int value, int d0index, int d1index, int d2index, int d3index, int d4index, int d5index);
    
    /**
     * {@inheritDoc}
     * 
     * The tensors this iterator loops over are guaranteed to be {@code IntD5Tensor} tensors.
     * 
     */
