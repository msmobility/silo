...
/**
 * The {@code FloatD4Tensor} interface combines the {@code FloatTensor} and {@code D4Tensor} interfaces. The notes and caveats
 ...
 */
public interface FloatD4Tensor extends FloatTensor, D4Tensor<Float> {
    /**
     ...
     */
    float getCell(int d0index, int d1index, int d2index, int d3index);
     ...
     *                                   equal to the size of its corresponding dimension.
     */
    void setCell(float value, int d0index, int d1index, int d2index, int d3index);
    
    /**
     * {@inheritDoc}
     * 
     * The tensors this iterator loops over are guaranteed to be {@code FloatD3Tensor} tensors.
     * 
     */
