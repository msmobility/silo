...
/**
 * The {@code IdIntD8Tensor} class combines the {@code Int8Tensor} and {@code IdTensor} interfaces. It adds a
 * number of methods extending {@code IntD8Tensor} methods so that dimensional indices can be referenced by ids.
 *
 * @param <I>
 ...
 */
public interface IdIntD8Tensor<I> extends IntD8Tensor,IdIntTensor<I>,IdD8Tensor<Integer,I> {
    /**
     ...
     */
    int getCellById(I d0id, I d1id, I d2id, I d3id, I d4id, I d5id, I d6id, I d7id);
     ...
     * @throws IllegalArgumentException if any id is not valid in its respective dimension.
     */
    void setCellById(int value, I d0id, I d1id, I d2id, I d3id, I d4id, I d5id, I d6id, I d7id);

    /**
     * {@inheritDoc}
     *
     * The tensors this iterator loops over are guaranteed to be {@code IdintD7Tensor<I>} tensors.
     * 
     */
