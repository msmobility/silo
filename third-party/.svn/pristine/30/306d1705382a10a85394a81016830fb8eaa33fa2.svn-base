...
/**
 * The {@code IntD7Tensor} interface combines the {@code IntTensor} and {@code D7Tensor} interfaces. The notes and caveats
 ...
 */
public interface IntD7Tensor extends IntTensor, D7Tensor<Integer> {
    /**
     ...
     */
    int getCell(int d0index, int d1index, int d2index, int d3index, int d4index, int d5index, int d6index);
     ...
     *                                   equal to the size of its corresponding dimension.
     */
    void setCell(int value, int d0index, int d1index, int d2index, int d3index, int d4index, int d5index, int d6index);
    
    /**
     * {@inheritDoc}
     * 
     * The tensors this iterator loops over are guaranteed to be {@code IntD6Tensor} tensors.
     * 
     */
