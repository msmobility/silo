...
/**
 * The {@code IdFloatD6Tensor} class combines the {@code Float6Tensor} and {@code IdTensor} interfaces. It adds a
 * number of methods extending {@code FloatD6Tensor} methods so that dimensional indices can be referenced by ids.
 *
 * @param <I>
 ...
 */
public interface IdFloatD6Tensor<I> extends FloatD6Tensor,IdFloatTensor<I>,IdD6Tensor<Float,I> {
    /**
     ...
     */
    float getCellById(I d0id, I d1id, I d2id, I d3id, I d4id, I d5id);
     ...
     * @throws IllegalArgumentException if any id is not valid in its respective dimension.
     */
    void setCellById(float value, I d0id, I d1id, I d2id, I d3id, I d4id, I d5id);

    /**
     * {@inheritDoc}
     *
     * The tensors this iterator loops over are guaranteed to be {@code IdfloatD5Tensor<I>} tensors.
     * 
     */
