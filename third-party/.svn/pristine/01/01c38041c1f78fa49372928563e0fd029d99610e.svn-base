...
/**
 * The {@code IntD2Tensor} interface combines the {@code IntTensor} and {@code Matrix} interfaces. The notes and caveats
 ...
 */
public interface IntD2Tensor extends IntTensor, Matrix<Integer> {
    /**
     ...
     */
    int getCell(int d0index, int d1index);
     ...
     *                                   equal to the size of its corresponding dimension.
     */
    void setCell(int value, int d0index, int d1index);
    
    /**
     * {@inheritDoc}
     * 
     * The tensors this iterator loops over are guaranteed to be {@code IntD1Tensor} tensors.
     * 
     */
