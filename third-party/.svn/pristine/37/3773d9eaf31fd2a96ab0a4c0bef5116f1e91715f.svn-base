 ...
 */
public abstract class IdDoubleD5TensorTest<I> extends IdDoubleTensorTest<I> {
    IdDoubleD5Tensor<I> pdTensor;

    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (IdDoubleD5Tensor<I>) pTensor;
    }
    ...
    public void testGetCellByIdD() {
        ...
        assertAlmostEquals(pData.get(index), pdTensor.getCellById(ids[0],ids[1],ids[2],ids[3],ids[4]));
    }
    ...
    public void testSetCellByIdD() {
        ...
        assertAlmostEquals(value,pdTensor.getCell(index[0],index[1],index[2],index[3],index[4]));
    }
    ...
    public void testIteratorType() {
        for (Tensor<Double> t : tensor)
            assertTrue(t instanceof IdDoubleD4Tensor);
    }   
    ...
    public void testGetValueByIdD() {
        ...
        for (int i : range(index.length))
            index[i] = random.nextInt(dimensions[i]);
        I[] ids = getIdsFromIndices(index);
        assertAlmostEquals(data.getValue(index), pdTensor.getValueById(ids[0],ids[1],ids[2],ids[3],ids[4]));
    }
    ...
    public void testSetValueByIdD() {
        ...
        assertAlmostEquals(value,idTensor.getValue(index[0],index[1],index[2],index[3],index[4]));
    }
    ...
    public void TestSizeSpecific() {
        assertAlmostEquals(5,pdTensor.size());
    }
