 ...
 */
public abstract class IdLongD9TensorTest<I> extends IdLongTensorTest<I> {
    IdLongD9Tensor<I> pdTensor;

    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (IdLongD9Tensor<I>) pTensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Long> t : tensor)
            assertTrue(t instanceof IdLongD8Tensor);
    }   
