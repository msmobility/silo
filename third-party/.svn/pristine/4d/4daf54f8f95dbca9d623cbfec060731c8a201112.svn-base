...
/**
 * The {@code IdLongD3Tensor} class combines the {@code Long3Tensor} and {@code IdTensor} interfaces. It adds a
 * number of methods extending {@code LongD3Tensor} methods so that dimensional indices can be referenced by ids.
 *
 * @param <I>
 ...
 */
public interface IdLongD3Tensor<I> extends LongD3Tensor,IdLongTensor<I>,IdD3Tensor<Long,I> {
    /**
     ...
     */
    long getCellById(I d0id, I d1id, I d2id);
     ...
     * @throws IllegalArgumentException if any id is not valid in its respective dimension.
     */
    void setCellById(long value, I d0id, I d1id, I d2id);

    /**
     * {@inheritDoc}
     *
     * The tensors this iterator loops over are guaranteed to be {@code IdlongD2Tensor<I>} tensors.
     * 
     */
