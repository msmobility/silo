...
/**
 * The {@code IdBooleanD3Tensor} class combines the {@code Boolean3Tensor} and {@code IdTensor} interfaces. It adds a
 * number of methods extending {@code BooleanD3Tensor} methods so that dimensional indices can be referenced by ids.
 *
 * @param <I>
 ...
 */
public interface IdBooleanD3Tensor<I> extends BooleanD3Tensor,IdBooleanTensor<I>,IdD3Tensor<Boolean,I> {
    /**
     ...
     */
    boolean getCellById(I d0id, I d1id, I d2id);
     ...
     * @throws IllegalArgumentException if any id is not valid in its respective dimension.
     */
    void setCellById(boolean value, I d0id, I d1id, I d2id);

    /**
     * {@inheritDoc}
     *
     * The tensors this iterator loops over are guaranteed to be {@code IdbooleanD2Tensor<I>} tensors.
     * 
     */
