 ...
 */
public abstract class IdFloatD8TensorTest<I> extends IdFloatTensorTest<I> {
    IdFloatD8Tensor<I> pdTensor;

    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (IdFloatD8Tensor<I>) pTensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Float> t : tensor)
            assertTrue(t instanceof IdFloatD7Tensor);
    }   
