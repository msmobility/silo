...
/**
 * The {@code ShortD5Tensor} interface combines the {@code ShortTensor} and {@code D5Tensor} interfaces. The notes and caveats
 ...
 */
public interface ShortD5Tensor extends ShortTensor, D5Tensor<Short> {
    /**
     ...
     */
    short getCell(int d0index, int d1index, int d2index, int d3index, int d4index);
     ...
     *                                   equal to the size of its corresponding dimension.
     */
    void setCell(short value, int d0index, int d1index, int d2index, int d3index, int d4index);
    
    /**
     * {@inheritDoc}
     * 
     * The tensors this iterator loops over are guaranteed to be {@code ShortD4Tensor} tensors.
     * 
     */
