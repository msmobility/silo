...
import com.pb.sawdust.tensor.decorators.primitive.size.LongD4TensorShell;
import com.pb.sawdust.tensor.decorators.primitive.size.LongD4Tensor;
...
/**
 * The {@code IdLongD4TensorShell} class is a wrapper which sets a {@code LongD4TensorShell} as an {@code IdTensor<I>} (or,
 * more specifically, an {@code IdLongD4Tensor}).
 *
 * @author crf <br/>
 *         Started: Jan 16, 2009 9:47:43 AM
 *         Revised: Dec 14, 2009 12:35:27 PM
 */
public class IdLongD4TensorShell<I> extends LongD4TensorShell implements IdLongD4Tensor<I> {
    private final LongD4Tensor tensor;
    private final Index<I> index;

    IdLongD4TensorShell(LongD4Tensor tensor, Index<I> index) {
        super(tensor);
        this.tensor = tensor;
        this.index = index;
    }
    ...
    public IdLongD4TensorShell(LongD4Tensor tensor) {
    ...
    public IdLongD4TensorShell(LongD4Tensor tensor, I[] ... ids) {
     ...
     *                                  in {@code ids} contains repeated elements.
     */
    public IdLongD4TensorShell(LongD4Tensor tensor, List<List<I>> ids) {
        this(tensor,new BaseIndex<I>(tensor,ids));
    }
    ...
    public Iterator<Tensor<Long>> iterator() {
        return new Iterator<Tensor<Long>>() {
            private final Iterator<Tensor<Long>> iterator = IdLongD4TensorShell.super.iterator();
            ...
            public Tensor<Long> next() {
                return new IdLongD3TensorShell<I>((LongD3Tensor) iterator.next());
            }
