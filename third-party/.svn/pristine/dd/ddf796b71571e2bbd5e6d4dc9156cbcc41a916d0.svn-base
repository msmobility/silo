...
import com.pb.sawdust.tensor.decorators.primitive.size.ShortD9TensorShell;
...
/**
 * The {@code IdShortD9TensorShell} class is a wrapper which sets a {@code ShortD9TensorShell} as an {@code IdTensor<I>} (or,
 * more specifically, an {@code IdShortD9Tensor}).
 *
 * @author crf <br/>
 *         Started: Jan 16, 2009 9:47:43 AM
 *         Revised: Dec 14, 2009 12:35:33 PM
 */
public class IdShortD9TensorShell<I> extends ShortD9TensorShell implements IdShortD9Tensor<I> {
    private final ShortD9Tensor tensor;
    private final Index<I> index;

    IdShortD9TensorShell(ShortD9Tensor tensor, Index<I> index) {
        super(tensor);
        this.tensor = tensor;
        this.index = index;
    }
    ...
    public IdShortD9TensorShell(ShortD9Tensor tensor) {
    ...
    public IdShortD9TensorShell(ShortD9Tensor tensor, I[] ... ids) {
     ...
     *                                  in {@code ids} contains repeated elements.
     */
    public IdShortD9TensorShell(ShortD9Tensor tensor, List<List<I>> ids) {
        this(tensor,new BaseIndex<I>(tensor,ids));
    }
    ...
    public Iterator<Tensor<Short>> iterator() {
        return new Iterator<Tensor<Short>>() {
            private final Iterator<Tensor<Short>> iterator = IdShortD9TensorShell.super.iterator();
            ...
            public Tensor<Short> next() {
                return new IdShortD8TensorShell<I>((ShortD8Tensor) iterator.next());
            }
