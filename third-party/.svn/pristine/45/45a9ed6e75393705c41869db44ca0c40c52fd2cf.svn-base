 ...
 */
public abstract class IdIntD3TensorTest<I> extends IdIntTensorTest<I> {
    IdIntD3Tensor<I> pdTensor;

    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (IdIntD3Tensor<I>) pTensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Integer> t : tensor)
            assertTrue(t instanceof IdIntD2Tensor);
    }   
