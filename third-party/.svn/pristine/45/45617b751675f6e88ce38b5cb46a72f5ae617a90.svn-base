 ...
 */
public abstract class ShortD9TensorTest extends ShortTensorTest {
    ShortD9Tensor pdTensor;

    abstract protected ShortD9Tensor getTensor(TypeSafeArray<Short> data);
    
    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (ShortD9Tensor) tensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Short> t : tensor)
            assertTrue(t instanceof ShortD8Tensor);
    }
}
