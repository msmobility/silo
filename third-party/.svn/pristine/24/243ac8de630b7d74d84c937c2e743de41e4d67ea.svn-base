 ...
 */
public abstract class IdShortD3TensorTest<I> extends IdShortTensorTest<I> {
    IdShortD3Tensor<I> pdTensor;

    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (IdShortD3Tensor<I>) pTensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Short> t : tensor)
            assertTrue(t instanceof IdShortD2Tensor);
    }   
