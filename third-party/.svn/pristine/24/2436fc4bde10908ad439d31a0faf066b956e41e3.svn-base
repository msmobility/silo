...
/**
 * The {@code IntD5Tensor} interface combines the {@code IntTensor} and {@code D5Tensor} interfaces. The notes and caveats
 ...
 */
public interface IntD5Tensor extends IntTensor, D5Tensor<Integer> {
    /**
     ...
     */
    int getCell(int d0index, int d1index, int d2index, int d3index, int d4index);
     ...
     *                                   equal to the size of its corresponding dimension.
     */
    void setCell(int value, int d0index, int d1index, int d2index, int d3index, int d4index);
    
    /**
     * {@inheritDoc}
     * 
     * The tensors this iterator loops over are guaranteed to be {@code IntD4Tensor} tensors.
     * 
     */
