...
/**
 * The {@code ConcurrentBooleanD7TensorShell} class provides a wrapper for implementations of the {@code BooleanD7Tensor} interface
 ...
 */
public class ConcurrentBooleanD7TensorShell extends ConcurrentD7TensorShell<Boolean> implements BooleanD7Tensor {
     ...
     */
    public ConcurrentBooleanD7TensorShell(BooleanD7Tensor tensor, ConcurrentD7TensorLocks locks) {
        super(tensor,locks);
        this.tensor = tensor;
    }
