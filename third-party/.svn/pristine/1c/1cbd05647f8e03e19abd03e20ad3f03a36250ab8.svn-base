 ...
 */
public abstract class CharD4TensorTest extends CharTensorTest {
    CharD4Tensor pdTensor;

    abstract protected CharD4Tensor getTensor(TypeSafeArray<Character> data);
    
    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (CharD4Tensor) tensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Character> t : tensor)
            assertTrue(t instanceof CharD3Tensor);
    }
}
