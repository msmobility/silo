 ...
 */
public abstract class IdLongD3TensorTest<I> extends IdLongTensorTest<I> {
    IdLongD3Tensor<I> pdTensor;

    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (IdLongD3Tensor<I>) pTensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Long> t : tensor)
            assertTrue(t instanceof IdLongD2Tensor);
    }   
