...
/**
 * The {@code IdLongD5Tensor} class combines the {@code Long5Tensor} and {@code IdTensor} interfaces. It adds a
 * number of methods extending {@code LongD5Tensor} methods so that dimensional indices can be referenced by ids.
 *
 * @param <I>
 ...
 */
public interface IdLongD5Tensor<I> extends LongD5Tensor,IdLongTensor<I>,IdD5Tensor<Long,I> {
    /**
     ...
     */
    long getCellById(I d0id, I d1id, I d2id, I d3id, I d4id);
     ...
     * @throws IllegalArgumentException if any id is not valid in its respective dimension.
     */
    void setCellById(long value, I d0id, I d1id, I d2id, I d3id, I d4id);

    /**
     * {@inheritDoc}
     *
     * The tensors this iterator loops over are guaranteed to be {@code IdlongD4Tensor<I>} tensors.
     * 
     */
