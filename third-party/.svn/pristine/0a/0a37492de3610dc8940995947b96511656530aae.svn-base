 ...
 */
public abstract class BooleanD1TensorTest extends BooleanTensorTest {
    BooleanD1Tensor pdTensor;

    abstract protected BooleanD1Tensor getTensor(TypeSafeArray<Boolean> data);
    
    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (BooleanD1Tensor) tensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Boolean> t : tensor)
            assertTrue(t instanceof BooleanD0Tensor);
    }
}
