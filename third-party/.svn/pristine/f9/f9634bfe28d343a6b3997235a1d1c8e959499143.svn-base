...
/**
 * The {@code IdDoubleD6Tensor} class combines the {@code Double6Tensor} and {@code IdTensor} interfaces. It adds a
 * number of methods extending {@code DoubleD6Tensor} methods so that dimensional indices can be referenced by ids.
 *
 * @param <I>
 ...
 */
public interface IdDoubleD6Tensor<I> extends DoubleD6Tensor,IdDoubleTensor<I>,IdD6Tensor<Double,I> {
    /**
     ...
     */
    double getCellById(I d0id, I d1id, I d2id, I d3id, I d4id, I d5id);
     ...
     * @throws IllegalArgumentException if any id is not valid in its respective dimension.
     */
    void setCellById(double value, I d0id, I d1id, I d2id, I d3id, I d4id, I d5id);

    /**
     * {@inheritDoc}
     *
     * The tensors this iterator loops over are guaranteed to be {@code IddoubleD5Tensor<I>} tensors.
     * 
     */
