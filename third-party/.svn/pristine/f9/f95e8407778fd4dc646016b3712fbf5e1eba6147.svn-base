 ...
 */
public abstract class IdByteD9TensorTest<I> extends IdByteTensorTest<I> {
    IdByteD9Tensor<I> pdTensor;

    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (IdByteD9Tensor<I>) pTensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Byte> t : tensor)
            assertTrue(t instanceof IdByteD8Tensor);
    }   
