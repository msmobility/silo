 ...
 */
public abstract class IdCharD9TensorTest<I> extends IdCharTensorTest<I> {
    IdCharD9Tensor<I> pdTensor;

    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (IdCharD9Tensor<I>) pTensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Character> t : tensor)
            assertTrue(t instanceof IdCharD8Tensor);
    }   
