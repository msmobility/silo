 ...
 */
public abstract class ByteD9TensorTest extends ByteTensorTest {
    ByteD9Tensor pdTensor;

    abstract protected ByteD9Tensor getTensor(TypeSafeArray<Byte> data);
    
    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (ByteD9Tensor) tensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Byte> t : tensor)
            assertTrue(t instanceof ByteD8Tensor);
    }
}
