 ...
 */
public abstract class CharD6TensorTest extends CharTensorTest {
    CharD6Tensor pdTensor;

    abstract protected CharD6Tensor getTensor(TypeSafeArray<Character> data);
    
    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (CharD6Tensor) tensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Character> t : tensor)
            assertTrue(t instanceof CharD5Tensor);
    }
}
