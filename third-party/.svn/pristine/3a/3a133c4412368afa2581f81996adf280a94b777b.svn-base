...
/**
 * The {@code IdIntD6Tensor} class combines the {@code Int6Tensor} and {@code IdTensor} interfaces. It adds a
 * number of methods extending {@code IntD6Tensor} methods so that dimensional indices can be referenced by ids.
 *
 * @param <I>
 ...
 */
public interface IdIntD6Tensor<I> extends IntD6Tensor,IdIntTensor<I>,IdD6Tensor<Integer,I> {
    /**
     ...
     */
    int getCellById(I d0id, I d1id, I d2id, I d3id, I d4id, I d5id);
     ...
     * @throws IllegalArgumentException if any id is not valid in its respective dimension.
     */
    void setCellById(int value, I d0id, I d1id, I d2id, I d3id, I d4id, I d5id);

    /**
     * {@inheritDoc}
     *
     * The tensors this iterator loops over are guaranteed to be {@code IdintD5Tensor<I>} tensors.
     * 
     */
