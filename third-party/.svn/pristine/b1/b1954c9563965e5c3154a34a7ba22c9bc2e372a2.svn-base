...
/**
 * The {@code AcsDataDictionary2010} is a data dictionary for 2005-2009 (2009 five-year) American Community Survey 
 * (ACS) PUMS data.
 *
 * @author crf
 *         Started 10/14/11 12:17 PM
 */
public class AcsDataDictionary2005_2009 extends AcsDataDictionary<AcsDataDictionary2005_2009.HouseholdField,AcsDataDictionary2005_2009.PersonField> {

    private static final AcsDataDictionary2005_2009 instance = new AcsDataDictionary2005_2009();
                                
    /**
     * Get an instance of the 2005-2009 ACS data dictionary.
     * 
     * @return a 2005-2009 ACS data dictionary.
     */
    public static AcsDataDictionary2005_2009 getDictionary() {
        return instance;
    }

    /**
     * The {@code AcsDataReader2005_2009} class provides a convenience reader class for 2005-2009 (2009 five-year) American 
     * Community Survey (ACS) PUMS data. 
     */
    public static class AcsDataReader2005_2009 extends AcsDataReader<AcsDataDictionary2005_2009.HouseholdField,AcsDataDictionary2005_2009.PersonField,AcsDataDictionary2005_2009> {
        /**
         ...
         */
        public AcsDataReader2005_2009(Map<String,String> files) {
            super(files,instance);
        }
    }


    private AcsDataDictionary2005_2009() {
    ...
    /**
     * The {@code HouseholdField} enum holds the household fields for the 2005-2009 (2009 five-year) American Community 
    ...
    /**
     * The {@code PersonField} enum holds the person fields for the 2005-2009 (2009 five-year) American Community 
     * Survey (ACS) PUMS data.
     */
