 ...
 */
public abstract class FloatD3TensorTest extends FloatTensorTest {
    FloatD3Tensor pdTensor;

    abstract protected FloatD3Tensor getTensor(TypeSafeArray<Float> data);
    
    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (FloatD3Tensor) tensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Float> t : tensor)
            assertTrue(t instanceof FloatD2Tensor);
    }
}
