 ...
 */
public abstract class ByteD4TensorTest extends ByteTensorTest {
    ByteD4Tensor pdTensor;

    abstract protected ByteD4Tensor getTensor(TypeSafeArray<Byte> data);
    
    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (ByteD4Tensor) tensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Byte> t : tensor)
            assertTrue(t instanceof ByteD3Tensor);
    }
}
