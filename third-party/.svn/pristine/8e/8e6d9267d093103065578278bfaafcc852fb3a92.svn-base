...
/**
 * The {@code IdD4Tensor} class combines the {@code D4Tensor} and {@code IdTensor} interfaces. It adds a number of
 * methods extending {@code D4Tensor} methods so that dimensional indices can be referenced by ids.
 *
 * @param <T>
 ...
 */
public interface IdD4Tensor<T,I> extends D4Tensor<T>,IdTensor<T,I> {
     ...
     */
    T getValueById(I d0id, I d1id, I d2id, I d3id);
     ...
     * @throws IllegalArgumentException if any id is not valid in its respective dimension.
     */
    void setValueById(T value, I d0id, I d1id, I d2id, I d3id);

    /**
     * {@inheritDoc}
     *
     * The tensors this iterator loops over are guaranteed to be {@code IdD3Tensor<T,I>} tensors.
     * 
     */
