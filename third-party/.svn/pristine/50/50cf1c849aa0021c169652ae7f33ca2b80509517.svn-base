...
/**
 * The {@code IdDoubleD8Tensor} class combines the {@code Double8Tensor} and {@code IdTensor} interfaces. It adds a
 * number of methods extending {@code DoubleD8Tensor} methods so that dimensional indices can be referenced by ids.
 *
 * @param <I>
 ...
 */
public interface IdDoubleD8Tensor<I> extends DoubleD8Tensor,IdDoubleTensor<I>,IdD8Tensor<Double,I> {
    /**
     ...
     */
    double getCellById(I d0id, I d1id, I d2id, I d3id, I d4id, I d5id, I d6id, I d7id);
     ...
     * @throws IllegalArgumentException if any id is not valid in its respective dimension.
     */
    void setCellById(double value, I d0id, I d1id, I d2id, I d3id, I d4id, I d5id, I d6id, I d7id);

    /**
     * {@inheritDoc}
     *
     * The tensors this iterator loops over are guaranteed to be {@code IddoubleD7Tensor<I>} tensors.
     * 
     */
