...
/**
 * The {@code ConcurrentByteD9TensorShell} class provides a wrapper for implementations of the {@code ByteD9Tensor} interface
 ...
 */
public class ConcurrentByteD9TensorShell extends ConcurrentD9TensorShell<Byte> implements ByteD9Tensor {
     ...
     */
    public ConcurrentByteD9TensorShell(ByteD9Tensor tensor, ConcurrentD9TensorLocks locks) {
        super(tensor,locks);
        this.tensor = tensor;
    }
