...
/**
 * The {@code ConcurrentFloatD4TensorShell} class provides a wrapper for implementations of the {@code FloatD4Tensor} interface
 ...
 */
public class ConcurrentFloatD4TensorShell extends ConcurrentD4TensorShell<Float> implements FloatD4Tensor {
     ...
     */
    public ConcurrentFloatD4TensorShell(FloatD4Tensor tensor, ConcurrentD4TensorLocks locks) {
        super(tensor,locks);
        this.tensor = tensor;
    }
