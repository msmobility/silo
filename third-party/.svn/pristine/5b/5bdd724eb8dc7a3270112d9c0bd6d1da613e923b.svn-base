...
/**
 * The {@code IdD7Tensor} class combines the {@code D7Tensor} and {@code IdTensor} interfaces. It adds a number of
 * methods extending {@code D7Tensor} methods so that dimensional indices can be referenced by ids.
 *
 * @param <T>
 ...
 */
public interface IdD7Tensor<T,I> extends D7Tensor<T>,IdTensor<T,I> {
     ...
     */
    T getValueById(I d0id, I d1id, I d2id, I d3id, I d4id, I d5id, I d6id);
     ...
     * @throws IllegalArgumentException if any id is not valid in its respective dimension.
     */
    void setValueById(T value, I d0id, I d1id, I d2id, I d3id, I d4id, I d5id, I d6id);

    /**
     * {@inheritDoc}
     *
     * The tensors this iterator loops over are guaranteed to be {@code IdD6Tensor<T,I>} tensors.
     * 
     */
