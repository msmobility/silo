 ...
 */
public abstract class BooleanD8TensorTest extends BooleanTensorTest {
    BooleanD8Tensor pdTensor;

    abstract protected BooleanD8Tensor getTensor(TypeSafeArray<Boolean> data);
    
    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (BooleanD8Tensor) tensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Boolean> t : tensor)
            assertTrue(t instanceof BooleanD7Tensor);
    }
}
