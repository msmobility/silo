 ...
 */
public abstract class FloatD6TensorTest extends FloatTensorTest {
    FloatD6Tensor pdTensor;

    abstract protected FloatD6Tensor getTensor(TypeSafeArray<Float> data);
    
    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (FloatD6Tensor) tensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Float> t : tensor)
            assertTrue(t instanceof FloatD5Tensor);
    }
}
