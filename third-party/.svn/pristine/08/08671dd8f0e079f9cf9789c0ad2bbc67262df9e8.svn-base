 ...
 */
public abstract class ShortD2TensorTest extends ShortTensorTest {
    ShortD2Tensor pdTensor;

    abstract protected ShortD2Tensor getTensor(TypeSafeArray<Short> data);
    
    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (ShortD2Tensor) tensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Short> t : tensor)
            assertTrue(t instanceof ShortD1Tensor);
    }
}
