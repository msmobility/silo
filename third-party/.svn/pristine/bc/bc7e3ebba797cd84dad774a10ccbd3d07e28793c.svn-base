...
/**
 * The {@code IdDoubleD5Tensor} class combines the {@code Double5Tensor} and {@code IdTensor} interfaces. It adds a
 * number of methods extending {@code DoubleD5Tensor} methods so that dimensional indices can be referenced by ids.
 *
 * @param <I>
 ...
 */
public interface IdDoubleD5Tensor<I> extends DoubleD5Tensor,IdDoubleTensor<I>,IdD5Tensor<Double,I> {
    /**
     ...
     */
    double getCellById(I d0id, I d1id, I d2id, I d3id, I d4id);
     ...
     * @throws IllegalArgumentException if any id is not valid in its respective dimension.
     */
    void setCellById(double value, I d0id, I d1id, I d2id, I d3id, I d4id);

    /**
     * {@inheritDoc}
     *
     * The tensors this iterator loops over are guaranteed to be {@code IddoubleD4Tensor<I>} tensors.
     * 
     */
