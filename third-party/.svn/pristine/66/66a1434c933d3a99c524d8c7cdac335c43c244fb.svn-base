...
import com.pb.sawdust.tensor.decorators.primitive.size.DoubleD4TensorShell;
...
/**
 * The {@code IdDoubleD4TensorShell} class is a wrapper which sets a {@code DoubleD4TensorShell} as an {@code IdTensor<I>} (or,
 * more specifically, an {@code IdDoubleD4Tensor}).
 *
 * @author crf <br/>
 *         Started: Jan 16, 2009 9:47:43 AM
 *         Revised: Dec 14, 2009 12:35:27 PM
 */
public class IdDoubleD4TensorShell<I> extends DoubleD4TensorShell implements IdDoubleD4Tensor<I> {
    private final DoubleD4Tensor tensor;
    private final Index<I> index;

    IdDoubleD4TensorShell(DoubleD4Tensor tensor, Index<I> index) {
        super(tensor);
        this.tensor = tensor;
        this.index = index;
    }
    ...
    public IdDoubleD4TensorShell(DoubleD4Tensor tensor) {
    ...
    public IdDoubleD4TensorShell(DoubleD4Tensor tensor, I[] ... ids) {
     ...
     *                                  in {@code ids} contains repeated elements.
     */
    public IdDoubleD4TensorShell(DoubleD4Tensor tensor, List<List<I>> ids) {
        this(tensor,new BaseIndex<I>(tensor,ids));
    }
    ...
    public Iterator<Tensor<Double>> iterator() {
        return new Iterator<Tensor<Double>>() {
            private final Iterator<Tensor<Double>> iterator = IdDoubleD4TensorShell.super.iterator();
            ...
            public Tensor<Double> next() {
                return new IdDoubleD3TensorShell<I>((DoubleD3Tensor) iterator.next());
            }
