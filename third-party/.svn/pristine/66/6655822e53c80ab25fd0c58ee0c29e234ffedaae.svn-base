 ...
 */
public abstract class LongD8TensorTest extends LongTensorTest {
    LongD8Tensor pdTensor;

    abstract protected LongD8Tensor getTensor(TypeSafeArray<Long> data);
    
    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (LongD8Tensor) tensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Long> t : tensor)
            assertTrue(t instanceof LongD7Tensor);
    }
}
