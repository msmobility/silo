 ...
 */
public abstract class BooleanD9TensorTest extends BooleanTensorTest {
    BooleanD9Tensor pdTensor;

    abstract protected BooleanD9Tensor getTensor(TypeSafeArray<Boolean> data);
    
    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (BooleanD9Tensor) tensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Boolean> t : tensor)
            assertTrue(t instanceof BooleanD8Tensor);
    }
}
