...
/**
 * The {@code IdDoubleD4Tensor} class combines the {@code Double4Tensor} and {@code IdTensor} interfaces. It adds a
 * number of methods extending {@code DoubleD4Tensor} methods so that dimensional indices can be referenced by ids.
 *
 * @param <I>
 ...
 */
public interface IdDoubleD4Tensor<I> extends DoubleD4Tensor,IdDoubleTensor<I>,IdD4Tensor<Double,I> {
    /**
     ...
     */
    double getCellById(I d0id, I d1id, I d2id, I d3id);
     ...
     * @throws IllegalArgumentException if any id is not valid in its respective dimension.
     */
    void setCellById(double value, I d0id, I d1id, I d2id, I d3id);

    /**
     * {@inheritDoc}
     *
     * The tensors this iterator loops over are guaranteed to be {@code IddoubleD3Tensor<I>} tensors.
     * 
     */
