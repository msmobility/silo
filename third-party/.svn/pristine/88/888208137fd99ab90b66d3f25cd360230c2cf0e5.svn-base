...
import com.pb.sawdust.tensor.decorators.primitive.size.ByteD7TensorShell;
...
/**
 * The {@code IdByteD7TensorShell} class is a wrapper which sets a {@code ByteD7TensorShell} as an {@code IdTensor<I>} (or,
 * more specifically, an {@code IdByteD7Tensor}).
 *
 * @author crf <br/>
 *         Started: Jan 16, 2009 9:47:43 AM
 *         Revised: Dec 14, 2009 12:35:30 PM
 */
public class IdByteD7TensorShell<I> extends ByteD7TensorShell implements IdByteD7Tensor<I> {
    private final ByteD7Tensor tensor;
    private final Index<I> index;

    IdByteD7TensorShell(ByteD7Tensor tensor, Index<I> index) {
        super(tensor);
        this.tensor = tensor;
        this.index = index;
    }
    ...
    public IdByteD7TensorShell(ByteD7Tensor tensor) {
    ...
    public IdByteD7TensorShell(ByteD7Tensor tensor, I[] ... ids) {
     ...
     *                                  in {@code ids} contains repeated elements.
     */
    public IdByteD7TensorShell(ByteD7Tensor tensor, List<List<I>> ids) {
        this(tensor,new BaseIndex<I>(tensor,ids));
    }
    ...
    public Iterator<Tensor<Byte>> iterator() {
        return new Iterator<Tensor<Byte>>() {
            private final Iterator<Tensor<Byte>> iterator = IdByteD7TensorShell.super.iterator();
            ...
            public Tensor<Byte> next() {
                return new IdByteD6TensorShell<I>((ByteD6Tensor) iterator.next());
            }
