...
import com.pb.sawdust.tensor.decorators.primitive.size.ShortD6TensorShell;
...
/**
 * The {@code IdShortD6TensorShell} class is a wrapper which sets a {@code ShortD6TensorShell} as an {@code IdTensor<I>} (or,
 * more specifically, an {@code IdShortD6Tensor}).
 *
 * @author crf <br/>
 *         Started: Jan 16, 2009 9:47:43 AM
 *         Revised: Dec 14, 2009 12:35:29 PM
 */
public class IdShortD6TensorShell<I> extends ShortD6TensorShell implements IdShortD6Tensor<I> {
    private final ShortD6Tensor tensor;
    private final Index<I> index;

    IdShortD6TensorShell(ShortD6Tensor tensor, Index<I> index) {
        super(tensor);
        this.tensor = tensor;
        this.index = index;
    }
    ...
    public IdShortD6TensorShell(ShortD6Tensor tensor) {
    ...
    public IdShortD6TensorShell(ShortD6Tensor tensor, I[] ... ids) {
     ...
     *                                  in {@code ids} contains repeated elements.
     */
    public IdShortD6TensorShell(ShortD6Tensor tensor, List<List<I>> ids) {
        this(tensor,new BaseIndex<I>(tensor,ids));
    }
    ...
    public Iterator<Tensor<Short>> iterator() {
        return new Iterator<Tensor<Short>>() {
            private final Iterator<Tensor<Short>> iterator = IdShortD6TensorShell.super.iterator();
            ...
            public Tensor<Short> next() {
                return new IdShortD5TensorShell<I>((ShortD5Tensor) iterator.next());
            }
