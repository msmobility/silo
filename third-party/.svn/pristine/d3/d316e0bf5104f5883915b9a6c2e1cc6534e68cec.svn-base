 ...
 */
public abstract class IdByteD8TensorTest<I> extends IdByteTensorTest<I> {
    IdByteD8Tensor<I> pdTensor;

    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (IdByteD8Tensor<I>) pTensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Byte> t : tensor)
            assertTrue(t instanceof IdByteD7Tensor);
    }   
