...
/**
 * The {@code IdD2Tensor} class combines the {@code Matrix} and {@code IdTensor} interfaces. It adds a number of
 * methods extending {@code Matrix} methods so that dimensional indices can be referenced by ids.
 *
 * @param <T>
 ...
 */
public interface IdD2Tensor<T,I> extends Matrix<T>,IdTensor<T,I> {
     ...
     * @throws IllegalArgumentException if any id is not valid in its respective dimension.
     */
    void setValueById(T value, I d0id, I d1id);

    /**
     * {@inheritDoc}
     *
     * The tensors this iterator loops over are guaranteed to be {@code IdD1Tensor<T,I>} tensors.
     * 
     */
