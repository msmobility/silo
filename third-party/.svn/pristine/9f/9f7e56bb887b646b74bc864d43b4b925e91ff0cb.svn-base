...
import com.pb.sawdust.tensor.decorators.primitive.size.CharD8TensorShell;
...
/**
 * The {@code IdCharD8TensorShell} class is a wrapper which sets a {@code CharD8TensorShell} as an {@code IdTensor<I>} (or,
 * more specifically, an {@code IdCharD8Tensor}).
 *
 * @author crf <br/>
 *         Started: Jan 16, 2009 9:47:43 AM
 *         Revised: Dec 14, 2009 12:35:33 PM
 */
public class IdCharD8TensorShell<I> extends CharD8TensorShell implements IdCharD8Tensor<I> {
    private final CharD8Tensor tensor;
    private final Index<I> index;

    IdCharD8TensorShell(CharD8Tensor tensor, Index<I> index) {
        super(tensor);
        this.tensor = tensor;
        this.index = index;
    }
    ...
    public IdCharD8TensorShell(CharD8Tensor tensor) {
    ...
    public IdCharD8TensorShell(CharD8Tensor tensor, I[] ... ids) {
     ...
     *                                  in {@code ids} contains repeated elements.
     */
    public IdCharD8TensorShell(CharD8Tensor tensor, List<List<I>> ids) {
        this(tensor,new BaseIndex<I>(tensor,ids));
    }
    ...
    public Iterator<Tensor<Character>> iterator() {
        return new Iterator<Tensor<Character>>() {
            private final Iterator<Tensor<Character>> iterator = IdCharD8TensorShell.super.iterator();
            ...
            public Tensor<Character> next() {
                return new IdCharD7TensorShell<I>((CharD7Tensor) iterator.next());
            }
