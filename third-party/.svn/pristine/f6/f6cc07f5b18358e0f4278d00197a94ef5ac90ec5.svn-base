...
/**
 * The {@code IdIntD4Tensor} class combines the {@code Int4Tensor} and {@code IdTensor} interfaces. It adds a
 * number of methods extending {@code IntD4Tensor} methods so that dimensional indices can be referenced by ids.
 *
 * @param <I>
 ...
 */
public interface IdIntD4Tensor<I> extends IntD4Tensor,IdIntTensor<I>,IdD4Tensor<Integer,I> {
    /**
     ...
     */
    int getCellById(I d0id, I d1id, I d2id, I d3id);
     ...
     * @throws IllegalArgumentException if any id is not valid in its respective dimension.
     */
    void setCellById(int value, I d0id, I d1id, I d2id, I d3id);

    /**
     * {@inheritDoc}
     *
     * The tensors this iterator loops over are guaranteed to be {@code IdintD3Tensor<I>} tensors.
     * 
     */
