 ...
 */
public abstract class IdBooleanD4TensorTest<I> extends IdBooleanTensorTest<I> {
    IdBooleanD4Tensor<I> pdTensor;

    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (IdBooleanD4Tensor<I>) pTensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Boolean> t : tensor)
            assertTrue(t instanceof IdBooleanD3Tensor);
    }   
