...
/**
 * The {@code CharD2Tensor} interface combines the {@code CharTensor} and {@code Matrix} interfaces. The notes and caveats
 ...
 */
public interface CharD2Tensor extends CharTensor, Matrix<Character> {
    /**
     ...
     */
    char getCell(int d0index, int d1index);
     ...
     *                                   equal to the size of its corresponding dimension.
     */
    void setCell(char value, int d0index, int d1index);
    
    /**
     * {@inheritDoc}
     * 
     * The tensors this iterator loops over are guaranteed to be {@code CharD1Tensor} tensors.
     * 
     */
