 ...
 */
public abstract class ShortD5TensorTest extends ShortTensorTest {
    ShortD5Tensor pdTensor;

    abstract protected ShortD5Tensor getTensor(TypeSafeArray<Short> data);
    
    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (ShortD5Tensor) tensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Short> t : tensor)
            assertTrue(t instanceof ShortD4Tensor);
    }
}
