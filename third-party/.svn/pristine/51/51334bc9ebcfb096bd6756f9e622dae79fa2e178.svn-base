...
/**
 * The {@code IdShortD3Tensor} class combines the {@code Short3Tensor} and {@code IdTensor} interfaces. It adds a
 * number of methods extending {@code ShortD3Tensor} methods so that dimensional indices can be referenced by ids.
 *
 * @param <I>
 ...
 */
public interface IdShortD3Tensor<I> extends ShortD3Tensor,IdShortTensor<I>,IdD3Tensor<Short,I> {
    /**
     ...
     */
    short getCellById(I d0id, I d1id, I d2id);
     ...
     * @throws IllegalArgumentException if any id is not valid in its respective dimension.
     */
    void setCellById(short value, I d0id, I d1id, I d2id);

    /**
     * {@inheritDoc}
     *
     * The tensors this iterator loops over are guaranteed to be {@code IdshortD2Tensor<I>} tensors.
     * 
     */
