 ...
 */
public abstract class ShortD3TensorTest extends ShortTensorTest {
    ShortD3Tensor pdTensor;

    abstract protected ShortD3Tensor getTensor(TypeSafeArray<Short> data);
    
    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (ShortD3Tensor) tensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Short> t : tensor)
            assertTrue(t instanceof ShortD2Tensor);
    }
}
