 ...
 */
public abstract class IdIntTensorTest<I>  extends IdTensorTest<Integer,I> {
    protected IdIntTensor<I> pTensor;
    ...
    public void testIteratorType() {
        for (Tensor<Integer> t : tensor)
            assertTrue(t instanceof IdIntTensor);
    }
