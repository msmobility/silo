...
/**
 * The {@code IdIntD7Tensor} class combines the {@code Int7Tensor} and {@code IdTensor} interfaces. It adds a
 * number of methods extending {@code IntD7Tensor} methods so that dimensional indices can be referenced by ids.
 *
 * @param <I>
 ...
 */
public interface IdIntD7Tensor<I> extends IntD7Tensor,IdIntTensor<I>,IdD7Tensor<Integer,I> {
    /**
     ...
     */
    int getCellById(I d0id, I d1id, I d2id, I d3id, I d4id, I d5id, I d6id);
     ...
     * @throws IllegalArgumentException if any id is not valid in its respective dimension.
     */
    void setCellById(int value, I d0id, I d1id, I d2id, I d3id, I d4id, I d5id, I d6id);

    /**
     * {@inheritDoc}
     *
     * The tensors this iterator loops over are guaranteed to be {@code IdintD6Tensor<I>} tensors.
     * 
     */
