 ...
 */
public abstract class CharD1TensorTest extends CharTensorTest {
    CharD1Tensor pdTensor;

    abstract protected CharD1Tensor getTensor(TypeSafeArray<Character> data);
    
    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (CharD1Tensor) tensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Character> t : tensor)
            assertTrue(t instanceof CharD0Tensor);
    }
}
