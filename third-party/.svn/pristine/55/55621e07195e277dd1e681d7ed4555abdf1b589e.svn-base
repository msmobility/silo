...
/**
 * The {@code ByteD7Tensor} interface combines the {@code ByteTensor} and {@code D7Tensor} interfaces. The notes and caveats
 ...
 */
public interface ByteD7Tensor extends ByteTensor, D7Tensor<Byte> {
    /**
     ...
     */
    byte getCell(int d0index, int d1index, int d2index, int d3index, int d4index, int d5index, int d6index);
     ...
     *                                   equal to the size of its corresponding dimension.
     */
    void setCell(byte value, int d0index, int d1index, int d2index, int d3index, int d4index, int d5index, int d6index);
    
    /**
     * {@inheritDoc}
     * 
     * The tensors this iterator loops over are guaranteed to be {@code ByteD6Tensor} tensors.
     * 
     */
