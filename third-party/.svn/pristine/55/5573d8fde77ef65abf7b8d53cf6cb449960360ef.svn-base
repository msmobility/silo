 ...
 */
public abstract class IdLongD8TensorTest<I> extends IdLongTensorTest<I> {
    IdLongD8Tensor<I> pdTensor;

    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (IdLongD8Tensor<I>) pTensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Long> t : tensor)
            assertTrue(t instanceof IdLongD7Tensor);
    }   
