...
import com.pb.sawdust.tensor.decorators.primitive.size.LongD6TensorShell;
import com.pb.sawdust.tensor.decorators.primitive.size.LongD6Tensor;
import com.pb.sawdust.tensor.decorators.primitive.size.LongD5Tensor;
...
/**
 * The {@code IdLongD6TensorShell} class is a wrapper which sets a {@code LongD6TensorShell} as an {@code IdTensor<I>} (or,
 * more specifically, an {@code IdLongD6Tensor}).
 *
 * @author crf <br/>
 *         Started: Jan 16, 2009 9:47:43 AM
 *         Revised: Dec 14, 2009 12:35:30 PM
 */
public class IdLongD6TensorShell<I> extends LongD6TensorShell implements IdLongD6Tensor<I> {
    private final LongD6Tensor tensor;
    private final Index<I> index;

    IdLongD6TensorShell(LongD6Tensor tensor, Index<I> index) {
        super(tensor);
        this.tensor = tensor;
        this.index = index;
    }
    ...
    public IdLongD6TensorShell(LongD6Tensor tensor) {
    ...
    public IdLongD6TensorShell(LongD6Tensor tensor, I[] ... ids) {
     ...
     *                                  in {@code ids} contains repeated elements.
     */
    public IdLongD6TensorShell(LongD6Tensor tensor, List<List<I>> ids) {
        this(tensor,new BaseIndex<I>(tensor,ids));
    }
    ...
    public Iterator<Tensor<Long>> iterator() {
        return new Iterator<Tensor<Long>>() {
            private final Iterator<Tensor<Long>> iterator = IdLongD6TensorShell.super.iterator();
            ...
            public Tensor<Long> next() {
                return new IdLongD5TensorShell<I>((LongD5Tensor) iterator.next());
            }
