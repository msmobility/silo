...
/**
 * The {@code LongD5Tensor} interface combines the {@code LongTensor} and {@code D5Tensor} interfaces. The notes and caveats
 ...
 */
public interface LongD5Tensor extends LongTensor, D5Tensor<Long> {
    /**
     ...
     */
    long getCell(int d0index, int d1index, int d2index, int d3index, int d4index);
     ...
     *                                   equal to the size of its corresponding dimension.
     */
    void setCell(long value, int d0index, int d1index, int d2index, int d3index, int d4index);
    
    /**
     * {@inheritDoc}
     * 
     * The tensors this iterator loops over are guaranteed to be {@code LongD4Tensor} tensors.
     * 
     */
