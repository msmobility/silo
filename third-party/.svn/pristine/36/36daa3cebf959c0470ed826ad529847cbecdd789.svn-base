...
/**
 * The {@code ConcurrentShortD3TensorShell} class provides a wrapper for implementations of the {@code ShortD3Tensor} interface
 ...
 */
public class ConcurrentShortD3TensorShell extends ConcurrentD3TensorShell<Short> implements ShortD3Tensor {
     ...
     */
    public ConcurrentShortD3TensorShell(ShortD3Tensor tensor, ConcurrentD3TensorLocks locks) {
        super(tensor,locks);
        this.tensor = tensor;
    }
