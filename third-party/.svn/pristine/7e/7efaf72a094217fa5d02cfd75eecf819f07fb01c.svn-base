 ...
 */
public abstract class CharD2TensorTest extends CharTensorTest {
    CharD2Tensor pdTensor;

    abstract protected CharD2Tensor getTensor(TypeSafeArray<Character> data);
    
    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (CharD2Tensor) tensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Character> t : tensor)
            assertTrue(t instanceof CharD1Tensor);
    }
}
