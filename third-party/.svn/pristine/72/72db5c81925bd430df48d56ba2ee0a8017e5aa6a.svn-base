...
/**
 * The {@code D3Tensor} interface specifies a tensor with {@code 3} dimensions.
 *
 * @param <T>
 ...
 */
public interface D3Tensor<T> extends Tensor<T> {

    /**
     * Gets the number of dimensions in this tensor.
     *
     * @return {@code 3}, the number of dimensions in this tensor.
     */
    int size();
     ...
     */
    T getValue(int d0index, int d1index, int d2index);
     ...
     *                                   equal to the size of its corresponding dimension.
     */
    void setValue(T value, int d0index, int d1index, int d2index);
    
    /**
     * {@inheritDoc}
     * 
     * The tensors this iterator loops over are guaranteed to be {@code D2Tensor<T>} tensors.
     * 
     */
