...
/**
 * The {@code ByteD5Tensor} interface combines the {@code ByteTensor} and {@code D5Tensor} interfaces. The notes and caveats
 ...
 */
public interface ByteD5Tensor extends ByteTensor, D5Tensor<Byte> {
    /**
     ...
     */
    byte getCell(int d0index, int d1index, int d2index, int d3index, int d4index);
     ...
     *                                   equal to the size of its corresponding dimension.
     */
    void setCell(byte value, int d0index, int d1index, int d2index, int d3index, int d4index);
    
    /**
     * {@inheritDoc}
     * 
     * The tensors this iterator loops over are guaranteed to be {@code ByteD4Tensor} tensors.
     * 
     */
