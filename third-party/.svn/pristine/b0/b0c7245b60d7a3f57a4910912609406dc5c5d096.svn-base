 ...
 */
public abstract class ByteD6TensorTest extends ByteTensorTest {
    ByteD6Tensor pdTensor;

    abstract protected ByteD6Tensor getTensor(TypeSafeArray<Byte> data);
    
    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (ByteD6Tensor) tensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Byte> t : tensor)
            assertTrue(t instanceof ByteD5Tensor);
    }
}
