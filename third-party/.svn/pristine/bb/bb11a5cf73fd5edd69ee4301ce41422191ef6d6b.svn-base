...
/**
 * The {@code IdLongD6Tensor} class combines the {@code Long6Tensor} and {@code IdTensor} interfaces. It adds a
 * number of methods extending {@code LongD6Tensor} methods so that dimensional indices can be referenced by ids.
 *
 * @param <I>
 ...
 */
public interface IdLongD6Tensor<I> extends LongD6Tensor,IdLongTensor<I>,IdD6Tensor<Long,I> {
    /**
     ...
     */
    long getCellById(I d0id, I d1id, I d2id, I d3id, I d4id, I d5id);
     ...
     * @throws IllegalArgumentException if any id is not valid in its respective dimension.
     */
    void setCellById(long value, I d0id, I d1id, I d2id, I d3id, I d4id, I d5id);

    /**
     * {@inheritDoc}
     *
     * The tensors this iterator loops over are guaranteed to be {@code IdlongD5Tensor<I>} tensors.
     * 
     */
