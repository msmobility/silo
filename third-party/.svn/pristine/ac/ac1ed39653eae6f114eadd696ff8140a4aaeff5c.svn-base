 ...
 */
public abstract class IdByteTensorTest<I>  extends IdTensorTest<Byte,I> {
    protected IdByteTensor<I> pTensor;
    ...
    public void testIteratorType() {
        for (Tensor<Byte> t : tensor)
            assertTrue(t instanceof IdByteTensor);
    }
