 ...
 */
public abstract class IntD5TensorTest extends IntTensorTest {
    IntD5Tensor pdTensor;

    abstract protected IntD5Tensor getTensor(TypeSafeArray<Integer> data);
    
    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (IntD5Tensor) tensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Integer> t : tensor)
            assertTrue(t instanceof IntD4Tensor);
    }
}
