...
import com.pb.sawdust.tensor.decorators.primitive.size.ByteD5TensorShell;
...
/**
 * The {@code IdByteD5TensorShell} class is a wrapper which sets a {@code ByteD5TensorShell} as an {@code IdTensor<I>} (or,
 * more specifically, an {@code IdByteD5Tensor}).
 *
 * @author crf <br/>
 *         Started: Jan 16, 2009 9:47:43 AM
 *         Revised: Dec 14, 2009 12:35:28 PM
 */
public class IdByteD5TensorShell<I> extends ByteD5TensorShell implements IdByteD5Tensor<I> {
    private final ByteD5Tensor tensor;
    private final Index<I> index;

    IdByteD5TensorShell(ByteD5Tensor tensor, Index<I> index) {
        super(tensor);
        this.tensor = tensor;
        this.index = index;
    }
    ...
    public IdByteD5TensorShell(ByteD5Tensor tensor) {
    ...
    public IdByteD5TensorShell(ByteD5Tensor tensor, I[] ... ids) {
     ...
     *                                  in {@code ids} contains repeated elements.
     */
    public IdByteD5TensorShell(ByteD5Tensor tensor, List<List<I>> ids) {
        this(tensor,new BaseIndex<I>(tensor,ids));
    }
    ...
    public Iterator<Tensor<Byte>> iterator() {
        return new Iterator<Tensor<Byte>>() {
            private final Iterator<Tensor<Byte>> iterator = IdByteD5TensorShell.super.iterator();
            ...
            public Tensor<Byte> next() {
                return new IdByteD4TensorShell<I>((ByteD4Tensor) iterator.next());
            }
