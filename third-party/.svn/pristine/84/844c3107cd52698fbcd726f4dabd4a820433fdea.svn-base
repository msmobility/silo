...
/**                  
 * The {@code IdDoubleTensor} class combines the {@code DoubleTensor} and {@code IdTensor} interfaces. It adds a number
 * of methods extending {@code DoubleTensor} methods so that dimensional indices can be referenced by ids.
 *
 * @param <I>
 ...
 */
public interface IdDoubleTensor<I> extends DoubleTensor,IdTensor<Double,I> {
    ...
    double getCellById(I ... ids);

    /**
     * Set the cell at the specified location referenced by ids. This method should be more efficient than {@code setValue(Double,I[])}.
     *
     * @param value
     ...
     */
    @SuppressWarnings({"unchecked", "varargs"})
    void setCellById(double value, I ... ids);

    /**
     * {@inheritDoc}
     *
     * The tensors this iterator loops over are guaranteed to be {@code IdDoubleTensor<I>} tensors.
     */
