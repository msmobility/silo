...
/**
 * The {@code ByteD1Tensor} interface combines the {@code ByteTensor} and {@code Vector} interfaces. The notes and caveats
 ...
 */
public interface ByteD1Tensor extends ByteTensor, Vector<Byte> {
    /**
     ...
     *                                   equal to the size of its corresponding dimension.
     */
    void setCell(byte value, int index);
    
    /**
     * {@inheritDoc}
     * 
     * The tensors this iterator loops over are guaranteed to be {@code ByteD0Tensor} tensors.
     * 
     */
