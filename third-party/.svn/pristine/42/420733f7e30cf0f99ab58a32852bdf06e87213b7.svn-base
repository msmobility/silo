...
/**
 * The {@code BooleanD2Tensor} interface combines the {@code BooleanTensor} and {@code Matrix} interfaces. The notes and caveats
 ...
 */
public interface BooleanD2Tensor extends BooleanTensor, Matrix<Boolean> {
    /**
     ...
     */
    boolean getCell(int d0index, int d1index);
     ...
     *                                   equal to the size of its corresponding dimension.
     */
    void setCell(boolean value, int d0index, int d1index);
    
    /**
     * {@inheritDoc}
     * 
     * The tensors this iterator loops over are guaranteed to be {@code BooleanD1Tensor} tensors.
     * 
     */
