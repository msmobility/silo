...
/**
 * The {@code DoubleD7Tensor} interface combines the {@code DoubleTensor} and {@code D7Tensor} interfaces. The notes and caveats
 ...
 */
public interface DoubleD7Tensor extends DoubleTensor, D7Tensor<Double> {
    /**
     ...
     */
    double getCell(int d0index, int d1index, int d2index, int d3index, int d4index, int d5index, int d6index);
     ...
     *                                   equal to the size of its corresponding dimension.
     */
    void setCell(double value, int d0index, int d1index, int d2index, int d3index, int d4index, int d5index, int d6index);
    
    /**
     * {@inheritDoc}
     * 
     * The tensors this iterator loops over are guaranteed to be {@code DoubleD6Tensor} tensors.
     * 
     */
