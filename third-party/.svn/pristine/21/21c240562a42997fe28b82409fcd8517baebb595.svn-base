 ...
 */
public abstract class BooleanD3TensorTest extends BooleanTensorTest {
    BooleanD3Tensor pdTensor;

    abstract protected BooleanD3Tensor getTensor(TypeSafeArray<Boolean> data);
    
    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (BooleanD3Tensor) tensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Boolean> t : tensor)
            assertTrue(t instanceof BooleanD2Tensor);
    }
}
