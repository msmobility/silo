 ...
 */
public abstract class ShortD4TensorTest extends ShortTensorTest {
    ShortD4Tensor pdTensor;

    abstract protected ShortD4Tensor getTensor(TypeSafeArray<Short> data);
    
    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (ShortD4Tensor) tensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Short> t : tensor)
            assertTrue(t instanceof ShortD3Tensor);
    }
}
