...
/**
 * The {@code IdCharVector} class combines the {@code Char1Tensor} and {@code IdTensor} interfaces. It adds a
 * number of methods extending {@code CharVector} methods so that dimensional indices can be referenced by ids.
 *
 * @param <I>
 ...
 */
public interface IdCharD1Tensor<I> extends CharVector,IdCharTensor<I>,IdVector<Character,I> {
    /**
     ...
     * @throws IllegalArgumentException if any id is not valid in its respective dimension.
     */
    void setCellById(char value, I id);

    /**
     * {@inheritDoc}
     *
     * The tensors this iterator loops over are guaranteed to be {@code IdcharD0Tensor<I>} tensors.
     * 
     */
