 ...
 */
public abstract class IntD3TensorTest extends IntTensorTest {
    IntD3Tensor pdTensor;

    abstract protected IntD3Tensor getTensor(TypeSafeArray<Integer> data);
    
    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (IntD3Tensor) tensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Integer> t : tensor)
            assertTrue(t instanceof IntD2Tensor);
    }
}
