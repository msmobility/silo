...
/**
 * The {@code IdCharD8Tensor} class combines the {@code Char8Tensor} and {@code IdTensor} interfaces. It adds a
 * number of methods extending {@code CharD8Tensor} methods so that dimensional indices can be referenced by ids.
 *
 * @param <I>
 ...
 */
public interface IdCharD8Tensor<I> extends CharD8Tensor,IdCharTensor<I>,IdD8Tensor<Character,I> {
    /**
     ...
     */
    char getCellById(I d0id, I d1id, I d2id, I d3id, I d4id, I d5id, I d6id, I d7id);
     ...
     * @throws IllegalArgumentException if any id is not valid in its respective dimension.
     */
    void setCellById(char value, I d0id, I d1id, I d2id, I d3id, I d4id, I d5id, I d6id, I d7id);

    /**
     * {@inheritDoc}
     *
     * The tensors this iterator loops over are guaranteed to be {@code IdcharD7Tensor<I>} tensors.
     * 
     */
