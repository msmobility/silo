...
/**
 * The {@code IdShortD8Tensor} class combines the {@code Short8Tensor} and {@code IdTensor} interfaces. It adds a
 * number of methods extending {@code ShortD8Tensor} methods so that dimensional indices can be referenced by ids.
 *
 * @param <I>
 ...
 */
public interface IdShortD8Tensor<I> extends ShortD8Tensor,IdShortTensor<I>,IdD8Tensor<Short,I> {
    /**
     ...
     */
    short getCellById(I d0id, I d1id, I d2id, I d3id, I d4id, I d5id, I d6id, I d7id);
     ...
     * @throws IllegalArgumentException if any id is not valid in its respective dimension.
     */
    void setCellById(short value, I d0id, I d1id, I d2id, I d3id, I d4id, I d5id, I d6id, I d7id);

    /**
     * {@inheritDoc}
     *
     * The tensors this iterator loops over are guaranteed to be {@code IdshortD7Tensor<I>} tensors.
     * 
     */
