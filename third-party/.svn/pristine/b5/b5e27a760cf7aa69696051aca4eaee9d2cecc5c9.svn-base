...
/**
 * The {@code ByteD3Tensor} interface combines the {@code ByteTensor} and {@code D3Tensor} interfaces. The notes and caveats
 ...
 */
public interface ByteD3Tensor extends ByteTensor, D3Tensor<Byte> {
    /**
     ...
     */
    byte getCell(int d0index, int d1index, int d2index);
     ...
     *                                   equal to the size of its corresponding dimension.
     */
    void setCell(byte value, int d0index, int d1index, int d2index);
    
    /**
     * {@inheritDoc}
     * 
     * The tensors this iterator loops over are guaranteed to be {@code ByteD2Tensor} tensors.
     * 
     */
