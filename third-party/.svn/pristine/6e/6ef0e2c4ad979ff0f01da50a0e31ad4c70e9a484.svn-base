 ...
 */
public abstract class DoubleD8TensorTest extends DoubleTensorTest {
    DoubleD8Tensor pdTensor;

    abstract protected DoubleD8Tensor getTensor(TypeSafeArray<Double> data);
    
    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (DoubleD8Tensor) tensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Double> t : tensor)
            assertTrue(t instanceof DoubleD7Tensor);
    }
}
