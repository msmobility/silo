 ...
 */
public abstract class CharD5TensorTest extends CharTensorTest {
    CharD5Tensor pdTensor;

    abstract protected CharD5Tensor getTensor(TypeSafeArray<Character> data);
    
    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (CharD5Tensor) tensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Character> t : tensor)
            assertTrue(t instanceof CharD4Tensor);
    }
}
