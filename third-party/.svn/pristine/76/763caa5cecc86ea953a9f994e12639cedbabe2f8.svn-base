 ...
 */
public abstract class ByteD5TensorTest extends ByteTensorTest {
    ByteD5Tensor pdTensor;

    abstract protected ByteD5Tensor getTensor(TypeSafeArray<Byte> data);
    
    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (ByteD5Tensor) tensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Byte> t : tensor)
            assertTrue(t instanceof ByteD4Tensor);
    }
}
