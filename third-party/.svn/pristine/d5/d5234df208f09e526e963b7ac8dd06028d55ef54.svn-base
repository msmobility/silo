...
/**
 * The {@code IdFloatD7Tensor} class combines the {@code Float7Tensor} and {@code IdTensor} interfaces. It adds a
 * number of methods extending {@code FloatD7Tensor} methods so that dimensional indices can be referenced by ids.
 *
 * @param <I>
 ...
 */
public interface IdFloatD7Tensor<I> extends FloatD7Tensor,IdFloatTensor<I>,IdD7Tensor<Float,I> {
    /**
     ...
     */
    float getCellById(I d0id, I d1id, I d2id, I d3id, I d4id, I d5id, I d6id);
     ...
     * @throws IllegalArgumentException if any id is not valid in its respective dimension.
     */
    void setCellById(float value, I d0id, I d1id, I d2id, I d3id, I d4id, I d5id, I d6id);

    /**
     * {@inheritDoc}
     *
     * The tensors this iterator loops over are guaranteed to be {@code IdfloatD6Tensor<I>} tensors.
     * 
     */
