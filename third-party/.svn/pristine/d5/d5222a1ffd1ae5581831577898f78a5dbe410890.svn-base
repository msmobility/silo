...
/**
 * The {@code IdByteD4Tensor} class combines the {@code Byte4Tensor} and {@code IdTensor} interfaces. It adds a
 * number of methods extending {@code ByteD4Tensor} methods so that dimensional indices can be referenced by ids.
 *
 * @param <I>
 ...
 */
public interface IdByteD4Tensor<I> extends ByteD4Tensor,IdByteTensor<I>,IdD4Tensor<Byte,I> {
    /**
     ...
     */
    byte getCellById(I d0id, I d1id, I d2id, I d3id);
     ...
     * @throws IllegalArgumentException if any id is not valid in its respective dimension.
     */
    void setCellById(byte value, I d0id, I d1id, I d2id, I d3id);

    /**
     * {@inheritDoc}
     *
     * The tensors this iterator loops over are guaranteed to be {@code IdbyteD3Tensor<I>} tensors.
     * 
     */
