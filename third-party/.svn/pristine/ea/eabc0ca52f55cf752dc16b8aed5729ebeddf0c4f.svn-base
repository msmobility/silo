 ...
 */
public abstract class IdByteD3TensorTest<I> extends IdByteTensorTest<I> {
    IdByteD3Tensor<I> pdTensor;

    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (IdByteD3Tensor<I>) pTensor;
    }
    ...
    public void testIteratorType() {
        for (Tensor<Byte> t : tensor)
            assertTrue(t instanceof IdByteD2Tensor);
    }   
