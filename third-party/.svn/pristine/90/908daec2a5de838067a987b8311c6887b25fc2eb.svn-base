 ...
 */
public abstract class IdIntD0TensorTest<I> extends IdIntTensorTest<I> {
    IdIntD0Tensor<I> pdTensor;

    @Before
    public void beforeTest() {
        super.beforeTest();
        pdTensor = (IdIntD0Tensor<I>) pTensor;
    ...
    public void testIteratorType() {
        for (Tensor<Integer> t : tensor)
            assertTrue(t instanceof IdIntD0Tensor);
    }   
