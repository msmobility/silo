...
/**
 * The {@code IdFloatD4Tensor} class combines the {@code Float4Tensor} and {@code IdTensor} interfaces. It adds a
 * number of methods extending {@code FloatD4Tensor} methods so that dimensional indices can be referenced by ids.
 *
 * @param <I>
 ...
 */
public interface IdFloatD4Tensor<I> extends FloatD4Tensor,IdFloatTensor<I>,IdD4Tensor<Float,I> {
    /**
     ...
     */
    float getCellById(I d0id, I d1id, I d2id, I d3id);
     ...
     * @throws IllegalArgumentException if any id is not valid in its respective dimension.
     */
    void setCellById(float value, I d0id, I d1id, I d2id, I d3id);

    /**
     * {@inheritDoc}
     *
     * The tensors this iterator loops over are guaranteed to be {@code IdfloatD3Tensor<I>} tensors.
     * 
     */
