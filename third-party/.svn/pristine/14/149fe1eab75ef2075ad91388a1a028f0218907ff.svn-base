...
import com.pb.sawdust.tensor.decorators.id.size.IdD4Tensor;
import com.pb.sawdust.tensor.Tensor;

import java.util.Iterator;

/**
 * The {@code IdLongD4Tensor} class combines the {@code Long4Tensor} and {@code IdTensor} interfaces. It adds a
 * number of methods extending {@code LongD4Tensor} methods so that dimensional indices can be referenced by ids.
 *
 * @param <I>
 ...
 */
public interface IdLongD4Tensor<I> extends LongD4Tensor,IdLongTensor<I>,IdD4Tensor<Long,I> {
    /**
     ...
     */
    long getCellById(I d0id, I d1id, I d2id, I d3id);
     ...
     * @throws IllegalArgumentException if any id is not valid in its respective dimension.
     */
    void setCellById(long value, I d0id, I d1id, I d2id, I d3id);

    /**
     * {@inheritDoc}
     *
     * The tensors this iterator loops over are guaranteed to be {@code IdlongD3Tensor<I>} tensors.
     * 
     */
