...
/**
 * The {@code IdByteD5Tensor} class combines the {@code Byte5Tensor} and {@code IdTensor} interfaces. It adds a
 * number of methods extending {@code ByteD5Tensor} methods so that dimensional indices can be referenced by ids.
 *
 * @param <I>
 ...
 */
public interface IdByteD5Tensor<I> extends ByteD5Tensor,IdByteTensor<I>,IdD5Tensor<Byte,I> {
    /**
     ...
     */
    byte getCellById(I d0id, I d1id, I d2id, I d3id, I d4id);
     ...
     * @throws IllegalArgumentException if any id is not valid in its respective dimension.
     */
    void setCellById(byte value, I d0id, I d1id, I d2id, I d3id, I d4id);

    /**
     * {@inheritDoc}
     *
     * The tensors this iterator loops over are guaranteed to be {@code IdbyteD4Tensor<I>} tensors.
     * 
     */
