 ...
 */
public class MunichUpdateCarOwnerShipModel extends AbstractModel implements AnnualModel {
    ...
    public MunichUpdateCarOwnerShipModel(SiloDataContainerImpl dataContainer, Properties properties) {
    ...
    private void updateCarOwnership() {
        ...
        HouseholdDataManager householdData = dataContainer.getHouseholdData();
        for (Household oldHousehold : householdData.getUpdatedHouseholds()) {
            Household newHousehold = householdData.getHouseholdFromId(oldHousehold.getId());
        ...
        final double numberOfHh = householdData.getHouseholds().size();
