...
public class DemographicsProperties {
    ...
    public DemographicsProperties(ResourceBundle bundle) {
        ...
        marriedScaler = (float) PropertiesUtil.getDoubleProperty(bundle, "demographics.birth.scaler.married", 1.59);
        singleScaler = (float) PropertiesUtil.getDoubleProperty(bundle, "demographics.birth.scaler.single", 0.34);
        localScaler = (float) PropertiesUtil.getDoubleProperty(bundle, "demographics.local.birth.rate.adjuster", 1.0);
