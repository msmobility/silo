...
public class RealEstateDataManager {
    ...
    public void readDwellings (de.tum.bgu.msm.properties.Properties properties) {
    ...
    private void readDwellingData(de.tum.bgu.msm.properties.Properties properties) {
