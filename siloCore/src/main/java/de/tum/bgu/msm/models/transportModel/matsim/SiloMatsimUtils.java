...
public class SiloMatsimUtils {
	...
	public static Config createMatsimConfig(Config initialConfig, Integer year,	double populationScalingFactor) {
		...
		String outputDirectory = Properties.get().main.baseDirectory + "scenOutput/"
				+ Properties.get().main.scenarioName + "/matsim/" + year + "/";
		config.controler().setRunId(year.toString());
