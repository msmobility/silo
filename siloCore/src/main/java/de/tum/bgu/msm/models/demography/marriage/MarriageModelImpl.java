...
public class MarriageModelImpl extends AbstractModel implements MarriageModel {
    ...
    public MarriageModelImpl(DataContainer dataContainer, AbstractMovesModelImpl movesModel,
...
//        }
    ...
    private boolean marryCouple(int id1, int id2) {
        ...
        householdDataManager.addHouseholdAboutToChange(hhOfPartner1);
        householdDataManager.addHouseholdAboutToChange(hhOfPartner2);
