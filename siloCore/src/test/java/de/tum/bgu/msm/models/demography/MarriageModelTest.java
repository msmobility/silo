...
public class MarriageModelTest {
    ...
    public static void setupModel() {
        ...
        Person person2 = dataContainer.getHouseholdData().createPerson(2, 30, Gender.FEMALE, Race.other, -1, -1, 0);
        ...
        Person person3 = dataContainer.getHouseholdData().createPerson(3, 30, Gender.MALE, Race.other, -1, -1, 0);
        ...
        Person person4 = dataContainer.getHouseholdData().createPerson(4, 30, Gender.FEMALE, Race.other, -1, -1, 0);
        ...
        Person person5 = dataContainer.getHouseholdData().createPerson(5, 30, Gender.MALE, Race.other, -1, -1, 0);
        ...
        Person person6 = dataContainer.getHouseholdData().createPerson(6, 30, Gender.FEMALE, Race.other, -1, -1, 0);
        person6.setRole(PersonRole.SINGLE);
        dataContainer.getHouseholdData().addPersonToHousehold(person6, household6);
        Person person6Child = dataContainer.getHouseholdData().createPerson(61, 10, Gender.FEMALE, Race.other, -1, -1, 0);
        ...
        Person person7 = dataContainer.getHouseholdData().createPerson(7, 30, Gender.MALE, Race.other, -1, -1, 0);
        dataContainer.getHouseholdData().addPersonToHousehold(person7, household7);
        person7.setRole(PersonRole.SINGLE);

        Person person7Child1 = dataContainer.getHouseholdData().createPerson(71, 10, Gender.FEMALE, Race.other, -1, -1, 0);
        dataContainer.getHouseholdData().addPersonToHousehold(person7Child1, household7);
        person7Child1.setRole(PersonRole.CHILD);
        Person person7Child2 = dataContainer.getHouseholdData().createPerson(72, 10, Gender.FEMALE, Race.other, -1, -1, 0);
        dataContainer.getHouseholdData().addPersonToHousehold(person7Child2, household7);
        person7Child2.setRole(PersonRole.CHILD);
        Person person7Child3 = dataContainer.getHouseholdData().createPerson(73, 10, Gender.FEMALE, Race.other, -1, -1, 0);
        ...
        Person person8 = dataContainer.getHouseholdData().createPerson(8, 30, Gender.FEMALE, Race.other, -1, -1, 0);
        dataContainer.getHouseholdData().addPersonToHousehold(person8, household8);
        person8.setRole(PersonRole.SINGLE);

        Person person8Child1 = dataContainer.getHouseholdData().createPerson(81, 10, Gender.FEMALE, Race.other, -1, -1, 0);
        dataContainer.getHouseholdData().addPersonToHousehold(person8Child1, household8);
        person8Child1.setRole(PersonRole.CHILD);
        Person person8Child2 = dataContainer.getHouseholdData().createPerson(82, 10, Gender.FEMALE, Race.other, -1, -1, 0);
        dataContainer.getHouseholdData().addPersonToHousehold(person8Child2, household8);
        person8Child2.setRole(PersonRole.CHILD);
        Person person8Child3 = dataContainer.getHouseholdData().createPerson(83, 10, Gender.FEMALE, Race.other, -1, -1, 0);
        ...
        for(int i = 0; i < 10000; i++) {
            ...
            final Person p = singleHouseholds.createPerson(i, ages.nextInt(), Gender.valueOf(genders.nextInt()), races.next(), occupations.nextInt(), 0, 0);
