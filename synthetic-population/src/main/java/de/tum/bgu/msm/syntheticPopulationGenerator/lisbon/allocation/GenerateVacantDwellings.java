...
public class GenerateVacantDwellings {
    ...
    private void generateVacantDwellings(){
        for (int taz : dataSetSynPop.getTazs()){
            ...
            int lsoaID = ((DataSetSynPopLIS)dataSetSynPop).getTazMunicipality().get(taz);
            float percentageVacantDwellings = ((DataSetSynPopLIS)dataSetSynPop).getLsoaAttributes().get(lsoaID).get("percentageVacantDwellings");
