 ...
 */
public class SyntheticPopPortland implements SyntheticPopI {
    ...
    protected transient Logger logger = Logger.getLogger(SyntheticPopPortland.class);
    ...
    public void runSP() {
        ...
        GeoDataReader geoDataReader = new GeoDataReaderPortland(geoData);
