...
public class ExtractMicroDataSH {
    ...
    static Logger logger = Logger.getLogger(ExtractMicroDataSH.class);
    ...
    public ExtractMicroDataSH(ResourceBundle rb, DataSetSynPop dataSetSynPop) {
        // Constructor
        this.rb = rb;
...
/*        String[] labels = frequencyMatrix.getColumnLabels();
        ...
        for (int i = 1; i <= frequencyMatrix.getRowCount(); i++){
            ...
            frequencyMatrix.setValueAt(i,"ppTotal",hhSize);
        }
    ...
    private void initializeAttributesMunicipality() {
        ...
        attributesDictionary.put("H_","HousOwn");
        attributesDictionary.put("ddT_","HousTyp");
        ...
        checkContainsAndAdd("job_",occupationBrackets, attributesDictionary);
        checkContainsAndAdd("nHH_",householdSizes, attributesDictionary);
        addIntegerColumnToTableDataSet(frequencyMatrix,"ppTotal");
