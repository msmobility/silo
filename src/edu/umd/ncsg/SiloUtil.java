...
public class SiloUtil {
    ...
    public static ResourceBundle siloInitialization(String resourceBundleName) {
        ...
        // copy employment files if not existent
        String destinationDirectory = baseDirectory + "scenOutput/" + scenarioName + "/employmentForecast/";
        File file = new File (destinationDirectory);
        if (!file.exists()) {
            String sourceDirectory = baseDirectory + "scenOutput/base/employmentForecast/";
            copyDirectoryAndFiles(sourceDirectory, destinationDirectory);
        }
