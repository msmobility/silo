package de.tum.bgu.msm.syntheticPopulationGenerator.munichCity;
...
public class SyntheticPopMuc implements SyntheticPopI {
    ...
    public SyntheticPopMuc(ResourceBundle rb){
        this.rb = rb;
    }
    ...
    private void readAttributes() {
        ...
        String fileName = "input/syntheticPopulation/variablesDictionary.csv";
