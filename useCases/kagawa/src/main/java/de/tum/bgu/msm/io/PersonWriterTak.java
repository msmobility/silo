...
public class PersonWriterTak implements PersonWriter {

    private final static Logger logger = LogManager.getLogger(PersonWriterTak.class);

    private final HouseholdDataManager householdData;

    public PersonWriterTak(HouseholdDataManager householdData) {
