...
public class MovesModelMstm extends AbstractMovesModelImpl {
    ...
    public MovesModelMstm(DataContainer dataContainer, Properties properties, MovesStrategy movesStrategy,
...
//    }
    ...
    public int searchForNewDwelling(Household household) {
        ...
        for (Person pp: household.getPersons().values()) {
            ...
            Race race = ((MarylandPerson) pp).getRace();
            if(householdRace == null) {
                householdRace = race;
            } else if (race != householdRace) {
