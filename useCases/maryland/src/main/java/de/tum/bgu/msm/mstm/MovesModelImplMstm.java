...
public class MovesModelImplMstm extends AbstractMovesModelImpl {
    ...
    public MovesModelImplMstm(DataContainer dataContainer, Properties properties, InputStream movesOrNotInputStream, InputStream selectDwellingInputStream, InputStream ddUtilityInputStream) {
