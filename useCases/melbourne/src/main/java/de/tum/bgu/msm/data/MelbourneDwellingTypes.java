...
public class MelbourneDwellingTypes implements DwellingTypes {

    private final static List<DwellingType> TYPES = Collections.unmodifiableList(Arrays.asList(DwellingTypeMelbourne.values()));

    @Override
    public DwellingType valueOf(String tp) {
        return DwellingTypeMelbourne.valueOf(tp);
    }
    ...
    public enum DwellingTypeMelbourne implements DwellingType {
        ...
        DwellingTypeMelbourne(float acresNeeded, float structuralVacancy) {
        ...
        public static DwellingTypeMelbourne valueOf(int code){
            switch (code){
                case 1:
                    return SFD;
                case 2:
