...
import de.tum.bgu.msm.data.PersonMEL;
...
public class PersonWriterMEL implements PersonWriter {

    private final static Logger logger = LogManager.getLogger(PersonWriterMEL.class);

    private final HouseholdDataManager householdData;

    public PersonWriterMEL(HouseholdDataManager householdData) {
    ...
    public void writePersons(String path) {
        ...
        for (Person pp : householdData.getPersons()) {
            ...
            pwp.print(",");
            pwp.print(((PersonMEL)pp).getEthnic().toString());
            pwp.print(",");
            ...
            pwp.print(",");
            pwp.print(((PersonMEL)pp).getSchoolId());
            pwp.println();
