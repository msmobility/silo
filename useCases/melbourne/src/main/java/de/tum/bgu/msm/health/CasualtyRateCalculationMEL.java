...
public class CasualtyRateCalculationMEL {
    private static final Logger log = LogManager.getLogger(CasualtyRateCalculationMEL.class);
    ...
    private double calculateUtility(Link link, int hour) {
        ...
        //
        String roadType = getStringAttribute(link.getAttributes(), "type", "null"); // todo: what should be the default
