...
public class JobReaderMEL implements JobReader {

    private final static Logger logger = LogManager.getLogger(JobReaderMEL.class);
    private final JobDataManager jobData;
    private final DataContainer dataContainer;

    public JobReaderMEL(JobDataManager jobDataManager, DataContainer dataContainer) {
