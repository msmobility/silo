...
public class JobMEL implements Job, MicroLocation {
    ...
    private String microlocationType;

    private final Attributes attributes = new AttributesImpl();

    JobMEL(int id, int zoneId, Coordinate coordinate, int workerId, String type) {
        this.id = id;
...
//                + "\nLocated in zone         " + zone
    ...
    public String getMicrolocationType() {
        return microlocationType;
    }

    public void setMicrolocationType(String microlocationType) {
        this.microlocationType = microlocationType;
    }
}
