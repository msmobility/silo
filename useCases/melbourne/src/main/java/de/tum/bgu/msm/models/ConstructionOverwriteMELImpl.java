 ...
 **/
public class ConstructionOverwriteMELImpl extends AbstractModel implements ConstructionOverwrite {

    private final static Logger logger = LogManager.getLogger(ConstructionOverwriteMELImpl.class);
    ...
    public ConstructionOverwriteMELImpl(DataContainer dataContainer, DwellingFactory factory, Properties properties, Random random) {
