...
/**
 * simple mirgration melbourne, only out no in
 **/
public class InOutMigrationMEL extends AbstractModel implements InOutMigration {

    private final static Logger logger = LogManager.getLogger(InOutMigrationMEL.class);
    ...
    public InOutMigrationMEL(DataContainer dataContainer, EmploymentModel employment,
    ...
    public Collection<MigrationEvent> getEventsForCurrentYear(int year) {
        ...
        //TODO: currently deactivate for melbourne impl
        return events;
    }
