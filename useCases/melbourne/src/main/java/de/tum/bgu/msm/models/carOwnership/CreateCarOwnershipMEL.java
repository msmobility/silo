...
public class CreateCarOwnershipMEL implements CreateCarOwnershipModel {

    private static Logger logger = LogManager.getLogger(CreateCarOwnershipMEL.class);

    private final DataContainer dataContainer;
    private final DefaultGeoData geoData;
    private final CreateCarOwnershipStrategy strategy;

    public CreateCarOwnershipMEL(DataContainer dataContainer, CreateCarOwnershipStrategy strategy) {
