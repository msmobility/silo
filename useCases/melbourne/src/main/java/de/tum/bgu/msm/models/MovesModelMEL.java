 ...
 */
public class MovesModelMEL extends AbstractModel implements MovesModel {

//    public static BufferedWriter fileWriter;

    public static boolean track = false;

    protected final static Logger logger = LogManager.getLogger(MovesModelMEL.class);
    ...
    public MovesModelMEL(DataContainer dataContainer, Properties properties, MovesStrategy movesStrategy,
    ...
    public List<MoveEvent> getEventsForCurrentYear(int year) {
        ...
        //TODO: comment out for running melbourne model without relocation
