...
public class ModelBuilderPortland {

    private final static Logger logger = Logger.getLogger(ModelBuilderPortland.class);

    private ModelBuilderPortland() {}

    public static ModelContainer getModelContainerForPortland(DataContainer dataContainer, Properties properties, Config config) {
        ...
        final HousingStrategyPortland housingStrategy = new HousingStrategyPortland(
                properties,
                dataContainer,
                dataContainer.getTravelTimes(),
                new DefaultDwellingProbabilityStrategy(),
                new DwellingUtilityStrategyMstm(),
                new RegionUilityStrategyPortland(), new RegionProbabilityStrategyImpl());
