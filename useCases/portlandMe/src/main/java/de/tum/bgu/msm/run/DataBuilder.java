...
import de.tum.bgu.msm.syntheticPopulationGenerator.portland.GeoDataReaderPortland;
...
public final class DataBuilder {
    ...
    public static DataContainer buildDataContainerForPortland(Properties properties, Config config) {
...
//                accessibility = new MatsimAccessibility(geoData);
        ...
        //CommutingTimeProbability commutingTimeProbability = new CommutingTimeProbabilityExponential(-0.07f, -0.07f); //for v3
        CommutingTimeProbability commutingTimeProbability = new CommutingTimeProbabilityExponential(-0.025f, -0.025f); //for v4
    ...
    public static void readInput(Properties properties, DataContainer dataContainer) {
        final GeoDataReaderPortland geoDataReaderMstm = new GeoDataReaderPortland((GeoDataMstm) dataContainer.getGeoData());
