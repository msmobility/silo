...
public class HousingStrategyPortland implements HousingStrategy<DwellingMstm> {
    ...
    private final RegionUilityStrategyPortland regionUtilityStrategy;
    ...
    public HousingStrategyPortland(Properties properties,
                                   DataContainer dataContainer,
                                   TravelTimes travelTimes,
                                   DwellingProbabilityStrategy dwellingProbabilityStrategy,
                                   DwellingUtilityStrategyMstm dwellingUtilityStrategy,
                                   RegionUilityStrategyPortland regionUtilityStrategy, RegionProbabilityStrategy regionProbabilityStrategy) {
    ...
    public HousingStrategy duplicate() {
        ...
        final HousingStrategyPortland housingStrategyMstm = new HousingStrategyPortland(properties, dataContainer, travelTimes, dwellingProbabilityStrategy, dwellingUtilityStrategy, regionUtilityStrategy, regionProbabilityStrategy);
            ...
            for (Race race : Race.values()) {
                ...
                for (Region region : geoData.getRegions().values()) {
                    ...
                    double util = regionUtilityStrategy.calculateRegionUtility(incomeCategory,
                            ...
                            crimeRateByRegion.get(region.getId()), (double) region.getAttributes().get("NICHE"));
...
//                            util *= Math.pow(hhByRegion.getIndexed(region.getId()), .35);//v5
                            util *= Math.pow(hhByRegion.getIndexed(region.getId()), .25);
                            break;
                        default:
                            //do nothing.
                    }
