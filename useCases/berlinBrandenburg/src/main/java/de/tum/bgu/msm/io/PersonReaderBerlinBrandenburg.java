...
public class PersonReaderBerlinBrandenburg implements PersonReader {

    private final static Logger logger = LogManager.getLogger(PersonReaderBerlinBrandenburg.class);
    private final HouseholdDataManager householdDataManager;

    public PersonReaderBerlinBrandenburg(HouseholdDataManager householdDataManager) {
    ...
    public void readData(String path) {
        ...
        PersonFactoryBerlinBrandenburg ppFactory = new PersonFactoryBerlinBrandenburg();
        String recString = "";
        int recCount = 0;
        try {
            ...
            while ((recString = in.readLine()) != null) {
                ...
                PersonBerlinBrandenburg pp = ppFactory.createPerson(id, age, gender, occupation, pr, workplace, income);
