 ...
 */
public class CreateCarOwnershipJSCalculatorBerlinBrandenburg extends JavaScriptCalculator<double[]> {

    public CreateCarOwnershipJSCalculatorBerlinBrandenburg(Reader reader){
        super(reader);
    }
