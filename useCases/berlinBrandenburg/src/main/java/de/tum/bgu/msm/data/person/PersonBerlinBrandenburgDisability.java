...
public class PersonBerlinBrandenburgDisability implements PersonWithSchool {

    private final PersonBerlinBrandenburg delegate;

    private Disability disability;

    PersonBerlinBrandenburgDisability(int id, int age,
                                      Gender gender, Occupation occupation,
                                      PersonRole role, int jobId,
                                      int income)  {
        delegate = new PersonBerlinBrandenburg(id, age, gender, occupation, role, jobId, income);
    }
