...
public class PersonReaderBerlinBrandenburgDisability implements PersonReader {

    private final static Logger logger = LogManager.getLogger(PersonReaderBerlinBrandenburgDisability.class);
    private final HouseholdDataManager householdDataManager;
    private final DefaultDisabilityStrategy strategy;

    public PersonReaderBerlinBrandenburgDisability(HouseholdDataManager householdDataManager, DefaultDisabilityStrategy strategy) {
    ...
    public void readData(String path) {
        ...
        PersonFactoryBerlinBrandenburgDisability ppFactory = new PersonFactoryBerlinBrandenburgDisability();
        String recString = "";
        int recCount = 0;
        try {
            ...
            while ((recString = in.readLine()) != null) {
                ...
                PersonBerlinBrandenburgDisability pp = ppFactory.createPerson(id, age, gender, occupation, pr, workplace, income);
