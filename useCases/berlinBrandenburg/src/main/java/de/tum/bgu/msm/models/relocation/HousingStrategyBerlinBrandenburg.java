...
public class HousingStrategyBerlinBrandenburg implements HousingStrategy {

    private final static Logger logger = LogManager.getLogger(HousingStrategyBerlinBrandenburg.class);
    ...
    public HousingStrategyBerlinBrandenburg(DataContainer dataContainer,
        ...
        for (IncomeCategory incomeCategory : IncomeCategory.values()) {
            ...
            for (Nationality nationality : Nationality.values()) {
                ...
                for (Region region : geoData.getRegions().values()) {
                    ...
                    double utility = regionUtilityStrategy.calculateSelectRegionProbability(incomeCategory, priceUtil, regAcc, (float) regionalShareForeigners.getIndexed(region.getId()));
    ...
    public double calculateRegionalUtility(Household household, Region region) {
        ...
        Nationality nationality = ((HouseholdBerlinBrandenburg) household).getNationality();
    ...
    public HousingStrategy duplicate() {
        ...
        final HousingStrategyBerlinBrandenburg housingStrategyMuc = new HousingStrategyBerlinBrandenburg(dataContainer, properties, travelTimes, dwellingProbabilityStrategy, dwellingUtilityStrategy, regionUtilityStrategy, regionProbabilityStrategy, commuteModeChoice);
    ...
    private void calculateShareOfForeignersByZoneAndRegion() {
        ...
        for (Household hh : dataContainer.getHouseholdDataManager().getHouseholds()) {
            ...
            if (((HouseholdBerlinBrandenburg) hh).getNationality() != Nationality.GERMAN) {
