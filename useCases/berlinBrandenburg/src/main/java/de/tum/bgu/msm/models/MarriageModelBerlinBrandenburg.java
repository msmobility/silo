 ...
 **/
public class MarriageModelBerlinBrandenburg extends AbstractModel implements MarriageModel {

    private final static Logger logger = LogManager.getLogger(MarriageModelBerlinBrandenburg.class);
    ...
    public MarriageModelBerlinBrandenburg(DataContainer dataContainer, MovesModelImpl movesModel,
    ...
    private Person findPartner(MarriageMarket market, Person person) {
        ...
        Nationality personRace = ((PersonBerlinBrandenburg) person).getNationality();
        float sum = 0;
        for (Person pp : possiblePartners) {
            float prob;
            PersonBerlinBrandenburg p = ((PersonBerlinBrandenburg) pp);
            if ((preference.sameNationality && personRace == p.getNationality())
                    || (!preference.sameNationality && personRace != p.getNationality())) {
                prob = 10000f;
            } else {
                prob = 0.001f;
            }
    ...
    private final static class MarriagePreference {
        ...
        private final boolean sameNationality;
        private final int age;
        private final Gender gender;

        private MarriagePreference(boolean sameNationality, int age, Gender gender) {
