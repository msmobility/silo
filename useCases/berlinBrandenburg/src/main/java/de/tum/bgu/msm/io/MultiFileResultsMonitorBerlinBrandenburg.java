...
public class MultiFileResultsMonitorBerlinBrandenburg extends MultiFileResultsMonitor {


    private DataContainer dataContainer;
    private Properties properties;
    private PrintWriter popByRace;
    private final Logger logger = LogManager.getLogger(MultiFileResultsMonitorBerlinBrandenburg.class);


    public MultiFileResultsMonitorBerlinBrandenburg(DataContainer dataContainer, Properties properties) {
