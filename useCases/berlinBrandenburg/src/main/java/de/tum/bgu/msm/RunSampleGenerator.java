...
public class RunSampleGenerator {
    ...
    public static void main(String[] args) {
        ...
        DataContainerWithSchools dataContainer = DataBuilder.getModelDataForBerlinBrandenburg(properties, null);
...
//
        ...
        new DwellingWriterBerlinBrandenburg(dataContainer).writeDwellings("C:/Users/Qin/Desktop/dd_2011.csv");
        ...
        new PersonWriterBerlinBrandenburg(dataContainer.getHouseholdDataManager()).writePersons("C:/Users/Qin/Desktop/pp_2011.csv");
        new JobWriterBerlinBrandenburg(dataContainer.getJobDataManager()).writeJobs("C:/Users/Qin/Desktop/jj_2011.csv");
