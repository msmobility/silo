...
public class HouseholdBerlinBrandenburg implements Household {

    private final HouseholdImpl delegate;
    private Nationality nationality;
    private int autonomous = 0;

    public HouseholdBerlinBrandenburg(int id, int dwellingId, int autos) {
...
//    }
    ...
    private void defineHouseholdNationality() {
        ...
        //    if (householdNationaliy == null) {
         //       householdNationaliy = ((PersonBerlinBrandenburg)pp).getNationality();
