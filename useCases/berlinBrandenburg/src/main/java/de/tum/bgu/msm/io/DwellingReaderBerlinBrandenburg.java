...
public class DwellingReaderBerlinBrandenburg implements DwellingReader {

    private final static Logger logger = LogManager.getLogger(DwellingReaderBerlinBrandenburg.class);
    ...
    public DwellingReaderBerlinBrandenburg(DwellingData realEstate) {
    ...
    public DwellingReaderBerlinBrandenburg(DwellingData realEstate, DwellingTypes dwellingTypes,
                                           DwellingFactory dwellingFactory) {
    ...
    public DwellingReaderBerlinBrandenburg(RealEstateDataManager realEstateDataManager) {
