 ...
 */
public class SwitchToAutonomousVehicleModelBerlinBrandenburg extends AbstractModel implements ModelUpdateListener {

    private final static Logger logger = LogManager.getLogger(SwitchToAutonomousVehicleModelBerlinBrandenburg.class);
    private SwitchToAutonomousVehicleJSCalculatorBerlinBrandenburg calculator;
...
//        Reader reader = new InputStreamReader(this.getClass().getResourceAsStream("SwitchToAutonomousVehicleCalc"));
        calculator = new SwitchToAutonomousVehicleJSCalculatorBerlinBrandenburg(reader);
    }
