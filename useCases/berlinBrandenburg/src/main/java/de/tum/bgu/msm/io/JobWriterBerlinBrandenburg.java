...
public class JobWriterBerlinBrandenburg implements JobWriter {

    private final static Logger logger = LogManager.getLogger(JobWriterBerlinBrandenburg.class);

    private final JobDataManager jobDataManager;

    public JobWriterBerlinBrandenburg(JobDataManager dataContainer) {
