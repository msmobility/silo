...
public class DataBuilder {
    ...
    public static DataContainerWithSchools getModelDataForBerlinBrandenburg(Properties properties, Config config) {
...
//                accessibility = new MatsimAccessibility(geoData);
        ...
        JobFactoryBerlinBrandenburg jobFactory = new JobFactoryBerlinBrandenburg();
        ...
        final HouseholdFactoryBerlinBrandenburg hhFactory = new HouseholdFactoryBerlinBrandenburg();
        HouseholdDataManager householdDataManager = new HouseholdDataManagerImpl(
                householdData, dwellingData, new PersonFactoryBerlinBrandenburg(),
    ...
    static public void read(Properties properties, DataContainerWithSchools dataContainer){
        ...
        HouseholdReader hhReader = new HouseholdReaderBerlinBrandenburg(dataContainer.getHouseholdDataManager(), (HouseholdFactoryBerlinBrandenburg) dataContainer.getHouseholdDataManager().getHouseholdFactory());
        ...
        PersonReader personReader = new PersonReaderBerlinBrandenburg(dataContainer.getHouseholdDataManager());
        personReader.readData(personFile);

        DwellingReader ddReader = new DwellingReaderBerlinBrandenburg(dataContainer.getRealEstateDataManager());
        ...
        new JobType(properties.jobData.jobTypes);
        JobReader jjReader = new JobReaderBerlinBrandenburg(dataContainer.getJobDataManager(), (JobFactoryBerlinBrandenburg) dataContainer.getJobDataManager().getFactory());
