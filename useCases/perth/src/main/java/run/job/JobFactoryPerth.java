...
public class JobFactoryPerth implements JobFactory {
    ...
    @Override
    public JobPerth createJob(int id, int zoneId, Coordinate coordinate, int workerId, String type) {
        JobPerth job = new JobPerth(id, zoneId, coordinate, workerId, type);
