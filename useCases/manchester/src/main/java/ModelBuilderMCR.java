...
public class ModelBuilderMCR {
    ...
    public static ModelContainer getModelContainerForManchester(DefaultDataContainer dataContainer, Properties properties, Config config) {
...
//                        properties, SiloUtil.provideNewRandom());
                scenarioAssembler = new SimpleCommuteMatsimScenarioAssembler(dataContainer, properties);
                transportModel = new MatsimTransportModelManchester(dataContainer, config, properties, scenarioAssembler, matsimData);
                break;
            case NONE:
            default:
                transportModel = null;
