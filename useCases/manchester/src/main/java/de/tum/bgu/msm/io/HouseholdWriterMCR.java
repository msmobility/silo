...
public class HouseholdWriterMCR implements HouseholdWriter {
    ...
    public HouseholdWriterMCR(HouseholdDataManager householdData, RealEstateDataManager realEstateData) {
