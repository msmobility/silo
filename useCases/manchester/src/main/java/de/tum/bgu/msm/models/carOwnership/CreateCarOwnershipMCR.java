...
public class CreateCarOwnershipMCR implements CreateCarOwnershipModel {

    private static Logger logger = LogManager.getLogger(CreateCarOwnershipMCR.class);

    private final DataContainer dataContainer;
    private final DefaultGeoData geoData;
    private final CreateCarOwnershipStrategy strategy;

    public CreateCarOwnershipMCR(DataContainer dataContainer, CreateCarOwnershipStrategy strategy) {
