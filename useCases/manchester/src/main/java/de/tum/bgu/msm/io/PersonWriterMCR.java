...
public class PersonWriterMCR implements PersonWriter {

    private final static Logger logger = LogManager.getLogger(PersonWriterMCR.class);

    private final HouseholdDataManager householdData;

    public PersonWriterMCR(HouseholdDataManager householdData) {
    ...
    public void writePersons(String path) {
        ...
        for (Person pp : householdData.getPersons()) {
            ...
            pwp.print(",");
            pwp.print(((PersonMCR)pp).getSchoolId());
            pwp.println();
