...
public class HuntNoiseSensitiveDwellingUtilityStrategyTest {
    ...
    public void test() {
        ...
        NoiseDwelling quietDwelling = new NoiseDwellingIml(new DwellingFactoryImpl().createDwelling(99999, 1, new Coordinate(40000,16000), -1, DefaultDwellingTypeImpl.SFD, 4, 3, 800, 1990));
        quietDwelling.setNoiseImmision(40);
        final double v = strategy.calculateHousingUtility(household, quietDwelling);

        NoiseDwelling noiseDwelling = new NoiseDwellingIml(new DwellingFactoryImpl().createDwelling(99999, 1, new Coordinate(40000,16000), -1, DefaultDwellingTypeImpl.SFD, 4, 3, 800, 1990));
        noiseDwelling.setNoiseImmision(60);
        final double v1 = strategy.calculateHousingUtility(household, noiseDwelling);

        NoiseDwelling noiseDwelling2 = new NoiseDwellingIml(new DwellingFactoryImpl().createDwelling(99999, 1, new Coordinate(40000,16000), -1, DefaultDwellingTypeImpl.SFD, 4, 3, 800, 1990));
