...
import de.tum.bgu.msm.scenarios.longCommutePenalty.LongCommutePenaltyModelBuilderMuc;
import de.tum.bgu.msm.scenarios.longCommutePenalty.RunLongCommutePenaltyMuc;
...
public class RunCoreCityDevelopmentMuc {
    ...
    private final static Logger logger = Logger.getLogger(RunCoreCityDevelopmentMuc.class);
