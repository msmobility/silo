...
public class PersonReaderMucHealth implements PersonReader {

    private final static Logger logger = LogManager.getLogger(PersonReaderMucHealth.class);
    private final HouseholdDataManager householdDataManager;

    public PersonReaderMucHealth(HouseholdDataManager householdDataManager) {
    ...
    public void readData(String path) {
        ...
        PersonFactoryMucHealth ppFactory = new PersonFactoryMucHealth();
        String recString = "";
        int recCount = 0;
        try {
            ...
            while ((recString = in.readLine()) != null) {
                ...
                PersonHealthMuc pp = ppFactory.createPerson(id, age, gender, occupation, pr, workplace, income);
