...
import de.tum.bgu.msm.models.relocation.DwellingProbabilityStrategyImpl;
import de.tum.bgu.msm.models.relocation.DwellingUtilityStrategyImpl;
import de.tum.bgu.msm.models.relocation.MovesModelImplMuc;
...
public class ModelConfigurator {
    ...
    public static ModelContainer getModelContainerForMuc(DataContainer dataContainer, Properties properties, Config config) {
        ...
        AbstractMovesModelImpl movesModel = new MovesModelImplMuc(
                dataContainer, properties, new DefaultMovesStrategy(), new DwellingUtilityStrategyImpl(),
                new DwellingProbabilityStrategyImpl(), new SelectRegionStrategyImpl());
