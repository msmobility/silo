...
public class MovesModelImplMuc extends AbstractMovesModelImpl {
    ...
    public MovesModelImplMuc(DataContainer dataContainer, Properties properties, MovesStrategy movesStrategy,
