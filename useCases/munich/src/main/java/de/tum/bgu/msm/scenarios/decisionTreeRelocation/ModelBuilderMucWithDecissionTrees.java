...
import de.tum.bgu.msm.scenarios.decisionTreeRelocation.models.relocation.DecissionTreeRelocationModel;
...
public class ModelBuilderMucWithDecissionTrees {
    ...
    public static ModelContainer getModelContainerForMuc(DataContainerWithSchools dataContainer, Properties properties, Config config) {
        ...
        DecissionTreeRelocationModel movesModel = new DecissionTreeRelocationModel(dataContainer, properties,SiloUtil.provideNewRandom());
