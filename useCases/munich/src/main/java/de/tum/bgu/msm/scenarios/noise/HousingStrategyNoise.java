...
public class HousingStrategyNoise implements HousingStrategy {
    ...
    public double calculateHousingUtility(Household hh, Dwelling dd) {
        ...
        int priceOld = dd.getPrice();
        int price = dd.getPrice();

        final double noiseImmission = ((NoiseDwelling) dd).getNoiseImmission();
        ...
        double ddPriceUtilityOld = convertPriceToUtility(priceOld, ht.getIncomeCategory());
        double ddPriceUtility = convertPriceToUtility(price, ht.getIncomeCategory());
    ...
    public HousingStrategy duplicate() {
        ...
        final HousingStrategyNoise housingStrategy = new HousingStrategyNoise(dataContainer, properties, travelTimes, dwellingProbabilityStrategy, dwellingUtilityStrategy, regionUtilityStrategyMuc, regionProbabilityStrategy, noiseModel);
        housingStrategy.regionalShareForeigners = this.regionalShareForeigners;
